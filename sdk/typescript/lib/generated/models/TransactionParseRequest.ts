...
export type TransactionParseRequestParseModeEnum =
  (typeof TransactionParseRequestParseModeEnum)[keyof typeof TransactionParseRequestParseModeEnum];
...
export type TransactionParseRequestValidationModeEnum =
  (typeof TransactionParseRequestValidationModeEnum)[keyof typeof TransactionParseRequestValidationModeEnum];
...
export type TransactionParseRequestResponseModeEnum =
  (typeof TransactionParseRequestResponseModeEnum)[keyof typeof TransactionParseRequestResponseModeEnum];
...
export function TransactionParseRequestFromJSON(
  json: any,
): TransactionParseRequest {
  return TransactionParseRequestFromJSONTyped(json, false);
}

export function TransactionParseRequestFromJSONTyped(
  json: any,
  ...
  return {
    ...
    validation_mode: !exists(json, "validation_mode")
      ? undefined
      : json["validation_mode"],
    response_mode: !exists(json, "response_mode")
      ? undefined
      : json["response_mode"],
    transaction_format_options: !exists(json, "transaction_format_options")
      ? undefined
      : TransactionFormatOptionsFromJSON(json["transaction_format_options"]),
  };
}

export function TransactionParseRequestToJSON(
  value?: TransactionParseRequest | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    ...
    transaction_format_options: TransactionFormatOptionsToJSON(
      value.transaction_format_options,
    ),
  };
}
