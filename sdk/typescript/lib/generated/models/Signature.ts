...
export type Signature =
  | ({ key_type: "EcdsaSecp256k1" } & EcdsaSecp256k1Signature)
  | ({ key_type: "EddsaEd25519" } & EddsaEd25519Signature);
...
export function SignatureFromJSONTyped(
  ...
  switch (json["key_type"]) {
    case "EcdsaSecp256k1":
      return {
        ...EcdsaSecp256k1SignatureFromJSONTyped(json, true),
        key_type: "EcdsaSecp256k1",
      };
    case "EddsaEd25519":
      return {
        ...EddsaEd25519SignatureFromJSONTyped(json, true),
        key_type: "EddsaEd25519",
      };
    default:
      throw new Error(
        `No variant of Signature exists with 'key_type=${json["key_type"]}'`,
      );
  }
}
...
export function SignatureToJSON(value?: Signature | null): any {
  ...
  switch (value["key_type"]) {
    ...
    default:
      throw new Error(
        `No variant of Signature exists with 'key_type=${value["key_type"]}'`,
      );
  }
}
