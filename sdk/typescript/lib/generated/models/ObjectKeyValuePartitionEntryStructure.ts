...
export type ObjectKeyValuePartitionEntryStructureTypeEnum =
  (typeof ObjectKeyValuePartitionEntryStructureTypeEnum)[keyof typeof ObjectKeyValuePartitionEntryStructureTypeEnum];

/**
 * Check if a given object implements the ObjectKeyValuePartitionEntryStructure interface.
 */
export function instanceOfObjectKeyValuePartitionEntryStructure(
  value: object,
): boolean {
  let isInstance = true;
...
export function ObjectKeyValuePartitionEntryStructureFromJSON(
  json: any,
): ObjectKeyValuePartitionEntryStructure {
  return ObjectKeyValuePartitionEntryStructureFromJSONTyped(json, false);
}

export function ObjectKeyValuePartitionEntryStructureFromJSONTyped(
  json: any,
...
export function ObjectKeyValuePartitionEntryStructureToJSON(
  value?: ObjectKeyValuePartitionEntryStructure | null,
): any {
  if (value === undefined) {
    return undefined;
  }
