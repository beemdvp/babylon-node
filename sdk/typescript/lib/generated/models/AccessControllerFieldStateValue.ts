 ...
 */
export function instanceOfAccessControllerFieldStateValue(
  value: object,
): boolean {
  let isInstance = true;
  ...
  isInstance =
    isInstance && "has_recovery_role_badge_withdraw_attempt" in value;

  return isInstance;
}

export function AccessControllerFieldStateValueFromJSON(
  json: any,
): AccessControllerFieldStateValue {
  return AccessControllerFieldStateValueFromJSONTyped(json, false);
}

export function AccessControllerFieldStateValueFromJSONTyped(
  json: any,
  ...
  return {
    ...
    xrd_fee_vault: !exists(json, "xrd_fee_vault")
      ? undefined
      : EntityReferenceFromJSON(json["xrd_fee_vault"]),
    timed_recovery_delay_minutes: !exists(json, "timed_recovery_delay_minutes")
      ? undefined
      : json["timed_recovery_delay_minutes"],
    recovery_badge_resource_address: json["recovery_badge_resource_address"],
    is_primary_role_locked: json["is_primary_role_locked"],
    primary_role_recovery_attempt: !exists(
      json,
      "primary_role_recovery_attempt",
    )
      ? undefined
      : PrimaryRoleRecoveryAttemptFromJSON(
          json["primary_role_recovery_attempt"],
        ),
    has_primary_role_badge_withdraw_attempt:
      json["has_primary_role_badge_withdraw_attempt"],
    recovery_role_recovery_attempt: !exists(
      json,
      "recovery_role_recovery_attempt",
    )
      ? undefined
      : RecoveryRoleRecoveryAttemptFromJSON(
          json["recovery_role_recovery_attempt"],
        ),
    has_recovery_role_badge_withdraw_attempt:
      json["has_recovery_role_badge_withdraw_attempt"],
  };
}

export function AccessControllerFieldStateValueToJSON(
  value?: AccessControllerFieldStateValue | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    ...
    primary_role_recovery_attempt: PrimaryRoleRecoveryAttemptToJSON(
      value.primary_role_recovery_attempt,
    ),
    has_primary_role_badge_withdraw_attempt:
      value.has_primary_role_badge_withdraw_attempt,
    recovery_role_recovery_attempt: RecoveryRoleRecoveryAttemptToJSON(
      value.recovery_role_recovery_attempt,
    ),
    has_recovery_role_badge_withdraw_attempt:
      value.has_recovery_role_badge_withdraw_attempt,
  };
}
