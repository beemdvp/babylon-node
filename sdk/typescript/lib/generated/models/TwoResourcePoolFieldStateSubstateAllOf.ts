...
export type TwoResourcePoolFieldStateSubstateAllOfSubstateTypeEnum =
  (typeof TwoResourcePoolFieldStateSubstateAllOfSubstateTypeEnum)[keyof typeof TwoResourcePoolFieldStateSubstateAllOfSubstateTypeEnum];

/**
 * Check if a given object implements the TwoResourcePoolFieldStateSubstateAllOf interface.
 */
export function instanceOfTwoResourcePoolFieldStateSubstateAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function TwoResourcePoolFieldStateSubstateAllOfFromJSON(
  json: any,
): TwoResourcePoolFieldStateSubstateAllOf {
  return TwoResourcePoolFieldStateSubstateAllOfFromJSONTyped(json, false);
}

export function TwoResourcePoolFieldStateSubstateAllOfFromJSONTyped(
  json: any,
...
export function TwoResourcePoolFieldStateSubstateAllOfToJSON(
  value?: TwoResourcePoolFieldStateSubstateAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
