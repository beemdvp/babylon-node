...
export type NonFungibleResourceManagerDataEntrySubstateSubstateTypeEnum =
  (typeof NonFungibleResourceManagerDataEntrySubstateSubstateTypeEnum)[keyof typeof NonFungibleResourceManagerDataEntrySubstateSubstateTypeEnum];

/**
 * Check if a given object implements the NonFungibleResourceManagerDataEntrySubstate interface.
 */
export function instanceOfNonFungibleResourceManagerDataEntrySubstate(
  value: object,
): boolean {
  let isInstance = true;
...
export function NonFungibleResourceManagerDataEntrySubstateFromJSON(
  json: any,
): NonFungibleResourceManagerDataEntrySubstate {
  return NonFungibleResourceManagerDataEntrySubstateFromJSONTyped(json, false);
}

export function NonFungibleResourceManagerDataEntrySubstateFromJSONTyped(
  json: any,
...
export function NonFungibleResourceManagerDataEntrySubstateToJSON(
  value?: NonFungibleResourceManagerDataEntrySubstate | null,
): any {
  if (value === undefined) {
    return undefined;
  }
