...
export type SchemaEntrySubstateAllOfSubstateTypeEnum =
  (typeof SchemaEntrySubstateAllOfSubstateTypeEnum)[keyof typeof SchemaEntrySubstateAllOfSubstateTypeEnum];
...
export function SchemaEntrySubstateAllOfFromJSON(
  json: any,
): SchemaEntrySubstateAllOf {
  return SchemaEntrySubstateAllOfFromJSONTyped(json, false);
}

export function SchemaEntrySubstateAllOfFromJSONTyped(
  json: any,
...
export function SchemaEntrySubstateAllOfToJSON(
  value?: SchemaEntrySubstateAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
