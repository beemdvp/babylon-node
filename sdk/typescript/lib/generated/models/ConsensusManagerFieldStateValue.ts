 ...
 */
export function instanceOfConsensusManagerFieldStateValue(
  value: object,
): boolean {
  let isInstance = true;
...
export function ConsensusManagerFieldStateValueFromJSON(
  json: any,
): ConsensusManagerFieldStateValue {
  return ConsensusManagerFieldStateValueFromJSONTyped(json, false);
}

export function ConsensusManagerFieldStateValueFromJSONTyped(
  json: any,
  ...
  return {
    ...
    current_leader: !exists(json, "current_leader")
      ? undefined
      : ActiveValidatorIndexFromJSON(json["current_leader"]),
  };
}

export function ConsensusManagerFieldStateValueToJSON(
  value?: ConsensusManagerFieldStateValue | null,
): any {
  if (value === undefined) {
    return undefined;
  }
