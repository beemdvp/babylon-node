 ...
 */
export function instanceOfMempoolTransactionResponsePayloadsInner(
  value: object,
): boolean {
  let isInstance = true;
...
export function MempoolTransactionResponsePayloadsInnerFromJSON(
  json: any,
): MempoolTransactionResponsePayloadsInner {
  return MempoolTransactionResponsePayloadsInnerFromJSONTyped(json, false);
}

export function MempoolTransactionResponsePayloadsInnerFromJSONTyped(
  json: any,
...
export function MempoolTransactionResponsePayloadsInnerToJSON(
  value?: MempoolTransactionResponsePayloadsInner | null,
): any {
  if (value === undefined) {
    return undefined;
  }
