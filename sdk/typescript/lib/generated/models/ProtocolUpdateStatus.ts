 ...
 * @export
 */
export type ProtocolUpdateStatus =
  | ({ type: "Complete" } & CompleteProtocolUpdateStatus)
  | ({ type: "InProgress" } & InProgressProtocolUpdateStatus);
...
export function ProtocolUpdateStatusFromJSONTyped(
  json: any,
  ...
  switch (json["type"]) {
    case "Complete":
      return {
        ...CompleteProtocolUpdateStatusFromJSONTyped(json, true),
        type: "Complete",
      };
    case "InProgress":
      return {
        ...InProgressProtocolUpdateStatusFromJSONTyped(json, true),
        type: "InProgress",
      };
    default:
      throw new Error(
        `No variant of ProtocolUpdateStatus exists with 'type=${json["type"]}'`,
      );
  }
}

export function ProtocolUpdateStatusToJSON(
  value?: ProtocolUpdateStatus | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  switch (value["type"]) {
    ...
    default:
      throw new Error(
        `No variant of ProtocolUpdateStatus exists with 'type=${value["type"]}'`,
      );
  }
}
