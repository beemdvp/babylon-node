...
export function DataStructFromJSONTyped(
  json: any,
  ...
  return {
    ...
    owned_entities: (json["owned_entities"] as Array<any>).map(
      EntityReferenceFromJSON,
    ),
    referenced_entities: (json["referenced_entities"] as Array<any>).map(
      EntityReferenceFromJSON,
    ),
  };
}
...
export function DataStructToJSON(value?: DataStruct | null): any {
  ...
  return {
    ...
    owned_entities: (value.owned_entities as Array<any>).map(
      EntityReferenceToJSON,
    ),
    referenced_entities: (value.referenced_entities as Array<any>).map(
      EntityReferenceToJSON,
    ),
  };
}
