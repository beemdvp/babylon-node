...
export type ConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstateSubstateTypeEnum =
  (typeof ConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstateSubstateTypeEnum)[keyof typeof ConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstateSubstateTypeEnum];

/**
 * Check if a given object implements the ConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstate interface.
 */
export function instanceOfConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstate(
  value: object,
): boolean {
  let isInstance = true;
...
export function ConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstateFromJSON(
  json: any,
): ConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstate {
  return ConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstateFromJSONTyped(
    json,
    false,
  );
}

export function ConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstateFromJSONTyped(
  json: any,
...
export function ConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstateToJSON(
  value?: ConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstate | null,
): any {
  if (value === undefined) {
    return undefined;
  }
