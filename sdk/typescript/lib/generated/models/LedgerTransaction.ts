...
export type LedgerTransaction =
  | ({ type: "Flash" } & FlashLedgerTransaction)
  | ({ type: "Genesis" } & GenesisLedgerTransaction)
  | ({ type: "RoundUpdate" } & RoundUpdateLedgerTransaction)
  | ({ type: "User" } & UserLedgerTransaction)
  | ({ type: "UserV2" } & UserLedgerTransactionV2);

export function LedgerTransactionFromJSON(json: any): LedgerTransaction {
  return LedgerTransactionFromJSONTyped(json, false);
}

export function LedgerTransactionFromJSONTyped(
  json: any,
  ...
  switch (json["type"]) {
    case "Flash":
      return {
        ...FlashLedgerTransactionFromJSONTyped(json, true),
        type: "Flash",
      };
    case "Genesis":
      return {
        ...GenesisLedgerTransactionFromJSONTyped(json, true),
        type: "Genesis",
      };
    case "RoundUpdate":
      return {
        ...RoundUpdateLedgerTransactionFromJSONTyped(json, true),
        type: "RoundUpdate",
      };
    case "User":
      return {
        ...UserLedgerTransactionFromJSONTyped(json, true),
        type: "User",
      };
    case "UserV2":
      return {
        ...UserLedgerTransactionV2FromJSONTyped(json, true),
        type: "UserV2",
      };
    default:
      throw new Error(
        `No variant of LedgerTransaction exists with 'type=${json["type"]}'`,
      );
  }
}
...
export function LedgerTransactionToJSON(value?: LedgerTransaction | null): any {
  ...
  switch (value["type"]) {
    ...
    default:
      throw new Error(
        `No variant of LedgerTransaction exists with 'type=${value["type"]}'`,
      );
  }
}
