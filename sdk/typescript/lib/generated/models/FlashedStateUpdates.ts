...
export function FlashedStateUpdatesFromJSONTyped(
  json: any,
  ...
  return {
    ...
    set_substates: (json["set_substates"] as Array<any>).map(
      FlashSetSubstateFromJSON,
    ),
...
export function FlashedStateUpdatesToJSON(
  value?: FlashedStateUpdates | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    ...
    set_substates: (value.set_substates as Array<any>).map(
      FlashSetSubstateToJSON,
    ),
