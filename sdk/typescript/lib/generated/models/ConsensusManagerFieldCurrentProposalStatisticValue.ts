 ...
 */
export function instanceOfConsensusManagerFieldCurrentProposalStatisticValue(
  value: object,
): boolean {
  let isInstance = true;
...
export function ConsensusManagerFieldCurrentProposalStatisticValueFromJSON(
  json: any,
): ConsensusManagerFieldCurrentProposalStatisticValue {
  return ConsensusManagerFieldCurrentProposalStatisticValueFromJSONTyped(
    json,
    false,
  );
}

export function ConsensusManagerFieldCurrentProposalStatisticValueFromJSONTyped(
  json: any,
...
export function ConsensusManagerFieldCurrentProposalStatisticValueToJSON(
  value?: ConsensusManagerFieldCurrentProposalStatisticValue | null,
): any {
  if (value === undefined) {
    return undefined;
  }
