...
export function SignedTransactionIntentFromJSON(
  json: any,
): SignedTransactionIntent {
  return SignedTransactionIntentFromJSONTyped(json, false);
}

export function SignedTransactionIntentFromJSONTyped(
  json: any,
  ...
  return {
    ...
    intent_signatures: (json["intent_signatures"] as Array<any>).map(
      SignatureWithPublicKeyFromJSON,
    ),
  };
}

export function SignedTransactionIntentToJSON(
  value?: SignedTransactionIntent | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    ...
    intent_signatures: (value.intent_signatures as Array<any>).map(
      SignatureWithPublicKeyToJSON,
    ),
  };
}
