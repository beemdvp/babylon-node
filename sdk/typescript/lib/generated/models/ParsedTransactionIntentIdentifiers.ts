 ...
 */
export function instanceOfParsedTransactionIntentIdentifiers(
  value: object,
): boolean {
  let isInstance = true;
...
export function ParsedTransactionIntentIdentifiersFromJSON(
  json: any,
): ParsedTransactionIntentIdentifiers {
  return ParsedTransactionIntentIdentifiersFromJSONTyped(json, false);
}

export function ParsedTransactionIntentIdentifiersFromJSONTyped(
  json: any,
...
export function ParsedTransactionIntentIdentifiersToJSON(
  value?: ParsedTransactionIntentIdentifiers | null,
): any {
  if (value === undefined) {
    return undefined;
  }
