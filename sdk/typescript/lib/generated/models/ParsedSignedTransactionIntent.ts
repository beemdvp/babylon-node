...
export type ParsedSignedTransactionIntentTypeEnum =
  (typeof ParsedSignedTransactionIntentTypeEnum)[keyof typeof ParsedSignedTransactionIntentTypeEnum];

/**
 * Check if a given object implements the ParsedSignedTransactionIntent interface.
 */
export function instanceOfParsedSignedTransactionIntent(
  value: object,
): boolean {
  let isInstance = true;
...
export function ParsedSignedTransactionIntentFromJSON(
  json: any,
): ParsedSignedTransactionIntent {
  return ParsedSignedTransactionIntentFromJSONTyped(json, false);
}

export function ParsedSignedTransactionIntentFromJSONTyped(
  json: any,
...
export function ParsedSignedTransactionIntentToJSON(
  value?: ParsedSignedTransactionIntent | null,
): any {
  if (value === undefined) {
    return undefined;
  }
