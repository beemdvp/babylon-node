 ...
 */
export function instanceOfBlueprintSchemaCollectionPartition(
  value: object,
): boolean {
  let isInstance = true;
...
export function BlueprintSchemaCollectionPartitionFromJSON(
  json: any,
): BlueprintSchemaCollectionPartition {
  return BlueprintSchemaCollectionPartitionFromJSONTyped(json, false);
}

export function BlueprintSchemaCollectionPartitionFromJSONTyped(
  json: any,
  ...
  return {
    ...
    collection_schema: BlueprintCollectionSchemaFromJSON(
      json["collection_schema"],
    ),
  };
}

export function BlueprintSchemaCollectionPartitionToJSON(
  value?: BlueprintSchemaCollectionPartition | null,
): any {
  if (value === undefined) {
    return undefined;
  }
