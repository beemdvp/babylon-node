...
export function LtsTransactionStatusResponseFromJSON(json: any): LtsTransactionStatusResponse {
    return LtsTransactionStatusResponseFromJSONTyped(json, false);
}

export function LtsTransactionStatusResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): LtsTransactionStatusResponse {
...
export function LtsTransactionStatusResponseToJSON(value?: LtsTransactionStatusResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
