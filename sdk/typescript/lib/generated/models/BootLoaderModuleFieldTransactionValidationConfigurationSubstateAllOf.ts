...
export type BootLoaderModuleFieldTransactionValidationConfigurationSubstateAllOfSubstateTypeEnum =
  (typeof BootLoaderModuleFieldTransactionValidationConfigurationSubstateAllOfSubstateTypeEnum)[keyof typeof BootLoaderModuleFieldTransactionValidationConfigurationSubstateAllOfSubstateTypeEnum];

/**
 * Check if a given object implements the BootLoaderModuleFieldTransactionValidationConfigurationSubstateAllOf interface.
 */
export function instanceOfBootLoaderModuleFieldTransactionValidationConfigurationSubstateAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function BootLoaderModuleFieldTransactionValidationConfigurationSubstateAllOfFromJSON(
  json: any,
): BootLoaderModuleFieldTransactionValidationConfigurationSubstateAllOf {
  return BootLoaderModuleFieldTransactionValidationConfigurationSubstateAllOfFromJSONTyped(
    json,
    false,
  );
}

export function BootLoaderModuleFieldTransactionValidationConfigurationSubstateAllOfFromJSONTyped(
  json: any,
...
export function BootLoaderModuleFieldTransactionValidationConfigurationSubstateAllOfToJSON(
  value?: BootLoaderModuleFieldTransactionValidationConfigurationSubstateAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
