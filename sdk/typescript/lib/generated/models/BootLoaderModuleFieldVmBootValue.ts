 ...
 */
export function instanceOfBootLoaderModuleFieldVmBootValue(
  value: object,
): boolean {
  let isInstance = true;
...
export function BootLoaderModuleFieldVmBootValueFromJSON(
  json: any,
): BootLoaderModuleFieldVmBootValue {
  return BootLoaderModuleFieldVmBootValueFromJSONTyped(json, false);
}

export function BootLoaderModuleFieldVmBootValueFromJSONTyped(
  json: any,
...
export function BootLoaderModuleFieldVmBootValueToJSON(
  value?: BootLoaderModuleFieldVmBootValue | null,
): any {
  if (value === undefined) {
    return undefined;
  }
