 ...
 */
export function instanceOfTransactionPreviewV2ErrorDetailsBase(
  value: object,
): boolean {
  let isInstance = true;
...
export function TransactionPreviewV2ErrorDetailsBaseFromJSON(
  json: any,
): TransactionPreviewV2ErrorDetailsBase {
  return TransactionPreviewV2ErrorDetailsBaseFromJSONTyped(json, false);
}

export function TransactionPreviewV2ErrorDetailsBaseFromJSONTyped(
  json: any,
...
export function TransactionPreviewV2ErrorDetailsBaseToJSON(
  value?: TransactionPreviewV2ErrorDetailsBase | null,
): any {
  if (value === undefined) {
    return undefined;
  }
