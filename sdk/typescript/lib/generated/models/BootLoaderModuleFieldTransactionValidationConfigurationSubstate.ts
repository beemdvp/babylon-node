...
export type BootLoaderModuleFieldTransactionValidationConfigurationSubstateSubstateTypeEnum =
  (typeof BootLoaderModuleFieldTransactionValidationConfigurationSubstateSubstateTypeEnum)[keyof typeof BootLoaderModuleFieldTransactionValidationConfigurationSubstateSubstateTypeEnum];

/**
 * Check if a given object implements the BootLoaderModuleFieldTransactionValidationConfigurationSubstate interface.
 */
export function instanceOfBootLoaderModuleFieldTransactionValidationConfigurationSubstate(
  value: object,
): boolean {
  let isInstance = true;
...
export function BootLoaderModuleFieldTransactionValidationConfigurationSubstateFromJSON(
  json: any,
...
export function BootLoaderModuleFieldTransactionValidationConfigurationSubstateFromJSONTyped(
  json: any,
...
export function BootLoaderModuleFieldTransactionValidationConfigurationSubstateToJSON(
  value?: BootLoaderModuleFieldTransactionValidationConfigurationSubstate | null,
): any {
  if (value === undefined) {
    return undefined;
  }
