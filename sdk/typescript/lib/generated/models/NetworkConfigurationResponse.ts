...
export interface NetworkConfigurationResponse {
  ...
  /**
   * The current value of the protocol-based USD/RORK multiplier (i.e. an amount of RORKs to be paid for 1 USD).
...
export function NetworkConfigurationResponseFromJSON(
  json: any,
): NetworkConfigurationResponse {
  return NetworkConfigurationResponseFromJSONTyped(json, false);
}

export function NetworkConfigurationResponseFromJSONTyped(
  json: any,
  ...
  return {
    ...
    address_types: (json["address_types"] as Array<any>).map(
      AddressTypeFromJSON,
    ),
    well_known_addresses:
      NetworkConfigurationResponseWellKnownAddressesFromJSON(
        json["well_known_addresses"],
      ),
  };
}

export function NetworkConfigurationResponseToJSON(
  value?: NetworkConfigurationResponse | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    ...
    well_known_addresses: NetworkConfigurationResponseWellKnownAddressesToJSON(
      value.well_known_addresses,
    ),
  };
}
