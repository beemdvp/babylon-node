...
export type FlashLedgerTransactionAllOfTypeEnum =
  (typeof FlashLedgerTransactionAllOfTypeEnum)[keyof typeof FlashLedgerTransactionAllOfTypeEnum];
...
export function FlashLedgerTransactionAllOfFromJSON(
  json: any,
): FlashLedgerTransactionAllOf {
  return FlashLedgerTransactionAllOfFromJSONTyped(json, false);
}

export function FlashLedgerTransactionAllOfFromJSONTyped(
  json: any,
  ...
  return {
    name: json["name"],
    flashed_state_updates: FlashedStateUpdatesFromJSON(
      json["flashed_state_updates"],
    ),
    type: !exists(json, "type") ? undefined : json["type"],
  };
}

export function FlashLedgerTransactionAllOfToJSON(
  value?: FlashLedgerTransactionAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    name: value.name,
    flashed_state_updates: FlashedStateUpdatesToJSON(
      value.flashed_state_updates,
    ),
    type: value.type,
  };
}
