...
export type GenericSubstitution =
  | ({ type: "Local" } & LocalGenericSubstitution)
  | ({ type: "Remote" } & RemoteGenericSubstitution);
...
export function GenericSubstitutionFromJSONTyped(
  json: any,
  ...
  switch (json["type"]) {
    case "Local":
      return {
        ...LocalGenericSubstitutionFromJSONTyped(json, true),
        type: "Local",
      };
    case "Remote":
      return {
        ...RemoteGenericSubstitutionFromJSONTyped(json, true),
        type: "Remote",
      };
    default:
      throw new Error(
        `No variant of GenericSubstitution exists with 'type=${json["type"]}'`,
      );
  }
}

export function GenericSubstitutionToJSON(
  value?: GenericSubstitution | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  switch (value["type"]) {
    ...
    default:
      throw new Error(
        `No variant of GenericSubstitution exists with 'type=${value["type"]}'`,
      );
  }
}
