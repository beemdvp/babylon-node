...
export function PrimaryRoleRecoveryAttemptFromJSON(
  json: any,
): PrimaryRoleRecoveryAttempt {
  return PrimaryRoleRecoveryAttemptFromJSONTyped(json, false);
}

export function PrimaryRoleRecoveryAttemptFromJSONTyped(
  json: any,
...
export function PrimaryRoleRecoveryAttemptToJSON(
  value?: PrimaryRoleRecoveryAttempt | null,
): any {
  if (value === undefined) {
    return undefined;
  }
