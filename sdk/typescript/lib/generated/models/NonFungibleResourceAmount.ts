...
export type NonFungibleResourceAmountResourceTypeEnum =
  (typeof NonFungibleResourceAmountResourceTypeEnum)[keyof typeof NonFungibleResourceAmountResourceTypeEnum];
...
export function NonFungibleResourceAmountFromJSON(
  json: any,
): NonFungibleResourceAmount {
  return NonFungibleResourceAmountFromJSONTyped(json, false);
}

export function NonFungibleResourceAmountFromJSONTyped(
  json: any,
...
export function NonFungibleResourceAmountToJSON(
  value?: NonFungibleResourceAmount | null,
): any {
  if (value === undefined) {
    return undefined;
  }
