 ...
 */
export function instanceOfParsedNotarizedTransactionAllOfValidationError(
  value: object,
): boolean {
  let isInstance = true;
...
export function ParsedNotarizedTransactionAllOfValidationErrorFromJSON(
  json: any,
): ParsedNotarizedTransactionAllOfValidationError {
  return ParsedNotarizedTransactionAllOfValidationErrorFromJSONTyped(
    json,
    false,
  );
}

export function ParsedNotarizedTransactionAllOfValidationErrorFromJSONTyped(
  json: any,
...
export function ParsedNotarizedTransactionAllOfValidationErrorToJSON(
  value?: ParsedNotarizedTransactionAllOfValidationError | null,
): any {
  if (value === undefined) {
    return undefined;
  }
