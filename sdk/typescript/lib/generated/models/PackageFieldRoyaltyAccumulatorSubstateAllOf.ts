...
export type PackageFieldRoyaltyAccumulatorSubstateAllOfSubstateTypeEnum =
  (typeof PackageFieldRoyaltyAccumulatorSubstateAllOfSubstateTypeEnum)[keyof typeof PackageFieldRoyaltyAccumulatorSubstateAllOfSubstateTypeEnum];

/**
 * Check if a given object implements the PackageFieldRoyaltyAccumulatorSubstateAllOf interface.
 */
export function instanceOfPackageFieldRoyaltyAccumulatorSubstateAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function PackageFieldRoyaltyAccumulatorSubstateAllOfFromJSON(
  json: any,
): PackageFieldRoyaltyAccumulatorSubstateAllOf {
  return PackageFieldRoyaltyAccumulatorSubstateAllOfFromJSONTyped(json, false);
}

export function PackageFieldRoyaltyAccumulatorSubstateAllOfFromJSONTyped(
  json: any,
...
export function PackageFieldRoyaltyAccumulatorSubstateAllOfToJSON(
  value?: PackageFieldRoyaltyAccumulatorSubstateAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
