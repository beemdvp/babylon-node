...
export type BootLoaderModuleFieldVmBootSubstateSubstateTypeEnum =
  (typeof BootLoaderModuleFieldVmBootSubstateSubstateTypeEnum)[keyof typeof BootLoaderModuleFieldVmBootSubstateSubstateTypeEnum];

/**
 * Check if a given object implements the BootLoaderModuleFieldVmBootSubstate interface.
 */
export function instanceOfBootLoaderModuleFieldVmBootSubstate(
  value: object,
): boolean {
  let isInstance = true;
...
export function BootLoaderModuleFieldVmBootSubstateFromJSON(
  json: any,
): BootLoaderModuleFieldVmBootSubstate {
  return BootLoaderModuleFieldVmBootSubstateFromJSONTyped(json, false);
}

export function BootLoaderModuleFieldVmBootSubstateFromJSONTyped(
  json: any,
...
export function BootLoaderModuleFieldVmBootSubstateToJSON(
  value?: BootLoaderModuleFieldVmBootSubstate | null,
): any {
  if (value === undefined) {
    return undefined;
  }
