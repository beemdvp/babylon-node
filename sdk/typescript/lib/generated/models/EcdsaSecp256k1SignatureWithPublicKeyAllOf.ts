...
export type EcdsaSecp256k1SignatureWithPublicKeyAllOfKeyTypeEnum =
  (typeof EcdsaSecp256k1SignatureWithPublicKeyAllOfKeyTypeEnum)[keyof typeof EcdsaSecp256k1SignatureWithPublicKeyAllOfKeyTypeEnum];

/**
 * Check if a given object implements the EcdsaSecp256k1SignatureWithPublicKeyAllOf interface.
 */
export function instanceOfEcdsaSecp256k1SignatureWithPublicKeyAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function EcdsaSecp256k1SignatureWithPublicKeyAllOfFromJSON(
  json: any,
): EcdsaSecp256k1SignatureWithPublicKeyAllOf {
  return EcdsaSecp256k1SignatureWithPublicKeyAllOfFromJSONTyped(json, false);
}

export function EcdsaSecp256k1SignatureWithPublicKeyAllOfFromJSONTyped(
  json: any,
  ...
  return {
    recoverable_signature: EcdsaSecp256k1SignatureFromJSON(
      json["recoverable_signature"],
    ),
    key_type: !exists(json, "key_type") ? undefined : json["key_type"],
  };
}

export function EcdsaSecp256k1SignatureWithPublicKeyAllOfToJSON(
  value?: EcdsaSecp256k1SignatureWithPublicKeyAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    recoverable_signature: EcdsaSecp256k1SignatureToJSON(
      value.recoverable_signature,
    ),
