...
export type ConsensusLedgerProofOriginAllOfTypeEnum =
  (typeof ConsensusLedgerProofOriginAllOfTypeEnum)[keyof typeof ConsensusLedgerProofOriginAllOfTypeEnum];

/**
 * Check if a given object implements the ConsensusLedgerProofOriginAllOf interface.
 */
export function instanceOfConsensusLedgerProofOriginAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function ConsensusLedgerProofOriginAllOfFromJSON(
  json: any,
): ConsensusLedgerProofOriginAllOf {
  return ConsensusLedgerProofOriginAllOfFromJSONTyped(json, false);
}

export function ConsensusLedgerProofOriginAllOfFromJSONTyped(
  json: any,
  ...
  return {
    ...
    timestamped_signatures: (json["timestamped_signatures"] as Array<any>).map(
      TimestampedValidatorSignatureFromJSON,
    ),
...
export function ConsensusLedgerProofOriginAllOfToJSON(
  value?: ConsensusLedgerProofOriginAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    ...
    timestamped_signatures: (value.timestamped_signatures as Array<any>).map(
      TimestampedValidatorSignatureToJSON,
    ),
    type: value.type,
  };
