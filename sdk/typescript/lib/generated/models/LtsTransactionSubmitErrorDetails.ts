...
export function LtsTransactionSubmitErrorDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): LtsTransactionSubmitErrorDetails {
    ...
    switch (json['type']) {
        ...
        case 'Rejected':
            return {...LtsTransactionSubmitRejectedErrorDetailsFromJSONTyped(json, true), type: 'Rejected'};
        default:
            throw new Error(`No variant of LtsTransactionSubmitErrorDetails exists with 'type=${json['type']}'`);
    }
}

export function LtsTransactionSubmitErrorDetailsToJSON(value?: LtsTransactionSubmitErrorDetails | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    switch (value['type']) {
        ...
        default:
            throw new Error(`No variant of LtsTransactionSubmitErrorDetails exists with 'type=${value['type']}'`);
    }
