...
export type ObjectTypeInfoDetailsTypeEnum =
  (typeof ObjectTypeInfoDetailsTypeEnum)[keyof typeof ObjectTypeInfoDetailsTypeEnum];
...
export function ObjectTypeInfoDetailsFromJSON(
  json: any,
): ObjectTypeInfoDetails {
  return ObjectTypeInfoDetailsFromJSONTyped(json, false);
}

export function ObjectTypeInfoDetailsFromJSONTyped(
  json: any,
...
export function ObjectTypeInfoDetailsToJSON(
  value?: ObjectTypeInfoDetails | null,
): any {
  if (value === undefined) {
    return undefined;
  }
