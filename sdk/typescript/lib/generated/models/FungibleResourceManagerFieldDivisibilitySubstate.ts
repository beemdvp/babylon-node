...
export type FungibleResourceManagerFieldDivisibilitySubstateSubstateTypeEnum =
  (typeof FungibleResourceManagerFieldDivisibilitySubstateSubstateTypeEnum)[keyof typeof FungibleResourceManagerFieldDivisibilitySubstateSubstateTypeEnum];

/**
 * Check if a given object implements the FungibleResourceManagerFieldDivisibilitySubstate interface.
 */
export function instanceOfFungibleResourceManagerFieldDivisibilitySubstate(
  value: object,
): boolean {
  let isInstance = true;
...
export function FungibleResourceManagerFieldDivisibilitySubstateFromJSON(
  json: any,
): FungibleResourceManagerFieldDivisibilitySubstate {
  return FungibleResourceManagerFieldDivisibilitySubstateFromJSONTyped(
    json,
    false,
  );
}

export function FungibleResourceManagerFieldDivisibilitySubstateFromJSONTyped(
  json: any,
...
export function FungibleResourceManagerFieldDivisibilitySubstateToJSON(
  value?: FungibleResourceManagerFieldDivisibilitySubstate | null,
): any {
  if (value === undefined) {
    return undefined;
  }
