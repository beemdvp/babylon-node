...
export function KeyValueBasedStructureFromJSON(
  json: any,
): KeyValueBasedStructure {
  return KeyValueBasedStructureFromJSONTyped(json, false);
}

export function KeyValueBasedStructureFromJSONTyped(
  json: any,
...
export function KeyValueBasedStructureToJSON(
  value?: KeyValueBasedStructure | null,
): any {
  if (value === undefined) {
    return undefined;
  }
