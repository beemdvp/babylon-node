...
export type KeyValueStoreTypeInfoDetailsAllOfTypeEnum =
  (typeof KeyValueStoreTypeInfoDetailsAllOfTypeEnum)[keyof typeof KeyValueStoreTypeInfoDetailsAllOfTypeEnum];

/**
 * Check if a given object implements the KeyValueStoreTypeInfoDetailsAllOf interface.
 */
export function instanceOfKeyValueStoreTypeInfoDetailsAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function KeyValueStoreTypeInfoDetailsAllOfFromJSON(
  json: any,
): KeyValueStoreTypeInfoDetailsAllOf {
  return KeyValueStoreTypeInfoDetailsAllOfFromJSONTyped(json, false);
}

export function KeyValueStoreTypeInfoDetailsAllOfFromJSONTyped(
  json: any,
...
export function KeyValueStoreTypeInfoDetailsAllOfToJSON(
  value?: KeyValueStoreTypeInfoDetailsAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
