...
export type NonFungiblePresentedBadgeTypeEnum =
  (typeof NonFungiblePresentedBadgeTypeEnum)[keyof typeof NonFungiblePresentedBadgeTypeEnum];
...
export function NonFungiblePresentedBadgeFromJSON(
  json: any,
): NonFungiblePresentedBadge {
  return NonFungiblePresentedBadgeFromJSONTyped(json, false);
}

export function NonFungiblePresentedBadgeFromJSONTyped(
  json: any,
...
export function NonFungiblePresentedBadgeToJSON(
  value?: NonFungiblePresentedBadge | null,
): any {
  if (value === undefined) {
    return undefined;
  }
