...
export type SortedIndexBlueprintCollectionSchemaTypeEnum =
  (typeof SortedIndexBlueprintCollectionSchemaTypeEnum)[keyof typeof SortedIndexBlueprintCollectionSchemaTypeEnum];

/**
 * Check if a given object implements the SortedIndexBlueprintCollectionSchema interface.
 */
export function instanceOfSortedIndexBlueprintCollectionSchema(
  value: object,
): boolean {
  let isInstance = true;
...
export function SortedIndexBlueprintCollectionSchemaFromJSON(
  json: any,
): SortedIndexBlueprintCollectionSchema {
  return SortedIndexBlueprintCollectionSchemaFromJSONTyped(json, false);
}

export function SortedIndexBlueprintCollectionSchemaFromJSONTyped(
  json: any,
...
export function SortedIndexBlueprintCollectionSchemaToJSON(
  value?: SortedIndexBlueprintCollectionSchema | null,
): any {
  if (value === undefined) {
    return undefined;
  }
