 ...
 * @export
 */
export const FungibleResourceAmountResourceTypeEnum = {
  Fungible: "Fungible",
} as const;
export type FungibleResourceAmountResourceTypeEnum =
  (typeof FungibleResourceAmountResourceTypeEnum)[keyof typeof FungibleResourceAmountResourceTypeEnum];
...
export function FungibleResourceAmountFromJSON(
  json: any,
): FungibleResourceAmount {
  return FungibleResourceAmountFromJSONTyped(json, false);
}

export function FungibleResourceAmountFromJSONTyped(
  json: any,
...
export function FungibleResourceAmountToJSON(
  value?: FungibleResourceAmount | null,
): any {
  if (value === undefined) {
    return undefined;
  }
