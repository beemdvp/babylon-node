...
export function LedgerTransactionBaseFromJSON(
  json: any,
): LedgerTransactionBase {
  return LedgerTransactionBaseFromJSONTyped(json, false);
}

export function LedgerTransactionBaseFromJSONTyped(
  json: any,
...
export function LedgerTransactionBaseToJSON(
  value?: LedgerTransactionBase | null,
): any {
  if (value === undefined) {
    return undefined;
  }
