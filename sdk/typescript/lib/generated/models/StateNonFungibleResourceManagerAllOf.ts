...
export type StateNonFungibleResourceManagerAllOfResourceTypeEnum =
  (typeof StateNonFungibleResourceManagerAllOfResourceTypeEnum)[keyof typeof StateNonFungibleResourceManagerAllOfResourceTypeEnum];

/**
 * Check if a given object implements the StateNonFungibleResourceManagerAllOf interface.
 */
export function instanceOfStateNonFungibleResourceManagerAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function StateNonFungibleResourceManagerAllOfFromJSON(
  json: any,
): StateNonFungibleResourceManagerAllOf {
  return StateNonFungibleResourceManagerAllOfFromJSONTyped(json, false);
}

export function StateNonFungibleResourceManagerAllOfFromJSONTyped(
  json: any,
  ...
  return {
    ...
    total_supply: !exists(json, "total_supply")
      ? undefined
      : SubstateFromJSON(json["total_supply"]),
    mutable_fields: SubstateFromJSON(json["mutable_fields"]),
    resource_type: !exists(json, "resource_type")
      ? undefined
      : json["resource_type"],
  };
}

export function StateNonFungibleResourceManagerAllOfToJSON(
  value?: StateNonFungibleResourceManagerAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
