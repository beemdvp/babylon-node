 ...
 */
export function instanceOfNetworkConfigurationResponseWellKnownAddresses(
  value: object,
): boolean {
  let isInstance = true;
...
export function NetworkConfigurationResponseWellKnownAddressesFromJSON(
  json: any,
): NetworkConfigurationResponseWellKnownAddresses {
  return NetworkConfigurationResponseWellKnownAddressesFromJSONTyped(
    json,
    false,
  );
}

export function NetworkConfigurationResponseWellKnownAddressesFromJSONTyped(
  json: any,
  ...
  return {
    ...
    secp256k1_signature_virtual_badge:
      json["secp256k1_signature_virtual_badge"],
    ...
    package_of_direct_caller_virtual_badge:
      json["package_of_direct_caller_virtual_badge"],
    ...
    transaction_tracker_package: !exists(json, "transaction_tracker_package")
      ? undefined
      : json["transaction_tracker_package"],
    locker_package: !exists(json, "locker_package")
      ? undefined
      : json["locker_package"],
    test_utils_package: !exists(json, "test_utils_package")
      ? undefined
      : json["test_utils_package"],
...
export function NetworkConfigurationResponseWellKnownAddressesToJSON(
  value?: NetworkConfigurationResponseWellKnownAddresses | null,
): any {
  if (value === undefined) {
    return undefined;
  }
