...
export function BlueprintDefinitionFromJSONTyped(
  json: any,
  ...
  return {
    ...
    function_exports: mapValues(
      json["function_exports"],
      PackageExportFromJSON,
    ),
...
export function BlueprintDefinitionToJSON(
  value?: BlueprintDefinition | null,
): any {
  if (value === undefined) {
    return undefined;
  }
