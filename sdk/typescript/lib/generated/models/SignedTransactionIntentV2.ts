...
export function SignedTransactionIntentV2FromJSON(
  json: any,
): SignedTransactionIntentV2 {
  return SignedTransactionIntentV2FromJSONTyped(json, false);
}

export function SignedTransactionIntentV2FromJSONTyped(
  json: any,
  ...
  return {
    ...
    transaction_intent_signatures: IntentSignaturesFromJSON(
      json["transaction_intent_signatures"],
    ),
    non_root_subintent_signatures: (
      json["non_root_subintent_signatures"] as Array<any>
    ).map(IntentSignaturesFromJSON),
  };
}

export function SignedTransactionIntentV2ToJSON(
  value?: SignedTransactionIntentV2 | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    ...
    transaction_intent_signatures: IntentSignaturesToJSON(
      value.transaction_intent_signatures,
    ),
    non_root_subintent_signatures: (
      value.non_root_subintent_signatures as Array<any>
    ).map(IntentSignaturesToJSON),
  };
}
