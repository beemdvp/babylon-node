...
export function SubstateValueFromJSONTyped(
  json: any,
  ...
  return {
    substate_hex: !exists(json, "substate_hex")
      ? undefined
      : json["substate_hex"],
    substate_data_hash: !exists(json, "substate_data_hash")
      ? undefined
      : json["substate_data_hash"],
    substate_data: !exists(json, "substate_data")
      ? undefined
      : SubstateFromJSON(json["substate_data"]),
  };
}
