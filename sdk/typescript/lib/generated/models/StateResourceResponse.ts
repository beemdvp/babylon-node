...
import {
    ...
    StateResourceManagerFromJSONTyped,
    StateResourceManagerToJSON,
} from './StateResourceManager';
 ...
 * 
 * @export
 * @interface StateResourceResponse
 */
...
/**
 * Check if a given object implements the StateResourceResponse interface.
 */
...
export function StateResourceResponseFromJSON(json: any): StateResourceResponse {
    return StateResourceResponseFromJSONTyped(json, false);
}

export function StateResourceResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): StateResourceResponse {
...
export function StateResourceResponseToJSON(value?: StateResourceResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
