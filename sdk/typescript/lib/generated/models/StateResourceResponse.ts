...
export function StateResourceResponseFromJSON(
  json: any,
): StateResourceResponse {
  return StateResourceResponseFromJSONTyped(json, false);
}

export function StateResourceResponseFromJSONTyped(
  json: any,
...
export function StateResourceResponseToJSON(
  value?: StateResourceResponse | null,
): any {
  if (value === undefined) {
    return undefined;
  }
