...
export interface PreviewFlags {
  /**
   * If enabled, a large simulated pool of RORK is marked as locked.
   *
...
export function PreviewFlagsFromJSONTyped(
  json: any,
  ...
  return {
    use_free_credit: !exists(json, "use_free_credit")
      ? undefined
      : json["use_free_credit"],
    assume_all_signature_proofs: !exists(json, "assume_all_signature_proofs")
      ? undefined
      : json["assume_all_signature_proofs"],
    skip_epoch_check: !exists(json, "skip_epoch_check")
      ? undefined
      : json["skip_epoch_check"],
    disable_auth_checks: !exists(json, "disable_auth_checks")
      ? undefined
      : json["disable_auth_checks"],
  };
}
