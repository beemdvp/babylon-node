...
export type VersionLedgerStateSelectorTypeEnum =
  (typeof VersionLedgerStateSelectorTypeEnum)[keyof typeof VersionLedgerStateSelectorTypeEnum];
...
export function VersionLedgerStateSelectorFromJSON(
  json: any,
): VersionLedgerStateSelector {
  return VersionLedgerStateSelectorFromJSONTyped(json, false);
}

export function VersionLedgerStateSelectorFromJSONTyped(
  json: any,
...
export function VersionLedgerStateSelectorToJSON(
  value?: VersionLedgerStateSelector | null,
): any {
  if (value === undefined) {
    return undefined;
  }
