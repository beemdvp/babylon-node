 ...
 */
export function instanceOfEncryptedMessageCurveDecryptorSet(
  value: object,
): boolean {
  let isInstance = true;
...
export function EncryptedMessageCurveDecryptorSetFromJSON(
  json: any,
): EncryptedMessageCurveDecryptorSet {
  return EncryptedMessageCurveDecryptorSetFromJSONTyped(json, false);
}

export function EncryptedMessageCurveDecryptorSetFromJSONTyped(
  json: any,
  ...
  return {
    ...
    decryptors: (json["decryptors"] as Array<any>).map(
      EncryptedMessageDecryptorFromJSON,
    ),
  };
}

export function EncryptedMessageCurveDecryptorSetToJSON(
  value?: EncryptedMessageCurveDecryptorSet | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    ...
    decryptors: (value.decryptors as Array<any>).map(
      EncryptedMessageDecryptorToJSON,
    ),
  };
}
