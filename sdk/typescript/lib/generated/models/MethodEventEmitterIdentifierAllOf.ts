...
export type MethodEventEmitterIdentifierAllOfTypeEnum =
  (typeof MethodEventEmitterIdentifierAllOfTypeEnum)[keyof typeof MethodEventEmitterIdentifierAllOfTypeEnum];

/**
 * Check if a given object implements the MethodEventEmitterIdentifierAllOf interface.
 */
export function instanceOfMethodEventEmitterIdentifierAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function MethodEventEmitterIdentifierAllOfFromJSON(
  json: any,
): MethodEventEmitterIdentifierAllOf {
  return MethodEventEmitterIdentifierAllOfFromJSONTyped(json, false);
}

export function MethodEventEmitterIdentifierAllOfFromJSONTyped(
  json: any,
...
export function MethodEventEmitterIdentifierAllOfToJSON(
  value?: MethodEventEmitterIdentifierAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
