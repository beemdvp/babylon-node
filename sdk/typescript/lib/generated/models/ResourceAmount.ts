...
export type ResourceAmount =
  | ({ resource_type: "Fungible" } & FungibleResourceAmount)
  | ({ resource_type: "NonFungible" } & NonFungibleResourceAmount);

export function ResourceAmountFromJSON(json: any): ResourceAmount {
  return ResourceAmountFromJSONTyped(json, false);
}

export function ResourceAmountFromJSONTyped(
  json: any,
  ...
  switch (json["resource_type"]) {
    case "Fungible":
      return {
        ...FungibleResourceAmountFromJSONTyped(json, true),
        resource_type: "Fungible",
      };
    case "NonFungible":
      return {
        ...NonFungibleResourceAmountFromJSONTyped(json, true),
        resource_type: "NonFungible",
      };
    default:
      throw new Error(
        `No variant of ResourceAmount exists with 'resource_type=${json["resource_type"]}'`,
      );
  }
}
...
export function ResourceAmountToJSON(value?: ResourceAmount | null): any {
  ...
  switch (value["resource_type"]) {
    ...
    default:
      throw new Error(
        `No variant of ResourceAmount exists with 'resource_type=${value["resource_type"]}'`,
      );
  }
}
