 ...
 * @export
 */
export type LedgerProofOrigin =
  | ({ type: "Consensus" } & ConsensusLedgerProofOrigin)
  | ({ type: "Genesis" } & GenesisLedgerProofOrigin)
  | ({ type: "ProtocolUpdate" } & ProtocolUpdateLedgerProofOrigin);

export function LedgerProofOriginFromJSON(json: any): LedgerProofOrigin {
  return LedgerProofOriginFromJSONTyped(json, false);
}

export function LedgerProofOriginFromJSONTyped(
  json: any,
  ...
  switch (json["type"]) {
    case "Consensus":
      return {
        ...ConsensusLedgerProofOriginFromJSONTyped(json, true),
        type: "Consensus",
      };
    case "Genesis":
      return {
        ...GenesisLedgerProofOriginFromJSONTyped(json, true),
        type: "Genesis",
      };
    case "ProtocolUpdate":
      return {
        ...ProtocolUpdateLedgerProofOriginFromJSONTyped(json, true),
        type: "ProtocolUpdate",
      };
    default:
      throw new Error(
        `No variant of LedgerProofOrigin exists with 'type=${json["type"]}'`,
      );
  }
}
...
export function LedgerProofOriginToJSON(value?: LedgerProofOrigin | null): any {
  ...
  switch (value["type"]) {
    ...
    default:
      throw new Error(
        `No variant of LedgerProofOrigin exists with 'type=${value["type"]}'`,
      );
  }
}
