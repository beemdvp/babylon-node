...
export type FunctionEventEmitterIdentifierAllOfTypeEnum =
  (typeof FunctionEventEmitterIdentifierAllOfTypeEnum)[keyof typeof FunctionEventEmitterIdentifierAllOfTypeEnum];

/**
 * Check if a given object implements the FunctionEventEmitterIdentifierAllOf interface.
 */
export function instanceOfFunctionEventEmitterIdentifierAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function FunctionEventEmitterIdentifierAllOfFromJSON(
  json: any,
): FunctionEventEmitterIdentifierAllOf {
  return FunctionEventEmitterIdentifierAllOfFromJSONTyped(json, false);
}

export function FunctionEventEmitterIdentifierAllOfFromJSONTyped(
  json: any,
...
export function FunctionEventEmitterIdentifierAllOfToJSON(
  value?: FunctionEventEmitterIdentifierAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
