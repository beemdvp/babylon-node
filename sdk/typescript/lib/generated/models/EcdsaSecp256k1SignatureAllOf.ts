...
export type EcdsaSecp256k1SignatureAllOfKeyTypeEnum =
  (typeof EcdsaSecp256k1SignatureAllOfKeyTypeEnum)[keyof typeof EcdsaSecp256k1SignatureAllOfKeyTypeEnum];
...
export function EcdsaSecp256k1SignatureAllOfFromJSON(
  json: any,
): EcdsaSecp256k1SignatureAllOf {
  return EcdsaSecp256k1SignatureAllOfFromJSONTyped(json, false);
}

export function EcdsaSecp256k1SignatureAllOfFromJSONTyped(
  json: any,
...
export function EcdsaSecp256k1SignatureAllOfToJSON(
  value?: EcdsaSecp256k1SignatureAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
