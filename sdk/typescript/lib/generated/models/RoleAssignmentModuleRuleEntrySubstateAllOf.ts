...
export type RoleAssignmentModuleRuleEntrySubstateAllOfSubstateTypeEnum =
  (typeof RoleAssignmentModuleRuleEntrySubstateAllOfSubstateTypeEnum)[keyof typeof RoleAssignmentModuleRuleEntrySubstateAllOfSubstateTypeEnum];

/**
 * Check if a given object implements the RoleAssignmentModuleRuleEntrySubstateAllOf interface.
 */
export function instanceOfRoleAssignmentModuleRuleEntrySubstateAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function RoleAssignmentModuleRuleEntrySubstateAllOfFromJSON(
  json: any,
): RoleAssignmentModuleRuleEntrySubstateAllOf {
  return RoleAssignmentModuleRuleEntrySubstateAllOfFromJSONTyped(json, false);
}

export function RoleAssignmentModuleRuleEntrySubstateAllOfFromJSONTyped(
  json: any,
  ...
  return {
    ...
    value: !exists(json, "value")
      ? undefined
      : RoleAssignmentModuleRuleEntryValueFromJSON(json["value"]),
...
export function RoleAssignmentModuleRuleEntrySubstateAllOfToJSON(
  value?: RoleAssignmentModuleRuleEntrySubstateAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
