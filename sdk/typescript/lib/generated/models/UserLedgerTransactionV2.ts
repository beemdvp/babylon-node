...
export type UserLedgerTransactionV2TypeEnum =
  (typeof UserLedgerTransactionV2TypeEnum)[keyof typeof UserLedgerTransactionV2TypeEnum];
...
export function UserLedgerTransactionV2FromJSON(
  json: any,
): UserLedgerTransactionV2 {
  return UserLedgerTransactionV2FromJSONTyped(json, false);
}

export function UserLedgerTransactionV2FromJSONTyped(
  json: any,
...
export function UserLedgerTransactionV2ToJSON(
  value?: UserLedgerTransactionV2 | null,
): any {
  if (value === undefined) {
    return undefined;
  }
