...
export type CompiledPreviewTransactionAllOfTypeEnum =
  (typeof CompiledPreviewTransactionAllOfTypeEnum)[keyof typeof CompiledPreviewTransactionAllOfTypeEnum];

/**
 * Check if a given object implements the CompiledPreviewTransactionAllOf interface.
 */
export function instanceOfCompiledPreviewTransactionAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function CompiledPreviewTransactionAllOfFromJSON(
  json: any,
): CompiledPreviewTransactionAllOf {
  return CompiledPreviewTransactionAllOfFromJSONTyped(json, false);
}

export function CompiledPreviewTransactionAllOfFromJSONTyped(
  json: any,
...
export function CompiledPreviewTransactionAllOfToJSON(
  value?: CompiledPreviewTransactionAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
