...
export type ConsensusManagerFieldCurrentTimeRoundedToMinutesSubstateSubstateTypeEnum =
  (typeof ConsensusManagerFieldCurrentTimeRoundedToMinutesSubstateSubstateTypeEnum)[keyof typeof ConsensusManagerFieldCurrentTimeRoundedToMinutesSubstateSubstateTypeEnum];

/**
 * Check if a given object implements the ConsensusManagerFieldCurrentTimeRoundedToMinutesSubstate interface.
 */
export function instanceOfConsensusManagerFieldCurrentTimeRoundedToMinutesSubstate(
  value: object,
): boolean {
  let isInstance = true;
...
export function ConsensusManagerFieldCurrentTimeRoundedToMinutesSubstateFromJSON(
  json: any,
): ConsensusManagerFieldCurrentTimeRoundedToMinutesSubstate {
  return ConsensusManagerFieldCurrentTimeRoundedToMinutesSubstateFromJSONTyped(
    json,
    false,
  );
}

export function ConsensusManagerFieldCurrentTimeRoundedToMinutesSubstateFromJSONTyped(
  json: any,
...
export function ConsensusManagerFieldCurrentTimeRoundedToMinutesSubstateToJSON(
  value?: ConsensusManagerFieldCurrentTimeRoundedToMinutesSubstate | null,
): any {
  if (value === undefined) {
    return undefined;
  }
