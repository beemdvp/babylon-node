...
export function FieldSchemaFromJSONTyped(
  json: any,
  ...
  return {
    ...
    condition: !exists(json, "condition")
      ? undefined
      : FieldSchemaFeatureConditionFromJSON(json["condition"]),
    transient_default_value_hex: !exists(json, "transient_default_value_hex")
      ? undefined
      : json["transient_default_value_hex"],
  };
}
