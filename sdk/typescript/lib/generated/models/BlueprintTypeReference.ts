 ...
 * @export
 */
export type BlueprintTypeReference =
  | ({ type: "BlueprintSchema" } & BlueprintSchemaBlueprintTypeReference)
  | ({ type: "InstanceSchema" } & InstanceSchemaBlueprintTypeReference);

export function BlueprintTypeReferenceFromJSON(
  json: any,
): BlueprintTypeReference {
  return BlueprintTypeReferenceFromJSONTyped(json, false);
}

export function BlueprintTypeReferenceFromJSONTyped(
  json: any,
  ...
  switch (json["type"]) {
    case "BlueprintSchema":
      return {
        ...BlueprintSchemaBlueprintTypeReferenceFromJSONTyped(json, true),
        type: "BlueprintSchema",
      };
    case "InstanceSchema":
      return {
        ...InstanceSchemaBlueprintTypeReferenceFromJSONTyped(json, true),
        type: "InstanceSchema",
      };
    default:
      throw new Error(
        `No variant of BlueprintTypeReference exists with 'type=${json["type"]}'`,
      );
  }
}

export function BlueprintTypeReferenceToJSON(
  value?: BlueprintTypeReference | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  switch (value["type"]) {
    ...
    default:
      throw new Error(
        `No variant of BlueprintTypeReference exists with 'type=${value["type"]}'`,
      );
  }
}
