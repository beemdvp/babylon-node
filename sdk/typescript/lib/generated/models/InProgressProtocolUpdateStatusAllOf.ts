...
export type InProgressProtocolUpdateStatusAllOfTypeEnum =
  (typeof InProgressProtocolUpdateStatusAllOfTypeEnum)[keyof typeof InProgressProtocolUpdateStatusAllOfTypeEnum];

/**
 * Check if a given object implements the InProgressProtocolUpdateStatusAllOf interface.
 */
export function instanceOfInProgressProtocolUpdateStatusAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function InProgressProtocolUpdateStatusAllOfFromJSON(
  json: any,
): InProgressProtocolUpdateStatusAllOf {
  return InProgressProtocolUpdateStatusAllOfFromJSONTyped(json, false);
}

export function InProgressProtocolUpdateStatusAllOfFromJSONTyped(
  json: any,
...
export function InProgressProtocolUpdateStatusAllOfToJSON(
  value?: InProgressProtocolUpdateStatusAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
