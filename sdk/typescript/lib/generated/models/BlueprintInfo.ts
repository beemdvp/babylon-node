...
export function BlueprintInfoFromJSONTyped(
  json: any,
  ...
  return {
    ...
    outer_object: !exists(json, "outer_object")
      ? undefined
      : json["outer_object"],
    features: json["features"],
    generic_substitutions: (json["generic_substitutions"] as Array<any>).map(
      GenericSubstitutionFromJSON,
    ),
  };
}
...
export function BlueprintInfoToJSON(value?: BlueprintInfo | null): any {
  ...
  return {
    ...
    generic_substitutions: (value.generic_substitutions as Array<any>).map(
      GenericSubstitutionToJSON,
    ),
  };
}
