...
export type FunctionEventEmitterIdentifierTypeEnum =
  (typeof FunctionEventEmitterIdentifierTypeEnum)[keyof typeof FunctionEventEmitterIdentifierTypeEnum];

/**
 * Check if a given object implements the FunctionEventEmitterIdentifier interface.
 */
export function instanceOfFunctionEventEmitterIdentifier(
  value: object,
): boolean {
  let isInstance = true;
...
export function FunctionEventEmitterIdentifierFromJSON(
  json: any,
): FunctionEventEmitterIdentifier {
  return FunctionEventEmitterIdentifierFromJSONTyped(json, false);
}

export function FunctionEventEmitterIdentifierFromJSONTyped(
  json: any,
...
export function FunctionEventEmitterIdentifierToJSON(
  value?: FunctionEventEmitterIdentifier | null,
): any {
  if (value === undefined) {
    return undefined;
  }
