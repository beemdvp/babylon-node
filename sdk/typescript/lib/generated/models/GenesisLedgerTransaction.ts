...
export type GenesisLedgerTransactionTypeEnum =
  (typeof GenesisLedgerTransactionTypeEnum)[keyof typeof GenesisLedgerTransactionTypeEnum];
...
export function GenesisLedgerTransactionFromJSON(
  json: any,
): GenesisLedgerTransaction {
  return GenesisLedgerTransactionFromJSONTyped(json, false);
}

export function GenesisLedgerTransactionFromJSONTyped(
  json: any,
...
export function GenesisLedgerTransactionToJSON(
  value?: GenesisLedgerTransaction | null,
): any {
  if (value === undefined) {
    return undefined;
  }
