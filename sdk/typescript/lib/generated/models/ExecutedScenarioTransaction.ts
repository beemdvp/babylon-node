...
export function ExecutedScenarioTransactionFromJSON(
  json: any,
): ExecutedScenarioTransaction {
  return ExecutedScenarioTransactionFromJSONTyped(json, false);
}

export function ExecutedScenarioTransactionFromJSONTyped(
  json: any,
...
export function ExecutedScenarioTransactionToJSON(
  value?: ExecutedScenarioTransaction | null,
): any {
  if (value === undefined) {
    return undefined;
  }
