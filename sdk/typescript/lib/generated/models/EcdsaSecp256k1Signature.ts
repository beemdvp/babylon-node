...
export type EcdsaSecp256k1SignatureKeyTypeEnum =
  (typeof EcdsaSecp256k1SignatureKeyTypeEnum)[keyof typeof EcdsaSecp256k1SignatureKeyTypeEnum];
...
export function EcdsaSecp256k1SignatureFromJSON(
  json: any,
): EcdsaSecp256k1Signature {
  return EcdsaSecp256k1SignatureFromJSONTyped(json, false);
}

export function EcdsaSecp256k1SignatureFromJSONTyped(
  json: any,
...
export function EcdsaSecp256k1SignatureToJSON(
  value?: EcdsaSecp256k1Signature | null,
): any {
  if (value === undefined) {
    return undefined;
  }
