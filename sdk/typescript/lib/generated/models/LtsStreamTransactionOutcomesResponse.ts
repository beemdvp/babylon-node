 ...
 */
export function instanceOfLtsStreamTransactionOutcomesResponse(
  value: object,
): boolean {
  let isInstance = true;
...
export function LtsStreamTransactionOutcomesResponseFromJSON(
  json: any,
): LtsStreamTransactionOutcomesResponse {
  return LtsStreamTransactionOutcomesResponseFromJSONTyped(json, false);
}

export function LtsStreamTransactionOutcomesResponseFromJSONTyped(
  json: any,
...
export function LtsStreamTransactionOutcomesResponseToJSON(
  value?: LtsStreamTransactionOutcomesResponse | null,
): any {
  if (value === undefined) {
    return undefined;
  }
