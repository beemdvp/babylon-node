...
export type FungibleResourceManagerFieldDivisibilitySubstateAllOfSubstateTypeEnum =
  (typeof FungibleResourceManagerFieldDivisibilitySubstateAllOfSubstateTypeEnum)[keyof typeof FungibleResourceManagerFieldDivisibilitySubstateAllOfSubstateTypeEnum];

/**
 * Check if a given object implements the FungibleResourceManagerFieldDivisibilitySubstateAllOf interface.
 */
export function instanceOfFungibleResourceManagerFieldDivisibilitySubstateAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function FungibleResourceManagerFieldDivisibilitySubstateAllOfFromJSON(
  json: any,
): FungibleResourceManagerFieldDivisibilitySubstateAllOf {
  return FungibleResourceManagerFieldDivisibilitySubstateAllOfFromJSONTyped(
    json,
    false,
  );
}

export function FungibleResourceManagerFieldDivisibilitySubstateAllOfFromJSONTyped(
  json: any,
...
export function FungibleResourceManagerFieldDivisibilitySubstateAllOfToJSON(
  value?: FungibleResourceManagerFieldDivisibilitySubstateAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
