...
export type NonFungibleRequirementAllOfTypeEnum =
  (typeof NonFungibleRequirementAllOfTypeEnum)[keyof typeof NonFungibleRequirementAllOfTypeEnum];
...
export function NonFungibleRequirementAllOfFromJSON(
  json: any,
): NonFungibleRequirementAllOf {
  return NonFungibleRequirementAllOfFromJSONTyped(json, false);
}

export function NonFungibleRequirementAllOfFromJSONTyped(
  json: any,
...
export function NonFungibleRequirementAllOfToJSON(
  value?: NonFungibleRequirementAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
