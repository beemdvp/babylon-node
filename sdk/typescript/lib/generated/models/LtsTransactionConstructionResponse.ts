 ...
 */
export function instanceOfLtsTransactionConstructionResponse(
  value: object,
): boolean {
  let isInstance = true;
...
export function LtsTransactionConstructionResponseFromJSON(
  json: any,
): LtsTransactionConstructionResponse {
  return LtsTransactionConstructionResponseFromJSONTyped(json, false);
}

export function LtsTransactionConstructionResponseFromJSONTyped(
  json: any,
...
export function LtsTransactionConstructionResponseToJSON(
  value?: LtsTransactionConstructionResponse | null,
): any {
  if (value === undefined) {
    return undefined;
  }
