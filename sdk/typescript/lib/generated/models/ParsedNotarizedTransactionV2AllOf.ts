...
export type ParsedNotarizedTransactionV2AllOfTypeEnum =
  (typeof ParsedNotarizedTransactionV2AllOfTypeEnum)[keyof typeof ParsedNotarizedTransactionV2AllOfTypeEnum];

/**
 * Check if a given object implements the ParsedNotarizedTransactionV2AllOf interface.
 */
export function instanceOfParsedNotarizedTransactionV2AllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function ParsedNotarizedTransactionV2AllOfFromJSON(
  json: any,
): ParsedNotarizedTransactionV2AllOf {
  return ParsedNotarizedTransactionV2AllOfFromJSONTyped(json, false);
}

export function ParsedNotarizedTransactionV2AllOfFromJSONTyped(
  json: any,
...
export function ParsedNotarizedTransactionV2AllOfToJSON(
  value?: ParsedNotarizedTransactionV2AllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
