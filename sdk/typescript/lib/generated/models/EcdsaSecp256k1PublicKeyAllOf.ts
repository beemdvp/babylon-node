...
export type EcdsaSecp256k1PublicKeyAllOfKeyTypeEnum =
  (typeof EcdsaSecp256k1PublicKeyAllOfKeyTypeEnum)[keyof typeof EcdsaSecp256k1PublicKeyAllOfKeyTypeEnum];
...
export function EcdsaSecp256k1PublicKeyAllOfFromJSON(
  json: any,
): EcdsaSecp256k1PublicKeyAllOf {
  return EcdsaSecp256k1PublicKeyAllOfFromJSONTyped(json, false);
}

export function EcdsaSecp256k1PublicKeyAllOfFromJSONTyped(
  json: any,
...
export function EcdsaSecp256k1PublicKeyAllOfToJSON(
  value?: EcdsaSecp256k1PublicKeyAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
