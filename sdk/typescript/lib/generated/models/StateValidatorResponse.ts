...
export function StateValidatorResponseFromJSON(
  json: any,
): StateValidatorResponse {
  return StateValidatorResponseFromJSONTyped(json, false);
}

export function StateValidatorResponseFromJSONTyped(
  json: any,
  ...
  return {
    ...
    protocol_update_readiness_signal: SubstateFromJSON(
      json["protocol_update_readiness_signal"],
    ),
    owner_role: SubstateFromJSON(json["owner_role"]),
    vaults: (json["vaults"] as Array<any>).map(VaultBalanceFromJSON),
    descendent_nodes: (json["descendent_nodes"] as Array<any>).map(
      StateComponentDescendentNodeFromJSON,
    ),
  };
}

export function StateValidatorResponseToJSON(
  value?: StateValidatorResponse | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    ...
    protocol_update_readiness_signal: SubstateToJSON(
      value.protocol_update_readiness_signal,
    ),
    owner_role: SubstateToJSON(value.owner_role),
    vaults: (value.vaults as Array<any>).map(VaultBalanceToJSON),
    descendent_nodes: (value.descendent_nodes as Array<any>).map(
      StateComponentDescendentNodeToJSON,
    ),
  };
}
