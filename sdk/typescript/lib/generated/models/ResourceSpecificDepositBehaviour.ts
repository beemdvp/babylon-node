...
export interface ResourceSpecificDepositBehaviour {
  ...
  /**
   * Whether the resource represents the native RORK fungible.
   * RORK is a special case which does not require `vault_exists = true` to satisfy the `AllowExisting` rule.
   * @type {boolean}
   * @memberof ResourceSpecificDepositBehaviour
   */
  is_xrd: boolean;
 ...
 */
export function instanceOfResourceSpecificDepositBehaviour(
  value: object,
): boolean {
  let isInstance = true;
...
export function ResourceSpecificDepositBehaviourFromJSON(
  json: any,
): ResourceSpecificDepositBehaviour {
  return ResourceSpecificDepositBehaviourFromJSONTyped(json, false);
}

export function ResourceSpecificDepositBehaviourFromJSONTyped(
  json: any,
  ...
  return {
    resource_preference: !exists(json, "resource_preference")
      ? undefined
      : ResourcePreferenceFromJSON(json["resource_preference"]),
...
export function ResourceSpecificDepositBehaviourToJSON(
  value?: ResourceSpecificDepositBehaviour | null,
): any {
  if (value === undefined) {
    return undefined;
  }
