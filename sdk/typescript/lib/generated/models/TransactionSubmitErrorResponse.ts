...
export type TransactionSubmitErrorResponseErrorTypeEnum =
  (typeof TransactionSubmitErrorResponseErrorTypeEnum)[keyof typeof TransactionSubmitErrorResponseErrorTypeEnum];

/**
 * Check if a given object implements the TransactionSubmitErrorResponse interface.
 */
export function instanceOfTransactionSubmitErrorResponse(
  value: object,
): boolean {
  let isInstance = true;
...
export function TransactionSubmitErrorResponseFromJSON(
  json: any,
): TransactionSubmitErrorResponse {
  return TransactionSubmitErrorResponseFromJSONTyped(json, false);
}

export function TransactionSubmitErrorResponseFromJSONTyped(
  json: any,
...
export function TransactionSubmitErrorResponseToJSON(
  value?: TransactionSubmitErrorResponse | null,
): any {
  if (value === undefined) {
    return undefined;
  }
