...
export function BlueprintInterfaceFromJSONTyped(
  json: any,
  ...
  return {
    outer_blueprint: !exists(json, "outer_blueprint")
      ? undefined
      : json["outer_blueprint"],
    generic_type_parameters: (
      json["generic_type_parameters"] as Array<any>
    ).map(GenericTypeParameterFromJSON),
...
export function BlueprintInterfaceToJSON(
  value?: BlueprintInterface | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    ...
    generic_type_parameters: (value.generic_type_parameters as Array<any>).map(
      GenericTypeParameterToJSON,
    ),
