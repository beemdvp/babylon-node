...
export type KeyValueBlueprintCollectionSchemaTypeEnum =
  (typeof KeyValueBlueprintCollectionSchemaTypeEnum)[keyof typeof KeyValueBlueprintCollectionSchemaTypeEnum];

/**
 * Check if a given object implements the KeyValueBlueprintCollectionSchema interface.
 */
export function instanceOfKeyValueBlueprintCollectionSchema(
  value: object,
): boolean {
  let isInstance = true;
...
export function KeyValueBlueprintCollectionSchemaFromJSON(
  json: any,
): KeyValueBlueprintCollectionSchema {
  return KeyValueBlueprintCollectionSchemaFromJSONTyped(json, false);
}

export function KeyValueBlueprintCollectionSchemaFromJSONTyped(
  json: any,
...
export function KeyValueBlueprintCollectionSchemaToJSON(
  value?: KeyValueBlueprintCollectionSchema | null,
): any {
  if (value === undefined) {
    return undefined;
  }
