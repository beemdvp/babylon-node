...
export function GenericSubstitutionBaseFromJSON(
  json: any,
): GenericSubstitutionBase {
  return GenericSubstitutionBaseFromJSONTyped(json, false);
}

export function GenericSubstitutionBaseFromJSONTyped(
  json: any,
...
export function GenericSubstitutionBaseToJSON(
  value?: GenericSubstitutionBase | null,
): any {
  if (value === undefined) {
    return undefined;
  }
