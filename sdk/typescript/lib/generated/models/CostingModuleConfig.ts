...
export interface CostingModuleConfig {
  /**
   * The string-encoded decimal representing the maximum amount of RORK configurable for a single function's royalty.
...
export function instanceOfCostingModuleConfig(value: object): boolean {
  ...
  isInstance =
    isInstance && "apply_execution_cost_for_all_system_calls" in value;
...
export function CostingModuleConfigFromJSONTyped(
  json: any,
  ...
  return {
    ...
    apply_execution_cost_for_all_system_calls:
      json["apply_execution_cost_for_all_system_calls"],
    apply_boot_ref_check_costing: json["apply_boot_ref_check_costing"],
  };
}

export function CostingModuleConfigToJSON(
  value?: CostingModuleConfig | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    ...
    apply_execution_cost_for_all_system_calls:
      value.apply_execution_cost_for_all_system_calls,
