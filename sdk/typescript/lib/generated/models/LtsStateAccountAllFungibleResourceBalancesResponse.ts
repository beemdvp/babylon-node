 ...
 *
 * @export
 * @interface LtsStateAccountAllFungibleResourceBalancesResponse
 */
export interface LtsStateAccountAllFungibleResourceBalancesResponse {
   ...
   * @type {Array<LtsFungibleResourceBalance>}
   * @memberof LtsStateAccountAllFungibleResourceBalancesResponse
   */
...
/**
 * Check if a given object implements the LtsStateAccountAllFungibleResourceBalancesResponse interface.
 */
export function instanceOfLtsStateAccountAllFungibleResourceBalancesResponse(
  value: object,
): boolean {
  let isInstance = true;
...
export function LtsStateAccountAllFungibleResourceBalancesResponseFromJSON(
  json: any,
): LtsStateAccountAllFungibleResourceBalancesResponse {
  return LtsStateAccountAllFungibleResourceBalancesResponseFromJSONTyped(
    json,
    false,
  );
}

export function LtsStateAccountAllFungibleResourceBalancesResponseFromJSONTyped(
  json: any,
  ...
  return {
    ...
    ledger_header_summary: LedgerHeaderSummaryFromJSON(
      json["ledger_header_summary"],
    ),
    account_address: json["account_address"],
    fungible_resource_balances: (
      json["fungible_resource_balances"] as Array<any>
    ).map(LtsFungibleResourceBalanceFromJSON),
  };
}

export function LtsStateAccountAllFungibleResourceBalancesResponseToJSON(
  value?: LtsStateAccountAllFungibleResourceBalancesResponse | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    ...
    ledger_header_summary: LedgerHeaderSummaryToJSON(
      value.ledger_header_summary,
    ),
    account_address: value.account_address,
    fungible_resource_balances: (
      value.fungible_resource_balances as Array<any>
    ).map(LtsFungibleResourceBalanceToJSON),
  };
}
