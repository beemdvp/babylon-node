 ...
 */
export function instanceOfProtocolUpdateStatusLatestCommit(
  value: object,
): boolean {
  let isInstance = true;
...
export function ProtocolUpdateStatusLatestCommitFromJSON(
  json: any,
): ProtocolUpdateStatusLatestCommit {
  return ProtocolUpdateStatusLatestCommitFromJSONTyped(json, false);
}

export function ProtocolUpdateStatusLatestCommitFromJSONTyped(
  json: any,
...
export function ProtocolUpdateStatusLatestCommitToJSON(
  value?: ProtocolUpdateStatusLatestCommit | null,
): any {
  if (value === undefined) {
    return undefined;
  }
