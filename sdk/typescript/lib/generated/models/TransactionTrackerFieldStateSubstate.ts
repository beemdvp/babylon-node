...
export type TransactionTrackerFieldStateSubstateSubstateTypeEnum =
  (typeof TransactionTrackerFieldStateSubstateSubstateTypeEnum)[keyof typeof TransactionTrackerFieldStateSubstateSubstateTypeEnum];

/**
 * Check if a given object implements the TransactionTrackerFieldStateSubstate interface.
 */
export function instanceOfTransactionTrackerFieldStateSubstate(
  value: object,
): boolean {
  let isInstance = true;
...
export function TransactionTrackerFieldStateSubstateFromJSON(
  json: any,
): TransactionTrackerFieldStateSubstate {
  return TransactionTrackerFieldStateSubstateFromJSONTyped(json, false);
}

export function TransactionTrackerFieldStateSubstateFromJSONTyped(
  json: any,
...
export function TransactionTrackerFieldStateSubstateToJSON(
  value?: TransactionTrackerFieldStateSubstate | null,
): any {
  if (value === undefined) {
    return undefined;
  }
