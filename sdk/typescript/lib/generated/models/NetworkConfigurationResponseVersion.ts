 ...
 */
export function instanceOfNetworkConfigurationResponseVersion(
  value: object,
): boolean {
  let isInstance = true;
...
export function NetworkConfigurationResponseVersionFromJSON(
  json: any,
): NetworkConfigurationResponseVersion {
  return NetworkConfigurationResponseVersionFromJSONTyped(json, false);
}

export function NetworkConfigurationResponseVersionFromJSONTyped(
  json: any,
...
export function NetworkConfigurationResponseVersionToJSON(
  value?: NetworkConfigurationResponseVersion | null,
): any {
  if (value === undefined) {
    return undefined;
  }
