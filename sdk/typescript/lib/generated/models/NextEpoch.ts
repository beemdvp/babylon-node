...
export function NextEpochFromJSONTyped(
  json: any,
  ...
  return {
    ...
    significant_protocol_update_readiness: !exists(
      json,
      "significant_protocol_update_readiness",
    )
      ? undefined
      : (json["significant_protocol_update_readiness"] as Array<any>).map(
          SignificantProtocolUpdateReadinessEntryFromJSON,
        ),
  };
}
...
export function NextEpochToJSON(value?: NextEpoch | null): any {
  ...
  return {
    ...
    significant_protocol_update_readiness:
      value.significant_protocol_update_readiness === undefined
        ? undefined
        : (value.significant_protocol_update_readiness as Array<any>).map(
            SignificantProtocolUpdateReadinessEntryToJSON,
          ),
  };
}
