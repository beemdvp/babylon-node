...
export type StaticBlueprintPayloadDefAllOfTypeEnum =
  (typeof StaticBlueprintPayloadDefAllOfTypeEnum)[keyof typeof StaticBlueprintPayloadDefAllOfTypeEnum];

/**
 * Check if a given object implements the StaticBlueprintPayloadDefAllOf interface.
 */
export function instanceOfStaticBlueprintPayloadDefAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function StaticBlueprintPayloadDefAllOfFromJSON(
  json: any,
): StaticBlueprintPayloadDefAllOf {
  return StaticBlueprintPayloadDefAllOfFromJSONTyped(json, false);
}

export function StaticBlueprintPayloadDefAllOfFromJSONTyped(
  json: any,
...
export function StaticBlueprintPayloadDefAllOfToJSON(
  value?: StaticBlueprintPayloadDefAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
