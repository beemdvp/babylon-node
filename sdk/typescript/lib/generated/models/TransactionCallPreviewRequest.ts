 ...
 */
export function instanceOfTransactionCallPreviewRequest(
  value: object,
): boolean {
  let isInstance = true;
...
export function TransactionCallPreviewRequestFromJSON(
  json: any,
): TransactionCallPreviewRequest {
  return TransactionCallPreviewRequestFromJSONTyped(json, false);
}

export function TransactionCallPreviewRequestFromJSONTyped(
  json: any,
...
export function TransactionCallPreviewRequestToJSON(
  value?: TransactionCallPreviewRequest | null,
): any {
  if (value === undefined) {
    return undefined;
  }
