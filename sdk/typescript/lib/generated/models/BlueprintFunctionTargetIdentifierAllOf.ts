...
export type BlueprintFunctionTargetIdentifierAllOfTypeEnum =
  (typeof BlueprintFunctionTargetIdentifierAllOfTypeEnum)[keyof typeof BlueprintFunctionTargetIdentifierAllOfTypeEnum];

/**
 * Check if a given object implements the BlueprintFunctionTargetIdentifierAllOf interface.
 */
export function instanceOfBlueprintFunctionTargetIdentifierAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function BlueprintFunctionTargetIdentifierAllOfFromJSON(
  json: any,
): BlueprintFunctionTargetIdentifierAllOf {
  return BlueprintFunctionTargetIdentifierAllOfFromJSONTyped(json, false);
}

export function BlueprintFunctionTargetIdentifierAllOfFromJSONTyped(
  json: any,
...
export function BlueprintFunctionTargetIdentifierAllOfToJSON(
  value?: BlueprintFunctionTargetIdentifierAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
