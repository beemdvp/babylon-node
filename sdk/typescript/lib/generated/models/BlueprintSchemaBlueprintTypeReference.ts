...
export type BlueprintSchemaBlueprintTypeReferenceTypeEnum =
  (typeof BlueprintSchemaBlueprintTypeReferenceTypeEnum)[keyof typeof BlueprintSchemaBlueprintTypeReferenceTypeEnum];

/**
 * Check if a given object implements the BlueprintSchemaBlueprintTypeReference interface.
 */
export function instanceOfBlueprintSchemaBlueprintTypeReference(
  value: object,
): boolean {
  let isInstance = true;
...
export function BlueprintSchemaBlueprintTypeReferenceFromJSON(
  json: any,
): BlueprintSchemaBlueprintTypeReference {
  return BlueprintSchemaBlueprintTypeReferenceFromJSONTyped(json, false);
}

export function BlueprintSchemaBlueprintTypeReferenceFromJSONTyped(
  json: any,
...
export function BlueprintSchemaBlueprintTypeReferenceToJSON(
  value?: BlueprintSchemaBlueprintTypeReference | null,
): any {
  if (value === undefined) {
    return undefined;
  }
