...
export type ConsensusManagerFieldConfigSubstateSubstateTypeEnum =
  (typeof ConsensusManagerFieldConfigSubstateSubstateTypeEnum)[keyof typeof ConsensusManagerFieldConfigSubstateSubstateTypeEnum];

/**
 * Check if a given object implements the ConsensusManagerFieldConfigSubstate interface.
 */
export function instanceOfConsensusManagerFieldConfigSubstate(
  value: object,
): boolean {
  let isInstance = true;
...
export function ConsensusManagerFieldConfigSubstateFromJSON(
  json: any,
): ConsensusManagerFieldConfigSubstate {
  return ConsensusManagerFieldConfigSubstateFromJSONTyped(json, false);
}

export function ConsensusManagerFieldConfigSubstateFromJSONTyped(
  json: any,
...
export function ConsensusManagerFieldConfigSubstateToJSON(
  value?: ConsensusManagerFieldConfigSubstate | null,
): any {
  if (value === undefined) {
    return undefined;
  }
