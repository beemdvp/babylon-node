 ...
 */
export function instanceOfLtsStreamAccountTransactionOutcomesRequest(
  value: object,
): boolean {
  let isInstance = true;
...
export function LtsStreamAccountTransactionOutcomesRequestFromJSON(
  json: any,
): LtsStreamAccountTransactionOutcomesRequest {
  return LtsStreamAccountTransactionOutcomesRequestFromJSONTyped(json, false);
}

export function LtsStreamAccountTransactionOutcomesRequestFromJSONTyped(
  json: any,
...
export function LtsStreamAccountTransactionOutcomesRequestToJSON(
  value?: LtsStreamAccountTransactionOutcomesRequest | null,
): any {
  if (value === undefined) {
    return undefined;
  }
