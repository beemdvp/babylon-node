...
export type ValidatorFieldProtocolUpdateReadinessSignalSubstateAllOfSubstateTypeEnum =
  (typeof ValidatorFieldProtocolUpdateReadinessSignalSubstateAllOfSubstateTypeEnum)[keyof typeof ValidatorFieldProtocolUpdateReadinessSignalSubstateAllOfSubstateTypeEnum];

/**
 * Check if a given object implements the ValidatorFieldProtocolUpdateReadinessSignalSubstateAllOf interface.
 */
export function instanceOfValidatorFieldProtocolUpdateReadinessSignalSubstateAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function ValidatorFieldProtocolUpdateReadinessSignalSubstateAllOfFromJSON(
  json: any,
): ValidatorFieldProtocolUpdateReadinessSignalSubstateAllOf {
  return ValidatorFieldProtocolUpdateReadinessSignalSubstateAllOfFromJSONTyped(
    json,
    false,
  );
}

export function ValidatorFieldProtocolUpdateReadinessSignalSubstateAllOfFromJSONTyped(
  json: any,
...
export function ValidatorFieldProtocolUpdateReadinessSignalSubstateAllOfToJSON(
  value?: ValidatorFieldProtocolUpdateReadinessSignalSubstateAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
