...
export function TransactionReceiptFromJSONTyped(
  json: any,
  ...
  return {
    ...
    fee_source: !exists(json, "fee_source")
      ? undefined
      : FeeSourceFromJSON(json["fee_source"]),
    fee_destination: !exists(json, "fee_destination")
      ? undefined
      : FeeDestinationFromJSON(json["fee_destination"]),
    state_updates: StateUpdatesFromJSON(json["state_updates"]),
    events: !exists(json, "events")
      ? undefined
      : (json["events"] as Array<any>).map(EventFromJSON),
    next_epoch: !exists(json, "next_epoch")
      ? undefined
      : NextEpochFromJSON(json["next_epoch"]),
    output: !exists(json, "output")
      ? undefined
      : (json["output"] as Array<any>).map(SborDataFromJSON),
    error_message: !exists(json, "error_message")
      ? undefined
      : json["error_message"],
  };
}

export function TransactionReceiptToJSON(
  value?: TransactionReceipt | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    ...
    output:
      value.output === undefined
        ? undefined
        : (value.output as Array<any>).map(SborDataToJSON),
