...
export type GenesisLedgerProofOriginAllOfTypeEnum =
  (typeof GenesisLedgerProofOriginAllOfTypeEnum)[keyof typeof GenesisLedgerProofOriginAllOfTypeEnum];

/**
 * Check if a given object implements the GenesisLedgerProofOriginAllOf interface.
 */
export function instanceOfGenesisLedgerProofOriginAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function GenesisLedgerProofOriginAllOfFromJSON(
  json: any,
): GenesisLedgerProofOriginAllOf {
  return GenesisLedgerProofOriginAllOfFromJSONTyped(json, false);
}

export function GenesisLedgerProofOriginAllOfFromJSONTyped(
  json: any,
...
export function GenesisLedgerProofOriginAllOfToJSON(
  value?: GenesisLedgerProofOriginAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
