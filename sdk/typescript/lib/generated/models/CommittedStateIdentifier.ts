...
export function CommittedStateIdentifierFromJSON(
  json: any,
): CommittedStateIdentifier {
  return CommittedStateIdentifierFromJSONTyped(json, false);
}

export function CommittedStateIdentifierFromJSONTyped(
  json: any,
...
export function CommittedStateIdentifierToJSON(
  value?: CommittedStateIdentifier | null,
): any {
  if (value === undefined) {
    return undefined;
  }
