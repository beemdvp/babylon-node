...
export function TransactionIntentV2FromJSONTyped(
  json: any,
  ...
  return {
    ...
    non_root_subintents: (json["non_root_subintents"] as Array<any>).map(
      SubintentV2FromJSON,
    ),
  };
}

export function TransactionIntentV2ToJSON(
  value?: TransactionIntentV2 | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    ...
    non_root_subintents: (value.non_root_subintents as Array<any>).map(
      SubintentV2ToJSON,
    ),
  };
}
