...
export type FieldSubstateKeyAllOfKeyTypeEnum =
  (typeof FieldSubstateKeyAllOfKeyTypeEnum)[keyof typeof FieldSubstateKeyAllOfKeyTypeEnum];
...
export function FieldSubstateKeyAllOfFromJSON(
  json: any,
): FieldSubstateKeyAllOf {
  return FieldSubstateKeyAllOfFromJSONTyped(json, false);
}

export function FieldSubstateKeyAllOfFromJSONTyped(
  json: any,
...
export function FieldSubstateKeyAllOfToJSON(
  value?: FieldSubstateKeyAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
