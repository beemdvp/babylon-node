 ...
 * @export
 */
export type SignatureWithPublicKey = { key_type: 'EcdsaSecp256k1' } & EcdsaSecp256k1SignatureWithPublicKey | { key_type: 'EddsaEd25519' } & EddsaEd25519SignatureWithPublicKey;
...
export function SignatureWithPublicKeyFromJSONTyped(json: any, ignoreDiscriminator: boolean): SignatureWithPublicKey {
    ...
    switch (json['key_type']) {
        case 'EcdsaSecp256k1':
            return {...EcdsaSecp256k1SignatureWithPublicKeyFromJSONTyped(json, true), key_type: 'EcdsaSecp256k1'};
        case 'EddsaEd25519':
            return {...EddsaEd25519SignatureWithPublicKeyFromJSONTyped(json, true), key_type: 'EddsaEd25519'};
        default:
            throw new Error(`No variant of SignatureWithPublicKey exists with 'key_type=${json['key_type']}'`);
    }
}
...
export function SignatureWithPublicKeyToJSON(value?: SignatureWithPublicKey | null): any {
    ...
    switch (value['key_type']) {
        ...
        default:
            throw new Error(`No variant of SignatureWithPublicKey exists with 'key_type=${value['key_type']}'`);
    }
