...
export function RecoveryRoleRecoveryAttemptFromJSON(
  json: any,
): RecoveryRoleRecoveryAttempt {
  return RecoveryRoleRecoveryAttemptFromJSONTyped(json, false);
}

export function RecoveryRoleRecoveryAttemptFromJSONTyped(
  json: any,
  ...
  return {
    ...
    allow_timed_recovery_after: !exists(json, "allow_timed_recovery_after")
      ? undefined
      : ScryptoInstantFromJSON(json["allow_timed_recovery_after"]),
  };
}

export function RecoveryRoleRecoveryAttemptToJSON(
  value?: RecoveryRoleRecoveryAttempt | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    ...
    allow_timed_recovery_after: ScryptoInstantToJSON(
      value.allow_timed_recovery_after,
    ),
  };
}
