...
export function LtsTransactionStatusRequestFromJSON(
  json: any,
): LtsTransactionStatusRequest {
  return LtsTransactionStatusRequestFromJSONTyped(json, false);
}

export function LtsTransactionStatusRequestFromJSONTyped(
  json: any,
...
export function LtsTransactionStatusRequestToJSON(
  value?: LtsTransactionStatusRequest | null,
): any {
  if (value === undefined) {
    return undefined;
  }
