...
export type KeyValueStoreEntryStructureTypeEnum =
  (typeof KeyValueStoreEntryStructureTypeEnum)[keyof typeof KeyValueStoreEntryStructureTypeEnum];
...
export function KeyValueStoreEntryStructureFromJSON(
  json: any,
): KeyValueStoreEntryStructure {
  return KeyValueStoreEntryStructureFromJSONTyped(json, false);
}

export function KeyValueStoreEntryStructureFromJSONTyped(
  json: any,
...
export function KeyValueStoreEntryStructureToJSON(
  value?: KeyValueStoreEntryStructure | null,
): any {
  if (value === undefined) {
    return undefined;
  }
