...
export type OneResourcePoolFieldStateSubstateAllOfSubstateTypeEnum =
  (typeof OneResourcePoolFieldStateSubstateAllOfSubstateTypeEnum)[keyof typeof OneResourcePoolFieldStateSubstateAllOfSubstateTypeEnum];

/**
 * Check if a given object implements the OneResourcePoolFieldStateSubstateAllOf interface.
 */
export function instanceOfOneResourcePoolFieldStateSubstateAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function OneResourcePoolFieldStateSubstateAllOfFromJSON(
  json: any,
): OneResourcePoolFieldStateSubstateAllOf {
  return OneResourcePoolFieldStateSubstateAllOfFromJSONTyped(json, false);
}

export function OneResourcePoolFieldStateSubstateAllOfFromJSONTyped(
  json: any,
...
export function OneResourcePoolFieldStateSubstateAllOfToJSON(
  value?: OneResourcePoolFieldStateSubstateAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
