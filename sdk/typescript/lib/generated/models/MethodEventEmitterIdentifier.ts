...
export type MethodEventEmitterIdentifierTypeEnum =
  (typeof MethodEventEmitterIdentifierTypeEnum)[keyof typeof MethodEventEmitterIdentifierTypeEnum];
...
export function MethodEventEmitterIdentifierFromJSON(
  json: any,
): MethodEventEmitterIdentifier {
  return MethodEventEmitterIdentifierFromJSONTyped(json, false);
}

export function MethodEventEmitterIdentifierFromJSONTyped(
  json: any,
...
export function MethodEventEmitterIdentifierToJSON(
  value?: MethodEventEmitterIdentifier | null,
): any {
  if (value === undefined) {
    return undefined;
  }
