...
export function instanceOfValidatorFieldStateValue(value: object): boolean {
  ...
  isInstance =
    isInstance && "already_unlocked_owner_stake_unit_amount" in value;

  return isInstance;
}

export function ValidatorFieldStateValueFromJSON(
  json: any,
): ValidatorFieldStateValue {
  return ValidatorFieldStateValueFromJSONTyped(json, false);
}

export function ValidatorFieldStateValueFromJSONTyped(
  json: any,
  ...
  return {
    sorted_key: !exists(json, "sorted_key")
      ? undefined
      : SubstateKeyFromJSON(json["sorted_key"]),
    ...
    validator_fee_change_request: !exists(json, "validator_fee_change_request")
      ? undefined
      : ValidatorFeeChangeRequestFromJSON(json["validator_fee_change_request"]),
    ...
    pending_xrd_withdraw_vault: EntityReferenceFromJSON(
      json["pending_xrd_withdraw_vault"],
    ),
    locked_owner_stake_unit_vault: EntityReferenceFromJSON(
      json["locked_owner_stake_unit_vault"],
    ),
    pending_owner_stake_unit_unlock_vault: EntityReferenceFromJSON(
      json["pending_owner_stake_unit_unlock_vault"],
    ),
    pending_owner_stake_unit_withdrawals: (
      json["pending_owner_stake_unit_withdrawals"] as Array<any>
    ).map(PendingOwnerStakeWithdrawalFromJSON),
    already_unlocked_owner_stake_unit_amount:
      json["already_unlocked_owner_stake_unit_amount"],
  };
}

export function ValidatorFieldStateValueToJSON(
  value?: ValidatorFieldStateValue | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    ...
    validator_fee_change_request: ValidatorFeeChangeRequestToJSON(
      value.validator_fee_change_request,
    ),
    ...
    pending_xrd_withdraw_vault: EntityReferenceToJSON(
      value.pending_xrd_withdraw_vault,
    ),
    locked_owner_stake_unit_vault: EntityReferenceToJSON(
      value.locked_owner_stake_unit_vault,
    ),
    pending_owner_stake_unit_unlock_vault: EntityReferenceToJSON(
      value.pending_owner_stake_unit_unlock_vault,
    ),
    pending_owner_stake_unit_withdrawals: (
      value.pending_owner_stake_unit_withdrawals as Array<any>
    ).map(PendingOwnerStakeWithdrawalToJSON),
    already_unlocked_owner_stake_unit_amount:
      value.already_unlocked_owner_stake_unit_amount,
  };
}
