...
export type SortedIndexBlueprintCollectionSchemaAllOfTypeEnum =
  (typeof SortedIndexBlueprintCollectionSchemaAllOfTypeEnum)[keyof typeof SortedIndexBlueprintCollectionSchemaAllOfTypeEnum];

/**
 * Check if a given object implements the SortedIndexBlueprintCollectionSchemaAllOf interface.
 */
export function instanceOfSortedIndexBlueprintCollectionSchemaAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function SortedIndexBlueprintCollectionSchemaAllOfFromJSON(
  json: any,
): SortedIndexBlueprintCollectionSchemaAllOf {
  return SortedIndexBlueprintCollectionSchemaAllOfFromJSONTyped(json, false);
}

export function SortedIndexBlueprintCollectionSchemaAllOfFromJSONTyped(
  json: any,
...
export function SortedIndexBlueprintCollectionSchemaAllOfToJSON(
  value?: SortedIndexBlueprintCollectionSchemaAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
