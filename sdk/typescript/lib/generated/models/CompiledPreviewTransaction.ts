...
export type CompiledPreviewTransactionTypeEnum =
  (typeof CompiledPreviewTransactionTypeEnum)[keyof typeof CompiledPreviewTransactionTypeEnum];
...
export function CompiledPreviewTransactionFromJSON(
  json: any,
): CompiledPreviewTransaction {
  return CompiledPreviewTransactionFromJSONTyped(json, false);
}

export function CompiledPreviewTransactionFromJSONTyped(
  json: any,
...
export function CompiledPreviewTransactionToJSON(
  value?: CompiledPreviewTransaction | null,
): any {
  if (value === undefined) {
    return undefined;
  }
