 ...
 */
export function instanceOfTransactionReceiptRequest(value: object): boolean {
  let isInstance = true;
...
export function TransactionReceiptRequestFromJSON(
  json: any,
): TransactionReceiptRequest {
  return TransactionReceiptRequestFromJSONTyped(json, false);
}

export function TransactionReceiptRequestFromJSONTyped(
  json: any,
...
export function TransactionReceiptRequestToJSON(
  value?: TransactionReceiptRequest | null,
): any {
  if (value === undefined) {
    return undefined;
  }
