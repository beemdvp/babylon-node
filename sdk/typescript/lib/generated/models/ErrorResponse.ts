...
export type ErrorResponse =
  | ({ error_type: "Basic" } & BasicErrorResponse)
  | ({ error_type: "LtsTransactionSubmit" } & LtsTransactionSubmitErrorResponse)
  | ({ error_type: "StreamProofs" } & StreamProofsErrorResponse)
  | ({ error_type: "StreamTransactions" } & StreamTransactionsErrorResponse)
  | ({ error_type: "TransactionPreviewV2" } & TransactionPreviewV2ErrorResponse)
...
export function ErrorResponseFromJSONTyped(
  ...
  switch (json["error_type"]) {
    case "Basic":
      return {
        ...BasicErrorResponseFromJSONTyped(json, true),
        error_type: "Basic",
      };
    case "LtsTransactionSubmit":
      return {
        ...LtsTransactionSubmitErrorResponseFromJSONTyped(json, true),
        error_type: "LtsTransactionSubmit",
      };
    case "StreamProofs":
      return {
        ...StreamProofsErrorResponseFromJSONTyped(json, true),
        error_type: "StreamProofs",
      };
    case "StreamTransactions":
      return {
        ...StreamTransactionsErrorResponseFromJSONTyped(json, true),
        error_type: "StreamTransactions",
      };
    case "TransactionPreviewV2":
      return {
        ...TransactionPreviewV2ErrorResponseFromJSONTyped(json, true),
        error_type: "TransactionPreviewV2",
      };
    case "TransactionSubmit":
      return {
        ...TransactionSubmitErrorResponseFromJSONTyped(json, true),
        error_type: "TransactionSubmit",
      };
    default:
      throw new Error(
        `No variant of ErrorResponse exists with 'error_type=${json["error_type"]}'`,
      );
  }
}
...
export function ErrorResponseToJSON(value?: ErrorResponse | null): any {
  ...
  switch (value["error_type"]) {
    ...
    default:
      throw new Error(
        `No variant of ErrorResponse exists with 'error_type=${value["error_type"]}'`,
      );
  }
}
