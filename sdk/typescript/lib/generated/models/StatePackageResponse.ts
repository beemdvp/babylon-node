...
export function StatePackageResponseFromJSONTyped(
  json: any,
  ...
  return {
    ...
    royalty: !exists(json, "royalty")
      ? undefined
      : SubstateFromJSON(json["royalty"]),
  };
}

export function StatePackageResponseToJSON(
  value?: StatePackageResponse | null,
): any {
  if (value === undefined) {
    return undefined;
  }
