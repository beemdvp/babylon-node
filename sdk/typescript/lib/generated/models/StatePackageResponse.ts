 ...
 * 
 * @export
 * @interface StatePackageResponse
 */
export interface StatePackageResponse {
    /**
     * 
...
/**
 * Check if a given object implements the StatePackageResponse interface.
 */
...
export function StatePackageResponseFromJSON(json: any): StatePackageResponse {
    return StatePackageResponseFromJSONTyped(json, false);
}

export function StatePackageResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): StatePackageResponse {
    ...
    return {
        ...
        'royalty': !exists(json, 'royalty') ? undefined : SubstateFromJSON(json['royalty']),
    };
}

export function StatePackageResponseToJSON(value?: StatePackageResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
