...
export type PlaintextTransactionMessageAllOfTypeEnum =
  (typeof PlaintextTransactionMessageAllOfTypeEnum)[keyof typeof PlaintextTransactionMessageAllOfTypeEnum];

/**
 * Check if a given object implements the PlaintextTransactionMessageAllOf interface.
 */
export function instanceOfPlaintextTransactionMessageAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function PlaintextTransactionMessageAllOfFromJSON(
  json: any,
): PlaintextTransactionMessageAllOf {
  return PlaintextTransactionMessageAllOfFromJSONTyped(json, false);
}

export function PlaintextTransactionMessageAllOfFromJSONTyped(
  json: any,
...
export function PlaintextTransactionMessageAllOfToJSON(
  value?: PlaintextTransactionMessageAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
