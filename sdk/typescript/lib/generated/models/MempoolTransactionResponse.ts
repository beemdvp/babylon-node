...
export function MempoolTransactionResponseFromJSONTyped(
  json: any,
  ...
  return {
    count: json["count"],
    payloads: (json["payloads"] as Array<any>).map(
      MempoolTransactionResponsePayloadsInnerFromJSON,
    ),
  };
}
...
export function MempoolTransactionResponseToJSON(
  value?: MempoolTransactionResponse | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    count: value.count,
    payloads: (value.payloads as Array<any>).map(
      MempoolTransactionResponsePayloadsInnerToJSON,
    ),
  };
}
