...
export function SignatureWithPublicKeyBaseFromJSON(
  json: any,
): SignatureWithPublicKeyBase {
  return SignatureWithPublicKeyBaseFromJSONTyped(json, false);
}

export function SignatureWithPublicKeyBaseFromJSONTyped(
  json: any,
...
export function SignatureWithPublicKeyBaseToJSON(
  value?: SignatureWithPublicKeyBase | null,
): any {
  if (value === undefined) {
    return undefined;
  }
