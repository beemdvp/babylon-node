 ...
 *
 * @export
 * @interface ParsedNotarizedTransactionV2
 */
export interface ParsedNotarizedTransactionV2 {
  /**
   *
   * @type {string}
   * @memberof ParsedNotarizedTransactionV2
   */
  type: ParsedNotarizedTransactionV2TypeEnum;
  /**
   *
 ...
 * @export
 */
export const ParsedNotarizedTransactionV2TypeEnum = {
  NotarizedTransactionV2: "NotarizedTransactionV2",
} as const;
export type ParsedNotarizedTransactionV2TypeEnum =
  (typeof ParsedNotarizedTransactionV2TypeEnum)[keyof typeof ParsedNotarizedTransactionV2TypeEnum];

/**
 * Check if a given object implements the ParsedNotarizedTransactionV2 interface.
 */
export function instanceOfParsedNotarizedTransactionV2(value: object): boolean {
  let isInstance = true;
...
export function ParsedNotarizedTransactionV2FromJSON(
  json: any,
): ParsedNotarizedTransactionV2 {
  return ParsedNotarizedTransactionV2FromJSONTyped(json, false);
}

export function ParsedNotarizedTransactionV2FromJSONTyped(
  json: any,
  ...
  return {
    type: json["type"],
    notarized_transaction: !exists(json, "notarized_transaction")
      ? undefined
      : NotarizedTransactionV2FromJSON(json["notarized_transaction"]),
    identifiers: ParsedNotarizedTransactionIdentifiersFromJSON(
      json["identifiers"],
    ),
    validation_error: !exists(json, "validation_error")
      ? undefined
      : ParsedNotarizedTransactionAllOfValidationErrorFromJSON(
...
export function ParsedNotarizedTransactionV2ToJSON(
  value?: ParsedNotarizedTransactionV2 | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    type: value.type,
    notarized_transaction: NotarizedTransactionV2ToJSON(
      value.notarized_transaction,
    ),
    identifiers: ParsedNotarizedTransactionIdentifiersToJSON(value.identifiers),
    validation_error: ParsedNotarizedTransactionAllOfValidationErrorToJSON(
