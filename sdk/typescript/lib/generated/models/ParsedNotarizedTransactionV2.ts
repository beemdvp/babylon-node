...
export type ParsedNotarizedTransactionV2TypeEnum = typeof ParsedNotarizedTransactionV2TypeEnum[keyof typeof ParsedNotarizedTransactionV2TypeEnum];
...
export function ParsedNotarizedTransactionV2FromJSON(json: any): ParsedNotarizedTransactionV2 {
    return ParsedNotarizedTransactionV2FromJSONTyped(json, false);
}

export function ParsedNotarizedTransactionV2FromJSONTyped(json: any, ignoreDiscriminator: boolean): ParsedNotarizedTransactionV2 {
...
export function ParsedNotarizedTransactionV2ToJSON(value?: ParsedNotarizedTransactionV2 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
