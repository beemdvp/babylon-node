...
export type StateFungibleResourceManagerAllOfResourceTypeEnum =
  (typeof StateFungibleResourceManagerAllOfResourceTypeEnum)[keyof typeof StateFungibleResourceManagerAllOfResourceTypeEnum];

/**
 * Check if a given object implements the StateFungibleResourceManagerAllOf interface.
 */
export function instanceOfStateFungibleResourceManagerAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function StateFungibleResourceManagerAllOfFromJSON(
  json: any,
): StateFungibleResourceManagerAllOf {
  return StateFungibleResourceManagerAllOfFromJSONTyped(json, false);
}

export function StateFungibleResourceManagerAllOfFromJSONTyped(
  json: any,
...
export function StateFungibleResourceManagerAllOfToJSON(
  value?: StateFungibleResourceManagerAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
