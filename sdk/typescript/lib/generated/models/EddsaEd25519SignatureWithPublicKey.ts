...
export type EddsaEd25519SignatureWithPublicKeyKeyTypeEnum =
  (typeof EddsaEd25519SignatureWithPublicKeyKeyTypeEnum)[keyof typeof EddsaEd25519SignatureWithPublicKeyKeyTypeEnum];

/**
 * Check if a given object implements the EddsaEd25519SignatureWithPublicKey interface.
 */
export function instanceOfEddsaEd25519SignatureWithPublicKey(
  value: object,
): boolean {
  let isInstance = true;
...
export function EddsaEd25519SignatureWithPublicKeyFromJSON(
  json: any,
): EddsaEd25519SignatureWithPublicKey {
  return EddsaEd25519SignatureWithPublicKeyFromJSONTyped(json, false);
}

export function EddsaEd25519SignatureWithPublicKeyFromJSONTyped(
  json: any,
...
export function EddsaEd25519SignatureWithPublicKeyToJSON(
  value?: EddsaEd25519SignatureWithPublicKey | null,
): any {
  if (value === undefined) {
    return undefined;
  }
