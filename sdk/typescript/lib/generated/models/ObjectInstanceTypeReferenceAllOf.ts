...
export type ObjectInstanceTypeReferenceAllOfTypeEnum =
  (typeof ObjectInstanceTypeReferenceAllOfTypeEnum)[keyof typeof ObjectInstanceTypeReferenceAllOfTypeEnum];

/**
 * Check if a given object implements the ObjectInstanceTypeReferenceAllOf interface.
 */
export function instanceOfObjectInstanceTypeReferenceAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function ObjectInstanceTypeReferenceAllOfFromJSON(
  json: any,
): ObjectInstanceTypeReferenceAllOf {
  return ObjectInstanceTypeReferenceAllOfFromJSONTyped(json, false);
}

export function ObjectInstanceTypeReferenceAllOfFromJSONTyped(
  json: any,
  ...
  return {
    resolved_full_type_id: FullyScopedTypeIdFromJSON(
      json["resolved_full_type_id"],
    ),
...
export function ObjectInstanceTypeReferenceAllOfToJSON(
  value?: ObjectInstanceTypeReferenceAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
