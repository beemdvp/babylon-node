 ...
 */
export function instanceOfTransactionTrackerCollectionEntryValue(
  value: object,
): boolean {
  let isInstance = true;
...
export function TransactionTrackerCollectionEntryValueFromJSON(
  json: any,
): TransactionTrackerCollectionEntryValue {
  return TransactionTrackerCollectionEntryValueFromJSONTyped(json, false);
}

export function TransactionTrackerCollectionEntryValueFromJSONTyped(
  json: any,
...
export function TransactionTrackerCollectionEntryValueToJSON(
  value?: TransactionTrackerCollectionEntryValue | null,
): any {
  if (value === undefined) {
    return undefined;
  }
