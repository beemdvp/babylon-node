...
export type UserLedgerTransactionTypeEnum =
  (typeof UserLedgerTransactionTypeEnum)[keyof typeof UserLedgerTransactionTypeEnum];
...
export function UserLedgerTransactionFromJSON(
  json: any,
): UserLedgerTransaction {
  return UserLedgerTransactionFromJSONTyped(json, false);
}

export function UserLedgerTransactionFromJSONTyped(
  json: any,
...
export function UserLedgerTransactionToJSON(
  value?: UserLedgerTransaction | null,
): any {
  if (value === undefined) {
    return undefined;
  }
