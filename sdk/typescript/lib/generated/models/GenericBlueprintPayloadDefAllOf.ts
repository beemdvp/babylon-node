...
export type GenericBlueprintPayloadDefAllOfTypeEnum =
  (typeof GenericBlueprintPayloadDefAllOfTypeEnum)[keyof typeof GenericBlueprintPayloadDefAllOfTypeEnum];

/**
 * Check if a given object implements the GenericBlueprintPayloadDefAllOf interface.
 */
export function instanceOfGenericBlueprintPayloadDefAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function GenericBlueprintPayloadDefAllOfFromJSON(
  json: any,
): GenericBlueprintPayloadDefAllOf {
  return GenericBlueprintPayloadDefAllOfFromJSONTyped(json, false);
}

export function GenericBlueprintPayloadDefAllOfFromJSONTyped(
  json: any,
...
export function GenericBlueprintPayloadDefAllOfToJSON(
  value?: GenericBlueprintPayloadDefAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
