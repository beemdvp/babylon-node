...
export function SubstateFormatOptionsFromJSON(
  json: any,
): SubstateFormatOptions {
  return SubstateFormatOptionsFromJSONTyped(json, false);
}

export function SubstateFormatOptionsFromJSONTyped(
  json: any,
...
export function SubstateFormatOptionsToJSON(
  value?: SubstateFormatOptions | null,
): any {
  if (value === undefined) {
    return undefined;
  }
