...
export type StreamProofsErrorDetailsRequestedEpochOutOfBoundsTypeEnum =
  (typeof StreamProofsErrorDetailsRequestedEpochOutOfBoundsTypeEnum)[keyof typeof StreamProofsErrorDetailsRequestedEpochOutOfBoundsTypeEnum];

/**
 * Check if a given object implements the StreamProofsErrorDetailsRequestedEpochOutOfBounds interface.
 */
export function instanceOfStreamProofsErrorDetailsRequestedEpochOutOfBounds(
  value: object,
): boolean {
  let isInstance = true;
...
export function StreamProofsErrorDetailsRequestedEpochOutOfBoundsFromJSON(
  json: any,
): StreamProofsErrorDetailsRequestedEpochOutOfBounds {
  return StreamProofsErrorDetailsRequestedEpochOutOfBoundsFromJSONTyped(
    json,
    false,
  );
}

export function StreamProofsErrorDetailsRequestedEpochOutOfBoundsFromJSONTyped(
  json: any,
...
export function StreamProofsErrorDetailsRequestedEpochOutOfBoundsToJSON(
  value?: StreamProofsErrorDetailsRequestedEpochOutOfBounds | null,
): any {
  if (value === undefined) {
    return undefined;
  }
