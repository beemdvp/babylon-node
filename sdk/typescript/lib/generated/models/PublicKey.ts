...
export type PublicKey =
  | ({ key_type: "EcdsaSecp256k1" } & EcdsaSecp256k1PublicKey)
  | ({ key_type: "EddsaEd25519" } & EddsaEd25519PublicKey);
...
export function PublicKeyFromJSONTyped(
  ...
  switch (json["key_type"]) {
    case "EcdsaSecp256k1":
      return {
        ...EcdsaSecp256k1PublicKeyFromJSONTyped(json, true),
        key_type: "EcdsaSecp256k1",
      };
    case "EddsaEd25519":
      return {
        ...EddsaEd25519PublicKeyFromJSONTyped(json, true),
        key_type: "EddsaEd25519",
      };
    default:
      throw new Error(
        `No variant of PublicKey exists with 'key_type=${json["key_type"]}'`,
      );
  }
}
...
export function PublicKeyToJSON(value?: PublicKey | null): any {
  ...
  switch (value["key_type"]) {
    ...
    default:
      throw new Error(
        `No variant of PublicKey exists with 'key_type=${value["key_type"]}'`,
      );
  }
}
