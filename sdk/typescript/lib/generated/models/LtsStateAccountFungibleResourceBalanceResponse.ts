 ...
 */
export function instanceOfLtsStateAccountFungibleResourceBalanceResponse(
  value: object,
): boolean {
  let isInstance = true;
...
export function LtsStateAccountFungibleResourceBalanceResponseFromJSON(
  json: any,
): LtsStateAccountFungibleResourceBalanceResponse {
  return LtsStateAccountFungibleResourceBalanceResponseFromJSONTyped(
    json,
    false,
  );
}

export function LtsStateAccountFungibleResourceBalanceResponseFromJSONTyped(
  json: any,
  ...
  return {
    ...
    fungible_resource_balance: LtsFungibleResourceBalanceFromJSON(
      json["fungible_resource_balance"],
    ),
  };
}

export function LtsStateAccountFungibleResourceBalanceResponseToJSON(
  value?: LtsStateAccountFungibleResourceBalanceResponse | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    ...
    fungible_resource_balance: LtsFungibleResourceBalanceToJSON(
      value.fungible_resource_balance,
    ),
  };
}
