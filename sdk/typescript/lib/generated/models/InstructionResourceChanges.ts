...
export function InstructionResourceChangesFromJSON(
  json: any,
): InstructionResourceChanges {
  return InstructionResourceChangesFromJSONTyped(json, false);
}

export function InstructionResourceChangesFromJSONTyped(
  json: any,
  ...
  return {
    index: json["index"],
    resource_changes: (json["resource_changes"] as Array<any>).map(
      ResourceChangeFromJSON,
    ),
  };
}

export function InstructionResourceChangesToJSON(
  value?: InstructionResourceChanges | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    index: value.index,
    resource_changes: (value.resource_changes as Array<any>).map(
      ResourceChangeToJSON,
    ),
  };
}
