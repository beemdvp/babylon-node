 ...
 */
export function instanceOfSignificantProtocolUpdateReadinessEntry(
  value: object,
): boolean {
  let isInstance = true;
...
export function SignificantProtocolUpdateReadinessEntryFromJSON(
  json: any,
): SignificantProtocolUpdateReadinessEntry {
  return SignificantProtocolUpdateReadinessEntryFromJSONTyped(json, false);
}

export function SignificantProtocolUpdateReadinessEntryFromJSONTyped(
  json: any,
...
export function SignificantProtocolUpdateReadinessEntryToJSON(
  value?: SignificantProtocolUpdateReadinessEntry | null,
): any {
  if (value === undefined) {
    return undefined;
  }
