...
export function TransactionPayloadDetailsFromJSON(
  json: any,
): TransactionPayloadDetails {
  return TransactionPayloadDetailsFromJSONTyped(json, false);
}

export function TransactionPayloadDetailsFromJSONTyped(
  json: any,
...
export function TransactionPayloadDetailsToJSON(
  value?: TransactionPayloadDetails | null,
): any {
  if (value === undefined) {
    return undefined;
  }
