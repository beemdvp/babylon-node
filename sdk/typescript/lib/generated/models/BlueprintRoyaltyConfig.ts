...
export function BlueprintRoyaltyConfigFromJSONTyped(json: any, ignoreDiscriminator: boolean): BlueprintRoyaltyConfig {
    ...
    return {
        ...
        'method_rules': !exists(json, 'method_rules') ? undefined : ((json['method_rules'] as Array<any>).map(BlueprintMethodRoyaltyFromJSON)),
    };
}
...
export function BlueprintRoyaltyConfigToJSON(value?: BlueprintRoyaltyConfig | null): any {
    ...
    return {
        ...
        'method_rules': value.method_rules === undefined ? undefined : ((value.method_rules as Array<any>).map(BlueprintMethodRoyaltyToJSON)),
    };
}
