...
export type ParsedLedgerTransactionTypeEnum =
  (typeof ParsedLedgerTransactionTypeEnum)[keyof typeof ParsedLedgerTransactionTypeEnum];
...
export function ParsedLedgerTransactionFromJSON(
  json: any,
): ParsedLedgerTransaction {
  return ParsedLedgerTransactionFromJSONTyped(json, false);
}

export function ParsedLedgerTransactionFromJSONTyped(
  json: any,
...
export function ParsedLedgerTransactionToJSON(
  value?: ParsedLedgerTransaction | null,
): any {
  if (value === undefined) {
    return undefined;
  }
