...
export type BootLoaderModuleFieldSystemBootSubstateSubstateTypeEnum =
  (typeof BootLoaderModuleFieldSystemBootSubstateSubstateTypeEnum)[keyof typeof BootLoaderModuleFieldSystemBootSubstateSubstateTypeEnum];

/**
 * Check if a given object implements the BootLoaderModuleFieldSystemBootSubstate interface.
 */
export function instanceOfBootLoaderModuleFieldSystemBootSubstate(
  value: object,
): boolean {
  let isInstance = true;
...
export function BootLoaderModuleFieldSystemBootSubstateFromJSON(
  json: any,
): BootLoaderModuleFieldSystemBootSubstate {
  return BootLoaderModuleFieldSystemBootSubstateFromJSONTyped(json, false);
}

export function BootLoaderModuleFieldSystemBootSubstateFromJSONTyped(
  json: any,
...
export function BootLoaderModuleFieldSystemBootSubstateToJSON(
  value?: BootLoaderModuleFieldSystemBootSubstate | null,
): any {
  if (value === undefined) {
    return undefined;
  }
