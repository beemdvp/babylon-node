...
export function CommittedTransactionFromJSONTyped(
  json: any,
  ...
  return {
    resultant_state_identifiers: CommittedStateIdentifierFromJSON(
      json["resultant_state_identifiers"],
    ),
    ...
    balance_changes: !exists(json, "balance_changes")
      ? undefined
      : CommittedTransactionBalanceChangesFromJSON(json["balance_changes"]),
    proposer_timestamp_ms: json["proposer_timestamp_ms"],
  };
}

export function CommittedTransactionToJSON(
  value?: CommittedTransaction | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    resultant_state_identifiers: CommittedStateIdentifierToJSON(
      value.resultant_state_identifiers,
    ),
    ledger_transaction: LedgerTransactionToJSON(value.ledger_transaction),
    receipt: TransactionReceiptToJSON(value.receipt),
    balance_changes: CommittedTransactionBalanceChangesToJSON(
