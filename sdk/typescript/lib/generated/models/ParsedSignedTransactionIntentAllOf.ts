...
export type ParsedSignedTransactionIntentAllOfTypeEnum =
  (typeof ParsedSignedTransactionIntentAllOfTypeEnum)[keyof typeof ParsedSignedTransactionIntentAllOfTypeEnum];

/**
 * Check if a given object implements the ParsedSignedTransactionIntentAllOf interface.
 */
export function instanceOfParsedSignedTransactionIntentAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function ParsedSignedTransactionIntentAllOfFromJSON(
  json: any,
): ParsedSignedTransactionIntentAllOf {
  return ParsedSignedTransactionIntentAllOfFromJSONTyped(json, false);
}

export function ParsedSignedTransactionIntentAllOfFromJSONTyped(
  json: any,
  ...
  return {
    signed_intent: !exists(json, "signed_intent")
      ? undefined
      : SignedTransactionIntentFromJSON(json["signed_intent"]),
    identifiers: ParsedSignedTransactionIntentIdentifiersFromJSON(
      json["identifiers"],
    ),
...
export function ParsedSignedTransactionIntentAllOfToJSON(
  value?: ParsedSignedTransactionIntentAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    ...
    identifiers: ParsedSignedTransactionIntentIdentifiersToJSON(
      value.identifiers,
    ),
    type: value.type,
  };
