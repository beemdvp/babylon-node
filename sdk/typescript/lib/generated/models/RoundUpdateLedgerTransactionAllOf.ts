...
export type RoundUpdateLedgerTransactionAllOfTypeEnum =
  (typeof RoundUpdateLedgerTransactionAllOfTypeEnum)[keyof typeof RoundUpdateLedgerTransactionAllOfTypeEnum];

/**
 * Check if a given object implements the RoundUpdateLedgerTransactionAllOf interface.
 */
export function instanceOfRoundUpdateLedgerTransactionAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function RoundUpdateLedgerTransactionAllOfFromJSON(
  json: any,
): RoundUpdateLedgerTransactionAllOf {
  return RoundUpdateLedgerTransactionAllOfFromJSONTyped(json, false);
}

export function RoundUpdateLedgerTransactionAllOfFromJSONTyped(
  json: any,
  ...
  return {
    round_update_transaction: RoundUpdateTransactionFromJSON(
      json["round_update_transaction"],
    ),
    type: !exists(json, "type") ? undefined : json["type"],
  };
}

export function RoundUpdateLedgerTransactionAllOfToJSON(
  value?: RoundUpdateLedgerTransactionAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    round_update_transaction: RoundUpdateTransactionToJSON(
      value.round_update_transaction,
    ),
    type: value.type,
  };
}
