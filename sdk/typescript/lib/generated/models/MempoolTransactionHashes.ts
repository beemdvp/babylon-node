...
export function MempoolTransactionHashesFromJSON(
  json: any,
): MempoolTransactionHashes {
  return MempoolTransactionHashesFromJSONTyped(json, false);
}

export function MempoolTransactionHashesFromJSONTyped(
  json: any,
...
export function MempoolTransactionHashesToJSON(
  value?: MempoolTransactionHashes | null,
): any {
  if (value === undefined) {
    return undefined;
  }
