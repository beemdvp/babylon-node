...
export type PackageCodeInstrumentedCodeEntrySubstateSubstateTypeEnum =
  (typeof PackageCodeInstrumentedCodeEntrySubstateSubstateTypeEnum)[keyof typeof PackageCodeInstrumentedCodeEntrySubstateSubstateTypeEnum];

/**
 * Check if a given object implements the PackageCodeInstrumentedCodeEntrySubstate interface.
 */
export function instanceOfPackageCodeInstrumentedCodeEntrySubstate(
  value: object,
): boolean {
  let isInstance = true;
...
export function PackageCodeInstrumentedCodeEntrySubstateFromJSON(
  json: any,
): PackageCodeInstrumentedCodeEntrySubstate {
  return PackageCodeInstrumentedCodeEntrySubstateFromJSONTyped(json, false);
}

export function PackageCodeInstrumentedCodeEntrySubstateFromJSONTyped(
  json: any,
...
export function PackageCodeInstrumentedCodeEntrySubstateToJSON(
  value?: PackageCodeInstrumentedCodeEntrySubstate | null,
): any {
  if (value === undefined) {
    return undefined;
  }
