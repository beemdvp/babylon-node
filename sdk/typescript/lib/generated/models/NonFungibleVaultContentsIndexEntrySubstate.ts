...
export type NonFungibleVaultContentsIndexEntrySubstateSubstateTypeEnum =
  (typeof NonFungibleVaultContentsIndexEntrySubstateSubstateTypeEnum)[keyof typeof NonFungibleVaultContentsIndexEntrySubstateSubstateTypeEnum];

/**
 * Check if a given object implements the NonFungibleVaultContentsIndexEntrySubstate interface.
 */
export function instanceOfNonFungibleVaultContentsIndexEntrySubstate(
  value: object,
): boolean {
  let isInstance = true;
...
export function NonFungibleVaultContentsIndexEntrySubstateFromJSON(
  json: any,
): NonFungibleVaultContentsIndexEntrySubstate {
  return NonFungibleVaultContentsIndexEntrySubstateFromJSONTyped(json, false);
}

export function NonFungibleVaultContentsIndexEntrySubstateFromJSONTyped(
  json: any,
...
export function NonFungibleVaultContentsIndexEntrySubstateToJSON(
  value?: NonFungibleVaultContentsIndexEntrySubstate | null,
): any {
  if (value === undefined) {
    return undefined;
  }
