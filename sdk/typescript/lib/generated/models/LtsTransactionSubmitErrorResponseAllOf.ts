...
export type LtsTransactionSubmitErrorResponseAllOfErrorTypeEnum =
  (typeof LtsTransactionSubmitErrorResponseAllOfErrorTypeEnum)[keyof typeof LtsTransactionSubmitErrorResponseAllOfErrorTypeEnum];

/**
 * Check if a given object implements the LtsTransactionSubmitErrorResponseAllOf interface.
 */
export function instanceOfLtsTransactionSubmitErrorResponseAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function LtsTransactionSubmitErrorResponseAllOfFromJSON(
  json: any,
): LtsTransactionSubmitErrorResponseAllOf {
  return LtsTransactionSubmitErrorResponseAllOfFromJSONTyped(json, false);
}

export function LtsTransactionSubmitErrorResponseAllOfFromJSONTyped(
  json: any,
  ...
  return {
    details: !exists(json, "details")
      ? undefined
      : LtsTransactionSubmitErrorDetailsFromJSON(json["details"]),
    error_type: !exists(json, "error_type") ? undefined : json["error_type"],
  };
}

export function LtsTransactionSubmitErrorResponseAllOfToJSON(
  value?: LtsTransactionSubmitErrorResponseAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
