...
export type TransactionSubmitRejectedErrorDetailsTypeEnum =
  (typeof TransactionSubmitRejectedErrorDetailsTypeEnum)[keyof typeof TransactionSubmitRejectedErrorDetailsTypeEnum];

/**
 * Check if a given object implements the TransactionSubmitRejectedErrorDetails interface.
 */
export function instanceOfTransactionSubmitRejectedErrorDetails(
  value: object,
): boolean {
  let isInstance = true;
...
export function TransactionSubmitRejectedErrorDetailsFromJSON(
  json: any,
): TransactionSubmitRejectedErrorDetails {
  return TransactionSubmitRejectedErrorDetailsFromJSONTyped(json, false);
}

export function TransactionSubmitRejectedErrorDetailsFromJSONTyped(
  json: any,
...
export function TransactionSubmitRejectedErrorDetailsToJSON(
  value?: TransactionSubmitRejectedErrorDetails | null,
): any {
  if (value === undefined) {
    return undefined;
  }
