...
export function LeaderProposalHistoryFromJSON(
  json: any,
): LeaderProposalHistory {
  return LeaderProposalHistoryFromJSONTyped(json, false);
}

export function LeaderProposalHistoryFromJSONTyped(
  json: any,
  ...
  return {
    gap_round_leaders: (json["gap_round_leaders"] as Array<any>).map(
      ActiveValidatorIndexFromJSON,
    ),
...
export function LeaderProposalHistoryToJSON(
  value?: LeaderProposalHistory | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    gap_round_leaders: (value.gap_round_leaders as Array<any>).map(
      ActiveValidatorIndexToJSON,
    ),
