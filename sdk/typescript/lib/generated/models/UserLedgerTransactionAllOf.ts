...
export type UserLedgerTransactionAllOfTypeEnum =
  (typeof UserLedgerTransactionAllOfTypeEnum)[keyof typeof UserLedgerTransactionAllOfTypeEnum];
...
export function UserLedgerTransactionAllOfFromJSON(
  json: any,
): UserLedgerTransactionAllOf {
  return UserLedgerTransactionAllOfFromJSONTyped(json, false);
}

export function UserLedgerTransactionAllOfFromJSONTyped(
  json: any,
  ...
  return {
    notarized_transaction: NotarizedTransactionFromJSON(
...
export function UserLedgerTransactionAllOfToJSON(
  value?: UserLedgerTransactionAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
