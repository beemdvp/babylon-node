...
export type ParsedNotarizedTransactionAllOfTypeEnum =
  (typeof ParsedNotarizedTransactionAllOfTypeEnum)[keyof typeof ParsedNotarizedTransactionAllOfTypeEnum];

/**
 * Check if a given object implements the ParsedNotarizedTransactionAllOf interface.
 */
export function instanceOfParsedNotarizedTransactionAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function ParsedNotarizedTransactionAllOfFromJSON(
  json: any,
): ParsedNotarizedTransactionAllOf {
  return ParsedNotarizedTransactionAllOfFromJSONTyped(json, false);
}

export function ParsedNotarizedTransactionAllOfFromJSONTyped(
  json: any,
  ...
  return {
    notarized_transaction: !exists(json, "notarized_transaction")
      ? undefined
      : NotarizedTransactionFromJSON(json["notarized_transaction"]),
...
export function ParsedNotarizedTransactionAllOfToJSON(
  value?: ParsedNotarizedTransactionAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    notarized_transaction: NotarizedTransactionToJSON(
