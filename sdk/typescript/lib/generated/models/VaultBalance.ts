...
/**
 * Check if a given object implements the VaultBalance interface.
 */
export function instanceOfVaultBalance(value: object): boolean {
    let isInstance = true;
...
export function VaultBalanceFromJSON(json: any): VaultBalance {
    return VaultBalanceFromJSONTyped(json, false);
}

export function VaultBalanceFromJSONTyped(json: any, ignoreDiscriminator: boolean): VaultBalance {
...
export function VaultBalanceToJSON(value?: VaultBalance | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
