...
export function EncryptedMessageDecryptorFromJSON(
  json: any,
): EncryptedMessageDecryptor {
  return EncryptedMessageDecryptorFromJSONTyped(json, false);
}

export function EncryptedMessageDecryptorFromJSONTyped(
  json: any,
...
export function EncryptedMessageDecryptorToJSON(
  value?: EncryptedMessageDecryptor | null,
): any {
  if (value === undefined) {
    return undefined;
  }
