...
export function LtsTransactionPayloadDetailsFromJSON(
  json: any,
): LtsTransactionPayloadDetails {
  return LtsTransactionPayloadDetailsFromJSONTyped(json, false);
}

export function LtsTransactionPayloadDetailsFromJSONTyped(
  json: any,
  ...
  return {
    ...
    state_version: !exists(json, "state_version")
      ? undefined
      : json["state_version"],
...
export function LtsTransactionPayloadDetailsToJSON(
  value?: LtsTransactionPayloadDetails | null,
): any {
  if (value === undefined) {
    return undefined;
  }
