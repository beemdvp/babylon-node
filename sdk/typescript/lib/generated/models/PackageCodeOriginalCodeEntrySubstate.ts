...
export type PackageCodeOriginalCodeEntrySubstateSubstateTypeEnum =
  (typeof PackageCodeOriginalCodeEntrySubstateSubstateTypeEnum)[keyof typeof PackageCodeOriginalCodeEntrySubstateSubstateTypeEnum];

/**
 * Check if a given object implements the PackageCodeOriginalCodeEntrySubstate interface.
 */
export function instanceOfPackageCodeOriginalCodeEntrySubstate(
  value: object,
): boolean {
  let isInstance = true;
...
export function PackageCodeOriginalCodeEntrySubstateFromJSON(
  json: any,
): PackageCodeOriginalCodeEntrySubstate {
  return PackageCodeOriginalCodeEntrySubstateFromJSONTyped(json, false);
}

export function PackageCodeOriginalCodeEntrySubstateFromJSONTyped(
  json: any,
...
export function PackageCodeOriginalCodeEntrySubstateToJSON(
  value?: PackageCodeOriginalCodeEntrySubstate | null,
): any {
  if (value === undefined) {
    return undefined;
  }
