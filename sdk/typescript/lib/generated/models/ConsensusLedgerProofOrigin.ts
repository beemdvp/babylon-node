...
export type ConsensusLedgerProofOriginTypeEnum =
  (typeof ConsensusLedgerProofOriginTypeEnum)[keyof typeof ConsensusLedgerProofOriginTypeEnum];
...
export function ConsensusLedgerProofOriginFromJSON(
  json: any,
): ConsensusLedgerProofOrigin {
  return ConsensusLedgerProofOriginFromJSONTyped(json, false);
}

export function ConsensusLedgerProofOriginFromJSONTyped(
  json: any,
...
export function ConsensusLedgerProofOriginToJSON(
  value?: ConsensusLedgerProofOrigin | null,
): any {
  if (value === undefined) {
    return undefined;
  }
