 ...
 * 
 * @export
 * @interface SystemCostingParameters
 */
export interface SystemCostingParameters {
    /**
     * The string-encoded decimal representing the RORK price of a single cost unit of transaction execution.
    ...
    /**
     * The string-encoded decimal representing the RORK price of a single cost unit of transaction finalization.
     * A decimal is formed of some signed integer `m` of attos (`10^(-18)`) units, where `-2^(192 - 1) <= m < 2^(192 - 1)`.
     * @type {string}
     * @memberof SystemCostingParameters
     */
    ...
    /**
     * The string-encoded decimal representing what amount of RORK is consumed by a Royalty of 1 USD.
     * This is fixed for a given protocol version, so is not an accurate representation of the RORK price.
     * A decimal is formed of some signed integer `m` of attos (`10^(-18)`) units, where `-2^(192 - 1) <= m < 2^(192 - 1)`.
     * @type {string}
     * @memberof SystemCostingParameters
     */
    ...
    /**
     * The string-encoded decimal representing the price of 1 byte of state storage, expressed in RORK.
     * A decimal is formed of some signed integer `m` of attos (`10^(-18)`) units, where `-2^(192 - 1) <= m < 2^(192 - 1)`.
     * @type {string}
     * @memberof SystemCostingParameters
     */
    ...
    /**
     * The string-encoded decimal representing the price of 1 byte of archive storage, expressed in RORK.
     * A decimal is formed of some signed integer `m` of attos (`10^(-18)`) units, where `-2^(192 - 1) <= m < 2^(192 - 1)`.
     * @type {string}
     * @memberof SystemCostingParameters
     */
...
/**
 * Check if a given object implements the SystemCostingParameters interface.
 */
export function instanceOfSystemCostingParameters(value: object): boolean {
    let isInstance = true;
...
export function SystemCostingParametersFromJSON(json: any): SystemCostingParameters {
    return SystemCostingParametersFromJSONTyped(json, false);
}

export function SystemCostingParametersFromJSONTyped(json: any, ignoreDiscriminator: boolean): SystemCostingParameters {
...
export function SystemCostingParametersToJSON(value?: SystemCostingParameters | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
