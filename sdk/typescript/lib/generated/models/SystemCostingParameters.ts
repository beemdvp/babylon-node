...
export function SystemCostingParametersFromJSON(
  json: any,
): SystemCostingParameters {
  return SystemCostingParametersFromJSONTyped(json, false);
}

export function SystemCostingParametersFromJSONTyped(
  json: any,
...
export function SystemCostingParametersToJSON(
  value?: SystemCostingParameters | null,
): any {
  if (value === undefined) {
    return undefined;
  }
