...
export function LedgerStateSelectorBaseFromJSON(
  json: any,
): LedgerStateSelectorBase {
  return LedgerStateSelectorBaseFromJSONTyped(json, false);
}

export function LedgerStateSelectorBaseFromJSONTyped(
  json: any,
...
export function LedgerStateSelectorBaseToJSON(
  value?: LedgerStateSelectorBase | null,
): any {
  if (value === undefined) {
    return undefined;
  }
