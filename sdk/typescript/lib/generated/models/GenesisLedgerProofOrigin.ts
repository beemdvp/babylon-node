...
export type GenesisLedgerProofOriginTypeEnum =
  (typeof GenesisLedgerProofOriginTypeEnum)[keyof typeof GenesisLedgerProofOriginTypeEnum];
...
export function GenesisLedgerProofOriginFromJSON(
  json: any,
): GenesisLedgerProofOrigin {
  return GenesisLedgerProofOriginFromJSONTyped(json, false);
}

export function GenesisLedgerProofOriginFromJSONTyped(
  json: any,
...
export function GenesisLedgerProofOriginToJSON(
  value?: GenesisLedgerProofOrigin | null,
): any {
  if (value === undefined) {
    return undefined;
  }
