...
export function TransactionPreviewResponseFromJSON(
  json: any,
): TransactionPreviewResponse {
  return TransactionPreviewResponseFromJSONTyped(json, false);
}

export function TransactionPreviewResponseFromJSONTyped(
  json: any,
  ...
  return {
    ...
    instruction_resource_changes: !exists(json, "instruction_resource_changes")
      ? undefined
      : (json["instruction_resource_changes"] as Array<any>).map(
          InstructionResourceChangesFromJSON,
        ),
    logs: (json["logs"] as Array<any>).map(
      TransactionPreviewResponseLogsInnerFromJSON,
    ),
  };
}

export function TransactionPreviewResponseToJSON(
  value?: TransactionPreviewResponse | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    ...
    instruction_resource_changes:
      value.instruction_resource_changes === undefined
        ? undefined
        : (value.instruction_resource_changes as Array<any>).map(
            InstructionResourceChangesToJSON,
          ),
    logs: (value.logs as Array<any>).map(
      TransactionPreviewResponseLogsInnerToJSON,
    ),
  };
}
