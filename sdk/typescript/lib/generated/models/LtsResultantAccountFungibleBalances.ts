 ...
 */
export function instanceOfLtsResultantAccountFungibleBalances(
  value: object,
): boolean {
  let isInstance = true;
...
export function LtsResultantAccountFungibleBalancesFromJSON(
  json: any,
): LtsResultantAccountFungibleBalances {
  return LtsResultantAccountFungibleBalancesFromJSONTyped(json, false);
}

export function LtsResultantAccountFungibleBalancesFromJSONTyped(
  json: any,
  ...
  return {
    ...
    resultant_balances: (json["resultant_balances"] as Array<any>).map(
      LtsResultantFungibleBalanceFromJSON,
    ),
  };
}

export function LtsResultantAccountFungibleBalancesToJSON(
  value?: LtsResultantAccountFungibleBalances | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    ...
    resultant_balances: (value.resultant_balances as Array<any>).map(
      LtsResultantFungibleBalanceToJSON,
    ),
  };
}
