...
export type AccessControllerFieldStateSubstateSubstateTypeEnum =
  (typeof AccessControllerFieldStateSubstateSubstateTypeEnum)[keyof typeof AccessControllerFieldStateSubstateSubstateTypeEnum];

/**
 * Check if a given object implements the AccessControllerFieldStateSubstate interface.
 */
export function instanceOfAccessControllerFieldStateSubstate(
  value: object,
): boolean {
  let isInstance = true;
...
export function AccessControllerFieldStateSubstateFromJSON(
  json: any,
): AccessControllerFieldStateSubstate {
  return AccessControllerFieldStateSubstateFromJSONTyped(json, false);
}

export function AccessControllerFieldStateSubstateFromJSONTyped(
  json: any,
...
export function AccessControllerFieldStateSubstateToJSON(
  value?: AccessControllerFieldStateSubstate | null,
): any {
  if (value === undefined) {
    return undefined;
  }
