...
export function ProtocolVersionReadinessFromJSON(
  json: any,
): ProtocolVersionReadiness {
  return ProtocolVersionReadinessFromJSONTyped(json, false);
}

export function ProtocolVersionReadinessFromJSONTyped(
  json: any,
  ...
  return {
    signalled_protocol_version: !exists(json, "signalled_protocol_version")
      ? undefined
      : json["signalled_protocol_version"],
    total_active_stake_proportion: json["total_active_stake_proportion"],
    signalling_validators: (json["signalling_validators"] as Array<any>).map(
      SignallingValidatorFromJSON,
    ),
  };
}

export function ProtocolVersionReadinessToJSON(
  value?: ProtocolVersionReadiness | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    ...
    signalling_validators: (value.signalling_validators as Array<any>).map(
      SignallingValidatorToJSON,
    ),
  };
}
