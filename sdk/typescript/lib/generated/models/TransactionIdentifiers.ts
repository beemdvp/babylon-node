...
export function TransactionIdentifiersFromJSON(
  json: any,
): TransactionIdentifiers {
  return TransactionIdentifiersFromJSONTyped(json, false);
}

export function TransactionIdentifiersFromJSONTyped(
  json: any,
...
export function TransactionIdentifiersToJSON(
  value?: TransactionIdentifiers | null,
): any {
  if (value === undefined) {
    return undefined;
  }
