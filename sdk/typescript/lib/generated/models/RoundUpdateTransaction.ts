...
export function RoundUpdateTransactionFromJSON(
  json: any,
): RoundUpdateTransaction {
  return RoundUpdateTransactionFromJSONTyped(json, false);
}

export function RoundUpdateTransactionFromJSONTyped(
  json: any,
  ...
  return {
    ...
    leader_proposal_history: LeaderProposalHistoryFromJSON(
      json["leader_proposal_history"],
    ),
  };
}

export function RoundUpdateTransactionToJSON(
  value?: RoundUpdateTransaction | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    ...
    leader_proposal_history: LeaderProposalHistoryToJSON(
      value.leader_proposal_history,
    ),
  };
}
