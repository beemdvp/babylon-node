...
export type KeyValueBlueprintCollectionSchemaAllOfTypeEnum =
  (typeof KeyValueBlueprintCollectionSchemaAllOfTypeEnum)[keyof typeof KeyValueBlueprintCollectionSchemaAllOfTypeEnum];

/**
 * Check if a given object implements the KeyValueBlueprintCollectionSchemaAllOf interface.
 */
export function instanceOfKeyValueBlueprintCollectionSchemaAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function KeyValueBlueprintCollectionSchemaAllOfFromJSON(
  json: any,
): KeyValueBlueprintCollectionSchemaAllOf {
  return KeyValueBlueprintCollectionSchemaAllOfFromJSONTyped(json, false);
}

export function KeyValueBlueprintCollectionSchemaAllOfFromJSONTyped(
  json: any,
...
export function KeyValueBlueprintCollectionSchemaAllOfToJSON(
  value?: KeyValueBlueprintCollectionSchemaAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
