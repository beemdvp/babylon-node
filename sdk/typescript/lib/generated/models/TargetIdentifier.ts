...
export type TargetIdentifier =
  | ({ type: "Function" } & BlueprintFunctionTargetIdentifier)
  | ({ type: "Method" } & ComponentMethodTargetIdentifier);

export function TargetIdentifierFromJSON(json: any): TargetIdentifier {
  return TargetIdentifierFromJSONTyped(json, false);
}

export function TargetIdentifierFromJSONTyped(
  json: any,
  ...
  switch (json["type"]) {
    case "Function":
      return {
        ...BlueprintFunctionTargetIdentifierFromJSONTyped(json, true),
        type: "Function",
      };
    case "Method":
      return {
        ...ComponentMethodTargetIdentifierFromJSONTyped(json, true),
        type: "Method",
      };
    default:
      throw new Error(
        `No variant of TargetIdentifier exists with 'type=${json["type"]}'`,
      );
  }
}
...
export function TargetIdentifierToJSON(value?: TargetIdentifier | null): any {
  ...
  switch (value["type"]) {
    ...
    default:
      throw new Error(
        `No variant of TargetIdentifier exists with 'type=${value["type"]}'`,
      );
  }
}
