 ...
 */
export function instanceOfLtsFungibleResourceBalanceChange(
  value: object,
): boolean {
  let isInstance = true;
...
export function LtsFungibleResourceBalanceChangeFromJSON(
  json: any,
): LtsFungibleResourceBalanceChange {
  return LtsFungibleResourceBalanceChangeFromJSONTyped(json, false);
}

export function LtsFungibleResourceBalanceChangeFromJSONTyped(
  json: any,
...
export function LtsFungibleResourceBalanceChangeToJSON(
  value?: LtsFungibleResourceBalanceChange | null,
): any {
  if (value === undefined) {
    return undefined;
  }
