...
export type PackageCodeVmTypeEntrySubstateSubstateTypeEnum =
  (typeof PackageCodeVmTypeEntrySubstateSubstateTypeEnum)[keyof typeof PackageCodeVmTypeEntrySubstateSubstateTypeEnum];

/**
 * Check if a given object implements the PackageCodeVmTypeEntrySubstate interface.
 */
export function instanceOfPackageCodeVmTypeEntrySubstate(
  value: object,
): boolean {
  let isInstance = true;
...
export function PackageCodeVmTypeEntrySubstateFromJSON(
  json: any,
): PackageCodeVmTypeEntrySubstate {
  return PackageCodeVmTypeEntrySubstateFromJSONTyped(json, false);
}

export function PackageCodeVmTypeEntrySubstateFromJSONTyped(
  json: any,
...
export function PackageCodeVmTypeEntrySubstateToJSON(
  value?: PackageCodeVmTypeEntrySubstate | null,
): any {
  if (value === undefined) {
    return undefined;
  }
