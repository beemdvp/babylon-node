...
export type TransactionPreviewV2ErrorResponseAllOfErrorTypeEnum =
  (typeof TransactionPreviewV2ErrorResponseAllOfErrorTypeEnum)[keyof typeof TransactionPreviewV2ErrorResponseAllOfErrorTypeEnum];

/**
 * Check if a given object implements the TransactionPreviewV2ErrorResponseAllOf interface.
 */
export function instanceOfTransactionPreviewV2ErrorResponseAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function TransactionPreviewV2ErrorResponseAllOfFromJSON(
  json: any,
): TransactionPreviewV2ErrorResponseAllOf {
  return TransactionPreviewV2ErrorResponseAllOfFromJSONTyped(json, false);
}

export function TransactionPreviewV2ErrorResponseAllOfFromJSONTyped(
  json: any,
  ...
  return {
    details: !exists(json, "details")
      ? undefined
      : TransactionPreviewV2ErrorDetailsFromJSON(json["details"]),
    error_type: !exists(json, "error_type") ? undefined : json["error_type"],
  };
}

export function TransactionPreviewV2ErrorResponseAllOfToJSON(
  value?: TransactionPreviewV2ErrorResponseAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
