 ...
 */
export function instanceOfTransactionCallPreviewResponse(
  value: object,
): boolean {
  let isInstance = true;
...
export function TransactionCallPreviewResponseFromJSON(
  json: any,
): TransactionCallPreviewResponse {
  return TransactionCallPreviewResponseFromJSONTyped(json, false);
}

export function TransactionCallPreviewResponseFromJSONTyped(
  json: any,
...
export function TransactionCallPreviewResponseToJSON(
  value?: TransactionCallPreviewResponse | null,
): any {
  if (value === undefined) {
    return undefined;
  }
