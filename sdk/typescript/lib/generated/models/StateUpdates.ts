...
export function StateUpdatesFromJSONTyped(
  json: any,
  ...
  return {
    deleted_partitions: (json["deleted_partitions"] as Array<any>).map(
      PartitionIdFromJSON,
    ),
    created_substates: (json["created_substates"] as Array<any>).map(
      CreatedSubstateFromJSON,
    ),
    updated_substates: (json["updated_substates"] as Array<any>).map(
      UpdatedSubstateFromJSON,
    ),
    deleted_substates: (json["deleted_substates"] as Array<any>).map(
      DeletedSubstateFromJSON,
    ),
    new_global_entities: (json["new_global_entities"] as Array<any>).map(
      EntityReferenceFromJSON,
    ),
  };
}
...
export function StateUpdatesToJSON(value?: StateUpdates | null): any {
  ...
  return {
    deleted_partitions: (value.deleted_partitions as Array<any>).map(
      PartitionIdToJSON,
    ),
    created_substates: (value.created_substates as Array<any>).map(
      CreatedSubstateToJSON,
    ),
    updated_substates: (value.updated_substates as Array<any>).map(
      UpdatedSubstateToJSON,
    ),
    deleted_substates: (value.deleted_substates as Array<any>).map(
      DeletedSubstateToJSON,
    ),
    new_global_entities: (value.new_global_entities as Array<any>).map(
      EntityReferenceToJSON,
    ),
  };
}
