...
export function LtsResultantFungibleBalanceFromJSON(
  json: any,
): LtsResultantFungibleBalance {
  return LtsResultantFungibleBalanceFromJSONTyped(json, false);
}

export function LtsResultantFungibleBalanceFromJSONTyped(
  json: any,
...
export function LtsResultantFungibleBalanceToJSON(
  value?: LtsResultantFungibleBalance | null,
): any {
  if (value === undefined) {
    return undefined;
  }
