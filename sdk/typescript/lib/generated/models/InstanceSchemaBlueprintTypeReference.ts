...
export type InstanceSchemaBlueprintTypeReferenceTypeEnum =
  (typeof InstanceSchemaBlueprintTypeReferenceTypeEnum)[keyof typeof InstanceSchemaBlueprintTypeReferenceTypeEnum];

/**
 * Check if a given object implements the InstanceSchemaBlueprintTypeReference interface.
 */
export function instanceOfInstanceSchemaBlueprintTypeReference(
  value: object,
): boolean {
  let isInstance = true;
...
export function InstanceSchemaBlueprintTypeReferenceFromJSON(
  json: any,
): InstanceSchemaBlueprintTypeReference {
  return InstanceSchemaBlueprintTypeReferenceFromJSONTyped(json, false);
}

export function InstanceSchemaBlueprintTypeReferenceFromJSONTyped(
  json: any,
...
export function InstanceSchemaBlueprintTypeReferenceToJSON(
  value?: InstanceSchemaBlueprintTypeReference | null,
): any {
  if (value === undefined) {
    return undefined;
  }
