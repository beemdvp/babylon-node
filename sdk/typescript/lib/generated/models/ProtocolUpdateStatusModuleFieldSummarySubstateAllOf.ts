...
export type ProtocolUpdateStatusModuleFieldSummarySubstateAllOfSubstateTypeEnum =
  (typeof ProtocolUpdateStatusModuleFieldSummarySubstateAllOfSubstateTypeEnum)[keyof typeof ProtocolUpdateStatusModuleFieldSummarySubstateAllOfSubstateTypeEnum];

/**
 * Check if a given object implements the ProtocolUpdateStatusModuleFieldSummarySubstateAllOf interface.
 */
export function instanceOfProtocolUpdateStatusModuleFieldSummarySubstateAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function ProtocolUpdateStatusModuleFieldSummarySubstateAllOfFromJSON(
  json: any,
): ProtocolUpdateStatusModuleFieldSummarySubstateAllOf {
  return ProtocolUpdateStatusModuleFieldSummarySubstateAllOfFromJSONTyped(
    json,
    false,
  );
}

export function ProtocolUpdateStatusModuleFieldSummarySubstateAllOfFromJSONTyped(
  json: any,
...
export function ProtocolUpdateStatusModuleFieldSummarySubstateAllOfToJSON(
  value?: ProtocolUpdateStatusModuleFieldSummarySubstateAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
