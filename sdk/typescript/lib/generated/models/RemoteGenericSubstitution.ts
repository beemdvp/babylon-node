...
export type RemoteGenericSubstitutionTypeEnum =
  (typeof RemoteGenericSubstitutionTypeEnum)[keyof typeof RemoteGenericSubstitutionTypeEnum];
...
export function RemoteGenericSubstitutionFromJSON(
  json: any,
): RemoteGenericSubstitution {
  return RemoteGenericSubstitutionFromJSONTyped(json, false);
}

export function RemoteGenericSubstitutionFromJSONTyped(
  json: any,
...
export function RemoteGenericSubstitutionToJSON(
  value?: RemoteGenericSubstitution | null,
): any {
  if (value === undefined) {
    return undefined;
  }
