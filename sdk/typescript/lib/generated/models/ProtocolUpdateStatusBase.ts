...
export function ProtocolUpdateStatusBaseFromJSON(
  json: any,
): ProtocolUpdateStatusBase {
  return ProtocolUpdateStatusBaseFromJSONTyped(json, false);
}

export function ProtocolUpdateStatusBaseFromJSONTyped(
  json: any,
...
export function ProtocolUpdateStatusBaseToJSON(
  value?: ProtocolUpdateStatusBase | null,
): any {
  if (value === undefined) {
    return undefined;
  }
