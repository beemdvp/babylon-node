...
export type FlashLedgerTransactionTypeEnum =
  (typeof FlashLedgerTransactionTypeEnum)[keyof typeof FlashLedgerTransactionTypeEnum];
...
export function FlashLedgerTransactionFromJSON(
  json: any,
): FlashLedgerTransaction {
  return FlashLedgerTransactionFromJSONTyped(json, false);
}

export function FlashLedgerTransactionFromJSONTyped(
  json: any,
...
export function FlashLedgerTransactionToJSON(
  value?: FlashLedgerTransaction | null,
): any {
  if (value === undefined) {
    return undefined;
  }
