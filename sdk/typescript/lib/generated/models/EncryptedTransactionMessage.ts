...
export type EncryptedTransactionMessageTypeEnum =
  (typeof EncryptedTransactionMessageTypeEnum)[keyof typeof EncryptedTransactionMessageTypeEnum];
...
export function EncryptedTransactionMessageFromJSON(
  json: any,
): EncryptedTransactionMessage {
  return EncryptedTransactionMessageFromJSONTyped(json, false);
}

export function EncryptedTransactionMessageFromJSONTyped(
  json: any,
...
export function EncryptedTransactionMessageToJSON(
  value?: EncryptedTransactionMessage | null,
): any {
  if (value === undefined) {
    return undefined;
  }
