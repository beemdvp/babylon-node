...
export type ConsensusManagerFieldCurrentTimeSubstateSubstateTypeEnum =
  (typeof ConsensusManagerFieldCurrentTimeSubstateSubstateTypeEnum)[keyof typeof ConsensusManagerFieldCurrentTimeSubstateSubstateTypeEnum];

/**
 * Check if a given object implements the ConsensusManagerFieldCurrentTimeSubstate interface.
 */
export function instanceOfConsensusManagerFieldCurrentTimeSubstate(
  value: object,
): boolean {
  let isInstance = true;
...
export function ConsensusManagerFieldCurrentTimeSubstateFromJSON(
  json: any,
): ConsensusManagerFieldCurrentTimeSubstate {
  return ConsensusManagerFieldCurrentTimeSubstateFromJSONTyped(json, false);
}

export function ConsensusManagerFieldCurrentTimeSubstateFromJSONTyped(
  json: any,
...
export function ConsensusManagerFieldCurrentTimeSubstateToJSON(
  value?: ConsensusManagerFieldCurrentTimeSubstate | null,
): any {
  if (value === undefined) {
    return undefined;
  }
