...
export function StateNonFungibleRequestFromJSON(
  json: any,
): StateNonFungibleRequest {
  return StateNonFungibleRequestFromJSONTyped(json, false);
}

export function StateNonFungibleRequestFromJSONTyped(
  json: any,
...
export function StateNonFungibleRequestToJSON(
  value?: StateNonFungibleRequest | null,
): any {
  if (value === undefined) {
    return undefined;
  }
