...
export type FungibleVaultFieldBalanceSubstateAllOfSubstateTypeEnum =
  (typeof FungibleVaultFieldBalanceSubstateAllOfSubstateTypeEnum)[keyof typeof FungibleVaultFieldBalanceSubstateAllOfSubstateTypeEnum];

/**
 * Check if a given object implements the FungibleVaultFieldBalanceSubstateAllOf interface.
 */
export function instanceOfFungibleVaultFieldBalanceSubstateAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function FungibleVaultFieldBalanceSubstateAllOfFromJSON(
  json: any,
): FungibleVaultFieldBalanceSubstateAllOf {
  return FungibleVaultFieldBalanceSubstateAllOfFromJSONTyped(json, false);
}

export function FungibleVaultFieldBalanceSubstateAllOfFromJSONTyped(
  json: any,
...
export function FungibleVaultFieldBalanceSubstateAllOfToJSON(
  value?: FungibleVaultFieldBalanceSubstateAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
