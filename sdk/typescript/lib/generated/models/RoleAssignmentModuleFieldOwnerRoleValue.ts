 ...
 */
export function instanceOfRoleAssignmentModuleFieldOwnerRoleValue(
  value: object,
): boolean {
  let isInstance = true;
...
export function RoleAssignmentModuleFieldOwnerRoleValueFromJSON(
  json: any,
): RoleAssignmentModuleFieldOwnerRoleValue {
  return RoleAssignmentModuleFieldOwnerRoleValueFromJSONTyped(json, false);
}

export function RoleAssignmentModuleFieldOwnerRoleValueFromJSONTyped(
  json: any,
...
export function RoleAssignmentModuleFieldOwnerRoleValueToJSON(
  value?: RoleAssignmentModuleFieldOwnerRoleValue | null,
): any {
  if (value === undefined) {
    return undefined;
  }
