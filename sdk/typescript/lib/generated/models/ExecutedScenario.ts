...
export function ExecutedScenarioFromJSONTyped(
  json: any,
  ...
  return {
    ...
    committed_transactions: (json["committed_transactions"] as Array<any>).map(
      ExecutedScenarioTransactionFromJSON,
    ),
...
export function ExecutedScenarioToJSON(value?: ExecutedScenario | null): any {
  ...
  return {
    ...
    committed_transactions: (value.committed_transactions as Array<any>).map(
      ExecutedScenarioTransactionToJSON,
    ),
