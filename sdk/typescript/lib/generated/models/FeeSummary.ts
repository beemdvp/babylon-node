...
export interface FeeSummary {
  ...
  /**
   * The string-encoded decimal representing the total amount of RORK burned in the transaction as part of execution costs.
  ...
  /**
   * The string-encoded decimal representing the total amount of RORK burned in the transaction as part of finalization costs.
   * A decimal is formed of some signed integer `m` of attos (`10^(-18)`) units, where `-2^(192 - 1) <= m < 2^(192 - 1)`.
   * @type {string}
   * @memberof FeeSummary
   */
  ...
  /**
   * The string-encoded decimal representing the total amount of RORK paid in royalties as part of the transaction.
   * A decimal is formed of some signed integer `m` of attos (`10^(-18)`) units, where `-2^(192 - 1) <= m < 2^(192 - 1)`.
   * @type {string}
   * @memberof FeeSummary
   */
  ...
  /**
   * The string-encoded decimal representing the total amount of RORK paid in state expansion costs as part of the transaction.
   * A decimal is formed of some signed integer `m` of attos (`10^(-18)`) units, where `-2^(192 - 1) <= m < 2^(192 - 1)`.
   * @type {string}
   * @memberof FeeSummary
   */
  ...
  /**
   * The string-encoded decimal representing the total amount of RORK tipped to validators in the transaction.
   * A decimal is formed of some signed integer `m` of attos (`10^(-18)`) units, where `-2^(192 - 1) <= m < 2^(192 - 1)`.
   * @type {string}
   * @memberof FeeSummary
   */
...
export function FeeSummaryFromJSONTyped(
  json: any,
