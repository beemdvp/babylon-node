...
export function LedgerHeaderFromJSONTyped(
  json: any,
  ...
  return {
    ...
    consensus_parent_round_timestamp_ms:
      json["consensus_parent_round_timestamp_ms"],
    proposer_timestamp_ms: json["proposer_timestamp_ms"],
    next_epoch: !exists(json, "next_epoch")
      ? undefined
      : NextEpochFromJSON(json["next_epoch"]),
    next_protocol_version: !exists(json, "next_protocol_version")
      ? undefined
      : json["next_protocol_version"],
  };
}
...
export function LedgerHeaderToJSON(value?: LedgerHeader | null): any {
  ...
  return {
    ...
    consensus_parent_round_timestamp_ms:
      value.consensus_parent_round_timestamp_ms,
