...
export type NonFungibleResourceManagerDataEntrySubstateAllOfSubstateTypeEnum =
  (typeof NonFungibleResourceManagerDataEntrySubstateAllOfSubstateTypeEnum)[keyof typeof NonFungibleResourceManagerDataEntrySubstateAllOfSubstateTypeEnum];

/**
 * Check if a given object implements the NonFungibleResourceManagerDataEntrySubstateAllOf interface.
 */
export function instanceOfNonFungibleResourceManagerDataEntrySubstateAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function NonFungibleResourceManagerDataEntrySubstateAllOfFromJSON(
  json: any,
): NonFungibleResourceManagerDataEntrySubstateAllOf {
  return NonFungibleResourceManagerDataEntrySubstateAllOfFromJSONTyped(
    json,
    false,
  );
}

export function NonFungibleResourceManagerDataEntrySubstateAllOfFromJSONTyped(
  json: any,
  ...
  return {
    ...
    value: !exists(json, "value")
      ? undefined
      : NonFungibleResourceManagerDataEntryValueFromJSON(json["value"]),
...
export function NonFungibleResourceManagerDataEntrySubstateAllOfToJSON(
  value?: NonFungibleResourceManagerDataEntrySubstateAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
