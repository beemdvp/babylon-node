...
export function StateNonFungibleResponseFromJSON(
  json: any,
): StateNonFungibleResponse {
  return StateNonFungibleResponseFromJSONTyped(json, false);
}

export function StateNonFungibleResponseFromJSONTyped(
  json: any,
...
export function StateNonFungibleResponseToJSON(
  value?: StateNonFungibleResponse | null,
): any {
  if (value === undefined) {
    return undefined;
  }
