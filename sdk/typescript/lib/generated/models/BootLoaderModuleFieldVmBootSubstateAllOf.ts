...
export type BootLoaderModuleFieldVmBootSubstateAllOfSubstateTypeEnum =
  (typeof BootLoaderModuleFieldVmBootSubstateAllOfSubstateTypeEnum)[keyof typeof BootLoaderModuleFieldVmBootSubstateAllOfSubstateTypeEnum];

/**
 * Check if a given object implements the BootLoaderModuleFieldVmBootSubstateAllOf interface.
 */
export function instanceOfBootLoaderModuleFieldVmBootSubstateAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function BootLoaderModuleFieldVmBootSubstateAllOfFromJSON(
  json: any,
): BootLoaderModuleFieldVmBootSubstateAllOf {
  return BootLoaderModuleFieldVmBootSubstateAllOfFromJSONTyped(json, false);
}

export function BootLoaderModuleFieldVmBootSubstateAllOfFromJSONTyped(
  json: any,
...
export function BootLoaderModuleFieldVmBootSubstateAllOfToJSON(
  value?: BootLoaderModuleFieldVmBootSubstateAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
