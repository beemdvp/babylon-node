...
export type NonFungibleResourceAmountAllOfResourceTypeEnum =
  (typeof NonFungibleResourceAmountAllOfResourceTypeEnum)[keyof typeof NonFungibleResourceAmountAllOfResourceTypeEnum];

/**
 * Check if a given object implements the NonFungibleResourceAmountAllOf interface.
 */
export function instanceOfNonFungibleResourceAmountAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function NonFungibleResourceAmountAllOfFromJSON(
  json: any,
): NonFungibleResourceAmountAllOf {
  return NonFungibleResourceAmountAllOfFromJSONTyped(json, false);
}

export function NonFungibleResourceAmountAllOfFromJSONTyped(
  json: any,
  ...
  return {
    amount: json["amount"],
    non_fungible_ids: (json["non_fungible_ids"] as Array<any>).map(
      NonFungibleLocalIdFromJSON,
    ),
...
export function NonFungibleResourceAmountAllOfToJSON(
  value?: NonFungibleResourceAmountAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    amount: value.amount,
    non_fungible_ids: (value.non_fungible_ids as Array<any>).map(
      NonFungibleLocalIdToJSON,
    ),
