...
export function LedgerProofOriginBaseFromJSON(
  json: any,
): LedgerProofOriginBase {
  return LedgerProofOriginBaseFromJSONTyped(json, false);
}

export function LedgerProofOriginBaseFromJSONTyped(
  json: any,
...
export function LedgerProofOriginBaseToJSON(
  value?: LedgerProofOriginBase | null,
): any {
  if (value === undefined) {
    return undefined;
  }
