...
export type ParsedNotarizedTransactionTypeEnum =
  (typeof ParsedNotarizedTransactionTypeEnum)[keyof typeof ParsedNotarizedTransactionTypeEnum];
...
export function ParsedNotarizedTransactionFromJSON(
  json: any,
): ParsedNotarizedTransaction {
  return ParsedNotarizedTransactionFromJSONTyped(json, false);
}

export function ParsedNotarizedTransactionFromJSONTyped(
  json: any,
...
export function ParsedNotarizedTransactionToJSON(
  value?: ParsedNotarizedTransaction | null,
): any {
  if (value === undefined) {
    return undefined;
  }
