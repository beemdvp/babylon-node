 ...
 */
export function instanceOfTransactionTrackerFieldStateValue(
  value: object,
): boolean {
  let isInstance = true;
...
export function TransactionTrackerFieldStateValueFromJSON(
  json: any,
): TransactionTrackerFieldStateValue {
  return TransactionTrackerFieldStateValueFromJSONTyped(json, false);
}

export function TransactionTrackerFieldStateValueFromJSONTyped(
  json: any,
...
export function TransactionTrackerFieldStateValueToJSON(
  value?: TransactionTrackerFieldStateValue | null,
): any {
  if (value === undefined) {
    return undefined;
  }
