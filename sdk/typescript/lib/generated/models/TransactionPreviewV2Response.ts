...
export function TransactionPreviewV2ResponseFromJSON(
  json: any,
): TransactionPreviewV2Response {
  return TransactionPreviewV2ResponseFromJSONTyped(json, false);
}

export function TransactionPreviewV2ResponseFromJSONTyped(
  json: any,
  ...
  return {
    ...
    receipt: !exists(json, "receipt")
      ? undefined
      : TransactionReceiptFromJSON(json["receipt"]),
    radix_engine_toolkit_receipt: !exists(json, "radix_engine_toolkit_receipt")
      ? undefined
      : json["radix_engine_toolkit_receipt"],
    logs: !exists(json, "logs")
      ? undefined
      : (json["logs"] as Array<any>).map(
          TransactionPreviewResponseLogsInnerFromJSON,
        ),
  };
}

export function TransactionPreviewV2ResponseToJSON(
  value?: TransactionPreviewV2Response | null,
): any {
  if (value === undefined) {
    return undefined;
  }
