...
export function MessageValidationConfigFromJSON(
  json: any,
): MessageValidationConfig {
  return MessageValidationConfigFromJSONTyped(json, false);
}

export function MessageValidationConfigFromJSONTyped(
  json: any,
...
export function MessageValidationConfigToJSON(
  value?: MessageValidationConfig | null,
): any {
  if (value === undefined) {
    return undefined;
  }
