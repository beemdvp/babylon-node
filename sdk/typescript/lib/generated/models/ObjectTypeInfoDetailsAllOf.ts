...
export type ObjectTypeInfoDetailsAllOfTypeEnum =
  (typeof ObjectTypeInfoDetailsAllOfTypeEnum)[keyof typeof ObjectTypeInfoDetailsAllOfTypeEnum];
...
export function ObjectTypeInfoDetailsAllOfFromJSON(
  json: any,
): ObjectTypeInfoDetailsAllOf {
  return ObjectTypeInfoDetailsAllOfFromJSONTyped(json, false);
}

export function ObjectTypeInfoDetailsAllOfFromJSONTyped(
  json: any,
  ...
  return {
    module_versions: (json["module_versions"] as Array<any>).map(
      ModuleVersionFromJSON,
    ),
...
export function ObjectTypeInfoDetailsAllOfToJSON(
  value?: ObjectTypeInfoDetailsAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    module_versions: (value.module_versions as Array<any>).map(
      ModuleVersionToJSON,
    ),
