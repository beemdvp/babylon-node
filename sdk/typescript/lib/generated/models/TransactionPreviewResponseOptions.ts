 ...
 */
export function instanceOfTransactionPreviewResponseOptions(
  value: object,
): boolean {
  let isInstance = true;
...
export function TransactionPreviewResponseOptionsFromJSON(
  json: any,
): TransactionPreviewResponseOptions {
  return TransactionPreviewResponseOptionsFromJSONTyped(json, false);
}

export function TransactionPreviewResponseOptionsFromJSONTyped(
  json: any,
...
export function TransactionPreviewResponseOptionsToJSON(
  value?: TransactionPreviewResponseOptions | null,
): any {
  if (value === undefined) {
    return undefined;
  }
