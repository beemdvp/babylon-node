 ...
 */
export function instanceOfLtsStreamAccountTransactionOutcomesResponse(
  value: object,
): boolean {
  let isInstance = true;
...
export function LtsStreamAccountTransactionOutcomesResponseFromJSON(
  json: any,
): LtsStreamAccountTransactionOutcomesResponse {
  return LtsStreamAccountTransactionOutcomesResponseFromJSONTyped(json, false);
}

export function LtsStreamAccountTransactionOutcomesResponseFromJSONTyped(
  json: any,
  ...
  return {
    ...
    committed_transaction_outcomes: (
      json["committed_transaction_outcomes"] as Array<any>
    ).map(LtsCommittedTransactionOutcomeFromJSON),
  };
}

export function LtsStreamAccountTransactionOutcomesResponseToJSON(
  value?: LtsStreamAccountTransactionOutcomesResponse | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    ...
    committed_transaction_outcomes: (
      value.committed_transaction_outcomes as Array<any>
    ).map(LtsCommittedTransactionOutcomeToJSON),
  };
}
