...
export type FungibleResourceManagerFieldTotalSupplySubstateAllOfSubstateTypeEnum =
  (typeof FungibleResourceManagerFieldTotalSupplySubstateAllOfSubstateTypeEnum)[keyof typeof FungibleResourceManagerFieldTotalSupplySubstateAllOfSubstateTypeEnum];

/**
 * Check if a given object implements the FungibleResourceManagerFieldTotalSupplySubstateAllOf interface.
 */
export function instanceOfFungibleResourceManagerFieldTotalSupplySubstateAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function FungibleResourceManagerFieldTotalSupplySubstateAllOfFromJSON(
  json: any,
): FungibleResourceManagerFieldTotalSupplySubstateAllOf {
  return FungibleResourceManagerFieldTotalSupplySubstateAllOfFromJSONTyped(
    json,
    false,
  );
}

export function FungibleResourceManagerFieldTotalSupplySubstateAllOfFromJSONTyped(
  json: any,
...
export function FungibleResourceManagerFieldTotalSupplySubstateAllOfToJSON(
  value?: FungibleResourceManagerFieldTotalSupplySubstateAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
