...
export type EddsaEd25519SignatureWithPublicKeyAllOfKeyTypeEnum =
  (typeof EddsaEd25519SignatureWithPublicKeyAllOfKeyTypeEnum)[keyof typeof EddsaEd25519SignatureWithPublicKeyAllOfKeyTypeEnum];

/**
 * Check if a given object implements the EddsaEd25519SignatureWithPublicKeyAllOf interface.
 */
export function instanceOfEddsaEd25519SignatureWithPublicKeyAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function EddsaEd25519SignatureWithPublicKeyAllOfFromJSON(
  json: any,
): EddsaEd25519SignatureWithPublicKeyAllOf {
  return EddsaEd25519SignatureWithPublicKeyAllOfFromJSONTyped(json, false);
}

export function EddsaEd25519SignatureWithPublicKeyAllOfFromJSONTyped(
  json: any,
...
export function EddsaEd25519SignatureWithPublicKeyAllOfToJSON(
  value?: EddsaEd25519SignatureWithPublicKeyAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
