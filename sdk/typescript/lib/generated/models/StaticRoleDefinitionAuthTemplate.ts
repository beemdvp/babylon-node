 ...
 */
export function instanceOfStaticRoleDefinitionAuthTemplate(
  value: object,
): boolean {
  let isInstance = true;
...
export function StaticRoleDefinitionAuthTemplateFromJSON(
  json: any,
): StaticRoleDefinitionAuthTemplate {
  return StaticRoleDefinitionAuthTemplateFromJSONTyped(json, false);
}

export function StaticRoleDefinitionAuthTemplateFromJSONTyped(
  json: any,
  ...
  return {
    ...
    roles: !exists(json, "roles")
      ? undefined
      : mapValues(json["roles"], RoleDetailsFromJSON),
    method_accessibility_map: mapValues(
      json["method_accessibility_map"],
      MethodAccessibilityFromJSON,
    ),
  };
}

export function StaticRoleDefinitionAuthTemplateToJSON(
  value?: StaticRoleDefinitionAuthTemplate | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    ...
    roles:
      value.roles === undefined
        ? undefined
        : mapValues(value.roles, RoleDetailsToJSON),
    method_accessibility_map: mapValues(
      value.method_accessibility_map,
      MethodAccessibilityToJSON,
    ),
  };
}
