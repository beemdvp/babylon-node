 ...
 * @export
 */
export type StreamProofsFilter =
  | ({ type: "Any" } & StreamProofsFilterAny)
  | ({ type: "NewEpochs" } & StreamProofsFilterNewEpochs)
  | ({
      type: "ProtocolUpdateExecution";
    } & StreamProofsFilterProtocolUpdateExecution)
  | ({
      type: "ProtocolUpdateInitializations";
    } & StreamProofsFilterProtocolUpdateInitializations);
...
export function StreamProofsFilterFromJSONTyped(
  json: any,
  ...
  switch (json["type"]) {
    ...
    case "NewEpochs":
      return {
        ...StreamProofsFilterNewEpochsFromJSONTyped(json, true),
        type: "NewEpochs",
      };
    case "ProtocolUpdateExecution":
      return {
        ...StreamProofsFilterProtocolUpdateExecutionFromJSONTyped(json, true),
        type: "ProtocolUpdateExecution",
      };
    ...
    default:
      throw new Error(
        `No variant of StreamProofsFilter exists with 'type=${json["type"]}'`,
      );
  }
}

export function StreamProofsFilterToJSON(
  value?: StreamProofsFilter | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  switch (value["type"]) {
    ...
    default:
      throw new Error(
        `No variant of StreamProofsFilter exists with 'type=${value["type"]}'`,
      );
  }
}
