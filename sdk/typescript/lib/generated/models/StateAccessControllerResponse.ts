 ...
 */
export function instanceOfStateAccessControllerResponse(
  value: object,
): boolean {
  let isInstance = true;
...
export function StateAccessControllerResponseFromJSON(
  json: any,
): StateAccessControllerResponse {
  return StateAccessControllerResponseFromJSONTyped(json, false);
}

export function StateAccessControllerResponseFromJSONTyped(
  json: any,
...
export function StateAccessControllerResponseToJSON(
  value?: StateAccessControllerResponse | null,
): any {
  if (value === undefined) {
    return undefined;
  }
