...
export type AccountResourcePreferenceEntrySubstateSubstateTypeEnum =
  (typeof AccountResourcePreferenceEntrySubstateSubstateTypeEnum)[keyof typeof AccountResourcePreferenceEntrySubstateSubstateTypeEnum];

/**
 * Check if a given object implements the AccountResourcePreferenceEntrySubstate interface.
 */
export function instanceOfAccountResourcePreferenceEntrySubstate(
  value: object,
): boolean {
  let isInstance = true;
...
export function AccountResourcePreferenceEntrySubstateFromJSON(
  json: any,
): AccountResourcePreferenceEntrySubstate {
  return AccountResourcePreferenceEntrySubstateFromJSONTyped(json, false);
}

export function AccountResourcePreferenceEntrySubstateFromJSONTyped(
  json: any,
...
export function AccountResourcePreferenceEntrySubstateToJSON(
  value?: AccountResourcePreferenceEntrySubstate | null,
): any {
  if (value === undefined) {
    return undefined;
  }
