 ...
 */
export function instanceOfParsedNotarizedTransactionIdentifiers(
  value: object,
): boolean {
  let isInstance = true;
...
export function ParsedNotarizedTransactionIdentifiersFromJSON(
  json: any,
): ParsedNotarizedTransactionIdentifiers {
  return ParsedNotarizedTransactionIdentifiersFromJSONTyped(json, false);
}

export function ParsedNotarizedTransactionIdentifiersFromJSONTyped(
  json: any,
...
export function ParsedNotarizedTransactionIdentifiersToJSON(
  value?: ParsedNotarizedTransactionIdentifiers | null,
): any {
  if (value === undefined) {
    return undefined;
  }
