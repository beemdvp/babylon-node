...
export function StateConsensusManagerRequestFromJSON(
  json: any,
): StateConsensusManagerRequest {
  return StateConsensusManagerRequestFromJSONTyped(json, false);
}

export function StateConsensusManagerRequestFromJSONTyped(
  json: any,
  ...
  return {
    ...
    include_readiness_signals: !exists(json, "include_readiness_signals")
      ? undefined
      : json["include_readiness_signals"],
  };
}

export function StateConsensusManagerRequestToJSON(
  value?: StateConsensusManagerRequest | null,
): any {
  if (value === undefined) {
    return undefined;
  }
