...
export function SystemParametersFromJSONTyped(
  json: any,
  ...
  return {
    ...
    costing_module_config: CostingModuleConfigFromJSON(
      json["costing_module_config"],
    ),
    costing_parameters: SystemCostingParametersFromJSON(
      json["costing_parameters"],
    ),
...
export function SystemParametersToJSON(value?: SystemParameters | null): any {
  ...
  return {
    ...
    costing_module_config: CostingModuleConfigToJSON(
      value.costing_module_config,
    ),
