...
export function StreamTransactionsResponseFromJSON(
  json: any,
): StreamTransactionsResponse {
  return StreamTransactionsResponseFromJSONTyped(json, false);
}

export function StreamTransactionsResponseFromJSONTyped(
  json: any,
  ...
  return {
    previous_state_identifiers: !exists(json, "previous_state_identifiers")
      ? undefined
      : CommittedStateIdentifierFromJSON(json["previous_state_identifiers"]),
    ...
    proofs: !exists(json, "proofs")
      ? undefined
      : (json["proofs"] as Array<any>).map(LedgerProofFromJSON),
  };
}

export function StreamTransactionsResponseToJSON(
  value?: StreamTransactionsResponse | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    previous_state_identifiers: CommittedStateIdentifierToJSON(
      value.previous_state_identifiers,
    ),
    ...
    proofs:
      value.proofs === undefined
        ? undefined
        : (value.proofs as Array<any>).map(LedgerProofToJSON),
  };
}
