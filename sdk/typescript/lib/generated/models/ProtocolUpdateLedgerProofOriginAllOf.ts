...
export type ProtocolUpdateLedgerProofOriginAllOfTypeEnum =
  (typeof ProtocolUpdateLedgerProofOriginAllOfTypeEnum)[keyof typeof ProtocolUpdateLedgerProofOriginAllOfTypeEnum];

/**
 * Check if a given object implements the ProtocolUpdateLedgerProofOriginAllOf interface.
 */
export function instanceOfProtocolUpdateLedgerProofOriginAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function ProtocolUpdateLedgerProofOriginAllOfFromJSON(
  json: any,
): ProtocolUpdateLedgerProofOriginAllOf {
  return ProtocolUpdateLedgerProofOriginAllOfFromJSONTyped(json, false);
}

export function ProtocolUpdateLedgerProofOriginAllOfFromJSONTyped(
  json: any,
...
export function ProtocolUpdateLedgerProofOriginAllOfToJSON(
  value?: ProtocolUpdateLedgerProofOriginAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
