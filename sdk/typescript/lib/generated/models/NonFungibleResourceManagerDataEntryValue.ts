 ...
 */
export function instanceOfNonFungibleResourceManagerDataEntryValue(
  value: object,
): boolean {
  let isInstance = true;
...
export function NonFungibleResourceManagerDataEntryValueFromJSON(
  json: any,
): NonFungibleResourceManagerDataEntryValue {
  return NonFungibleResourceManagerDataEntryValueFromJSONTyped(json, false);
}

export function NonFungibleResourceManagerDataEntryValueFromJSONTyped(
  json: any,
...
export function NonFungibleResourceManagerDataEntryValueToJSON(
  value?: NonFungibleResourceManagerDataEntryValue | null,
): any {
  if (value === undefined) {
    return undefined;
  }
