...
export function StreamTransactionsRequestFromJSON(
  json: any,
): StreamTransactionsRequest {
  return StreamTransactionsRequestFromJSONTyped(json, false);
}

export function StreamTransactionsRequestFromJSONTyped(
  json: any,
  ...
  return {
    ...
    limit: json["limit"],
    sbor_format_options: !exists(json, "sbor_format_options")
      ? undefined
      : SborFormatOptionsFromJSON(json["sbor_format_options"]),
    ...
    substate_format_options: !exists(json, "substate_format_options")
      ? undefined
      : SubstateFormatOptionsFromJSON(json["substate_format_options"]),
    include_proofs: !exists(json, "include_proofs")
      ? undefined
      : json["include_proofs"],
  };
}

export function StreamTransactionsRequestToJSON(
  value?: StreamTransactionsRequest | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    ...
    substate_format_options: SubstateFormatOptionsToJSON(
      value.substate_format_options,
    ),
