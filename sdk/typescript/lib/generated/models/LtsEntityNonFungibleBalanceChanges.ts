 ...
 */
export function instanceOfLtsEntityNonFungibleBalanceChanges(
  value: object,
): boolean {
  let isInstance = true;
...
export function LtsEntityNonFungibleBalanceChangesFromJSON(
  json: any,
): LtsEntityNonFungibleBalanceChanges {
  return LtsEntityNonFungibleBalanceChangesFromJSONTyped(json, false);
}

export function LtsEntityNonFungibleBalanceChangesFromJSONTyped(
  json: any,
...
export function LtsEntityNonFungibleBalanceChangesToJSON(
  value?: LtsEntityNonFungibleBalanceChanges | null,
): any {
  if (value === undefined) {
    return undefined;
  }
