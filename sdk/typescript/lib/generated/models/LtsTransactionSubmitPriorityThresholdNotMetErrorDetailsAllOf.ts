...
export type LtsTransactionSubmitPriorityThresholdNotMetErrorDetailsAllOfTypeEnum =
  (typeof LtsTransactionSubmitPriorityThresholdNotMetErrorDetailsAllOfTypeEnum)[keyof typeof LtsTransactionSubmitPriorityThresholdNotMetErrorDetailsAllOfTypeEnum];

/**
 * Check if a given object implements the LtsTransactionSubmitPriorityThresholdNotMetErrorDetailsAllOf interface.
 */
export function instanceOfLtsTransactionSubmitPriorityThresholdNotMetErrorDetailsAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function LtsTransactionSubmitPriorityThresholdNotMetErrorDetailsAllOfFromJSON(
  json: any,
): LtsTransactionSubmitPriorityThresholdNotMetErrorDetailsAllOf {
  return LtsTransactionSubmitPriorityThresholdNotMetErrorDetailsAllOfFromJSONTyped(
    json,
    false,
  );
}

export function LtsTransactionSubmitPriorityThresholdNotMetErrorDetailsAllOfFromJSONTyped(
  json: any,
...
export function LtsTransactionSubmitPriorityThresholdNotMetErrorDetailsAllOfToJSON(
  value?: LtsTransactionSubmitPriorityThresholdNotMetErrorDetailsAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
