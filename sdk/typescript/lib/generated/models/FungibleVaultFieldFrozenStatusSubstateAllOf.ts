...
export type FungibleVaultFieldFrozenStatusSubstateAllOfSubstateTypeEnum =
  (typeof FungibleVaultFieldFrozenStatusSubstateAllOfSubstateTypeEnum)[keyof typeof FungibleVaultFieldFrozenStatusSubstateAllOfSubstateTypeEnum];

/**
 * Check if a given object implements the FungibleVaultFieldFrozenStatusSubstateAllOf interface.
 */
export function instanceOfFungibleVaultFieldFrozenStatusSubstateAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function FungibleVaultFieldFrozenStatusSubstateAllOfFromJSON(
  json: any,
): FungibleVaultFieldFrozenStatusSubstateAllOf {
  return FungibleVaultFieldFrozenStatusSubstateAllOfFromJSONTyped(json, false);
}

export function FungibleVaultFieldFrozenStatusSubstateAllOfFromJSONTyped(
  json: any,
...
export function FungibleVaultFieldFrozenStatusSubstateAllOfToJSON(
  value?: FungibleVaultFieldFrozenStatusSubstateAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
