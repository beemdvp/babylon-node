...
export function KeyValueStoreInfoFromJSONTyped(
  json: any,
  ...
  return {
    key_generic_substitution: GenericSubstitutionFromJSON(
      json["key_generic_substitution"],
    ),
    value_generic_substitution: GenericSubstitutionFromJSON(
      json["value_generic_substitution"],
    ),
...
export function KeyValueStoreInfoToJSON(value?: KeyValueStoreInfo | null): any {
  ...
  return {
    key_generic_substitution: GenericSubstitutionToJSON(
      value.key_generic_substitution,
    ),
    value_generic_substitution: GenericSubstitutionToJSON(
      value.value_generic_substitution,
    ),
