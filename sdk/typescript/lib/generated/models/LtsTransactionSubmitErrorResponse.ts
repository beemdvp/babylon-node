...
export type LtsTransactionSubmitErrorResponseErrorTypeEnum =
  (typeof LtsTransactionSubmitErrorResponseErrorTypeEnum)[keyof typeof LtsTransactionSubmitErrorResponseErrorTypeEnum];

/**
 * Check if a given object implements the LtsTransactionSubmitErrorResponse interface.
 */
export function instanceOfLtsTransactionSubmitErrorResponse(
  value: object,
): boolean {
  let isInstance = true;
...
export function LtsTransactionSubmitErrorResponseFromJSON(
  json: any,
): LtsTransactionSubmitErrorResponse {
  return LtsTransactionSubmitErrorResponseFromJSONTyped(json, false);
}

export function LtsTransactionSubmitErrorResponseFromJSONTyped(
  json: any,
...
export function LtsTransactionSubmitErrorResponseToJSON(
  value?: LtsTransactionSubmitErrorResponse | null,
): any {
  if (value === undefined) {
    return undefined;
  }
