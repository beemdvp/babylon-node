...
export type RemoteGenericSubstitutionAllOfTypeEnum =
  (typeof RemoteGenericSubstitutionAllOfTypeEnum)[keyof typeof RemoteGenericSubstitutionAllOfTypeEnum];

/**
 * Check if a given object implements the RemoteGenericSubstitutionAllOf interface.
 */
export function instanceOfRemoteGenericSubstitutionAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function RemoteGenericSubstitutionAllOfFromJSON(
  json: any,
): RemoteGenericSubstitutionAllOf {
  return RemoteGenericSubstitutionAllOfFromJSONTyped(json, false);
}

export function RemoteGenericSubstitutionAllOfFromJSONTyped(
  json: any,
  ...
  return {
    blueprint_type_identifier: BlueprintTypeIdentifierFromJSON(
      json["blueprint_type_identifier"],
    ),
    resolved_full_type_id: !exists(json, "resolved_full_type_id")
      ? undefined
      : FullyScopedTypeIdFromJSON(json["resolved_full_type_id"]),
    type: !exists(json, "type") ? undefined : json["type"],
  };
}

export function RemoteGenericSubstitutionAllOfToJSON(
  value?: RemoteGenericSubstitutionAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    blueprint_type_identifier: BlueprintTypeIdentifierToJSON(
      value.blueprint_type_identifier,
    ),
