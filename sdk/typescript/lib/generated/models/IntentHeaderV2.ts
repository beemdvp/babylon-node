...
export function IntentHeaderV2FromJSONTyped(
  json: any,
  ...
  return {
    ...
    min_proposer_timestamp_inclusive: !exists(
      json,
      "min_proposer_timestamp_inclusive",
    )
      ? undefined
      : ScryptoInstantFromJSON(json["min_proposer_timestamp_inclusive"]),
    max_proposer_timestamp_exclusive: !exists(
      json,
      "max_proposer_timestamp_exclusive",
    )
      ? undefined
      : ScryptoInstantFromJSON(json["max_proposer_timestamp_exclusive"]),
...
export function IntentHeaderV2ToJSON(value?: IntentHeaderV2 | null): any {
  ...
  return {
    ...
    min_proposer_timestamp_inclusive: ScryptoInstantToJSON(
      value.min_proposer_timestamp_inclusive,
    ),
    max_proposer_timestamp_exclusive: ScryptoInstantToJSON(
      value.max_proposer_timestamp_exclusive,
    ),
