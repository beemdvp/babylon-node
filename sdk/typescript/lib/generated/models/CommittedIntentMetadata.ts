...
export function CommittedIntentMetadataFromJSON(
  json: any,
): CommittedIntentMetadata {
  return CommittedIntentMetadataFromJSONTyped(json, false);
}

export function CommittedIntentMetadataFromJSONTyped(
  json: any,
...
export function CommittedIntentMetadataToJSON(
  value?: CommittedIntentMetadata | null,
): any {
  if (value === undefined) {
    return undefined;
  }
