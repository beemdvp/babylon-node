...
export type LtsTransactionSubmitRejectedErrorDetailsTypeEnum =
  (typeof LtsTransactionSubmitRejectedErrorDetailsTypeEnum)[keyof typeof LtsTransactionSubmitRejectedErrorDetailsTypeEnum];

/**
 * Check if a given object implements the LtsTransactionSubmitRejectedErrorDetails interface.
 */
export function instanceOfLtsTransactionSubmitRejectedErrorDetails(
  value: object,
): boolean {
  let isInstance = true;
...
export function LtsTransactionSubmitRejectedErrorDetailsFromJSON(
  json: any,
): LtsTransactionSubmitRejectedErrorDetails {
  return LtsTransactionSubmitRejectedErrorDetailsFromJSONTyped(json, false);
}

export function LtsTransactionSubmitRejectedErrorDetailsFromJSONTyped(
  json: any,
...
export function LtsTransactionSubmitRejectedErrorDetailsToJSON(
  value?: LtsTransactionSubmitRejectedErrorDetails | null,
): any {
  if (value === undefined) {
    return undefined;
  }
