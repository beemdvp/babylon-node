 ...
 */
export function instanceOfCommittedTransactionBalanceChanges(value: object): boolean {
    let isInstance = true;
...
export function CommittedTransactionBalanceChangesFromJSON(json: any): CommittedTransactionBalanceChanges {
    return CommittedTransactionBalanceChangesFromJSONTyped(json, false);
}

export function CommittedTransactionBalanceChangesFromJSONTyped(json: any, ignoreDiscriminator: boolean): CommittedTransactionBalanceChanges {
...
export function CommittedTransactionBalanceChangesToJSON(value?: CommittedTransactionBalanceChanges | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
