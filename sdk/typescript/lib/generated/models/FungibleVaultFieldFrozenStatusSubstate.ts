...
export type FungibleVaultFieldFrozenStatusSubstateSubstateTypeEnum =
  (typeof FungibleVaultFieldFrozenStatusSubstateSubstateTypeEnum)[keyof typeof FungibleVaultFieldFrozenStatusSubstateSubstateTypeEnum];

/**
 * Check if a given object implements the FungibleVaultFieldFrozenStatusSubstate interface.
 */
export function instanceOfFungibleVaultFieldFrozenStatusSubstate(
  value: object,
): boolean {
  let isInstance = true;
...
export function FungibleVaultFieldFrozenStatusSubstateFromJSON(
  json: any,
): FungibleVaultFieldFrozenStatusSubstate {
  return FungibleVaultFieldFrozenStatusSubstateFromJSONTyped(json, false);
}

export function FungibleVaultFieldFrozenStatusSubstateFromJSONTyped(
  json: any,
...
export function FungibleVaultFieldFrozenStatusSubstateToJSON(
  value?: FungibleVaultFieldFrozenStatusSubstate | null,
): any {
  if (value === undefined) {
    return undefined;
  }
