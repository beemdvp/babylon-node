...
export type GenericKeyValueStoreEntrySubstateSubstateTypeEnum =
  (typeof GenericKeyValueStoreEntrySubstateSubstateTypeEnum)[keyof typeof GenericKeyValueStoreEntrySubstateSubstateTypeEnum];

/**
 * Check if a given object implements the GenericKeyValueStoreEntrySubstate interface.
 */
export function instanceOfGenericKeyValueStoreEntrySubstate(
  value: object,
): boolean {
  let isInstance = true;
...
export function GenericKeyValueStoreEntrySubstateFromJSON(
  json: any,
): GenericKeyValueStoreEntrySubstate {
  return GenericKeyValueStoreEntrySubstateFromJSONTyped(json, false);
}

export function GenericKeyValueStoreEntrySubstateFromJSONTyped(
  json: any,
...
export function GenericKeyValueStoreEntrySubstateToJSON(
  value?: GenericKeyValueStoreEntrySubstate | null,
): any {
  if (value === undefined) {
    return undefined;
  }
