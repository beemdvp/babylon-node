...
export type NonFungibleVaultFieldFrozenStatusSubstateAllOfSubstateTypeEnum =
  (typeof NonFungibleVaultFieldFrozenStatusSubstateAllOfSubstateTypeEnum)[keyof typeof NonFungibleVaultFieldFrozenStatusSubstateAllOfSubstateTypeEnum];

/**
 * Check if a given object implements the NonFungibleVaultFieldFrozenStatusSubstateAllOf interface.
 */
export function instanceOfNonFungibleVaultFieldFrozenStatusSubstateAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function NonFungibleVaultFieldFrozenStatusSubstateAllOfFromJSON(
  json: any,
): NonFungibleVaultFieldFrozenStatusSubstateAllOf {
  return NonFungibleVaultFieldFrozenStatusSubstateAllOfFromJSONTyped(
    json,
    false,
  );
}

export function NonFungibleVaultFieldFrozenStatusSubstateAllOfFromJSONTyped(
  json: any,
...
export function NonFungibleVaultFieldFrozenStatusSubstateAllOfToJSON(
  value?: NonFungibleVaultFieldFrozenStatusSubstateAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
