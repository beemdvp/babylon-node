...
export function StateComponentResponseFromJSON(
  json: any,
): StateComponentResponse {
  return StateComponentResponseFromJSONTyped(json, false);
}

export function StateComponentResponseFromJSONTyped(
  json: any,
  ...
  return {
    ...
    royalty_accumulator: !exists(json, "royalty_accumulator")
      ? undefined
      : SubstateFromJSON(json["royalty_accumulator"]),
...
export function StateComponentResponseToJSON(
  value?: StateComponentResponse | null,
): any {
  if (value === undefined) {
    return undefined;
  }
