...
export type AccountResourcePreferenceEntrySubstateAllOfSubstateTypeEnum =
  (typeof AccountResourcePreferenceEntrySubstateAllOfSubstateTypeEnum)[keyof typeof AccountResourcePreferenceEntrySubstateAllOfSubstateTypeEnum];

/**
 * Check if a given object implements the AccountResourcePreferenceEntrySubstateAllOf interface.
 */
export function instanceOfAccountResourcePreferenceEntrySubstateAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function AccountResourcePreferenceEntrySubstateAllOfFromJSON(
  json: any,
): AccountResourcePreferenceEntrySubstateAllOf {
  return AccountResourcePreferenceEntrySubstateAllOfFromJSONTyped(json, false);
}

export function AccountResourcePreferenceEntrySubstateAllOfFromJSONTyped(
  json: any,
  ...
  return {
    ...
    value: !exists(json, "value")
      ? undefined
      : AccountResourcePreferenceEntryValueFromJSON(json["value"]),
...
export function AccountResourcePreferenceEntrySubstateAllOfToJSON(
  value?: AccountResourcePreferenceEntrySubstateAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
