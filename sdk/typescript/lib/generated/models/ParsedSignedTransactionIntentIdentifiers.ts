 ...
 */
export function instanceOfParsedSignedTransactionIntentIdentifiers(
  value: object,
): boolean {
  let isInstance = true;
...
export function ParsedSignedTransactionIntentIdentifiersFromJSON(
  json: any,
): ParsedSignedTransactionIntentIdentifiers {
  return ParsedSignedTransactionIntentIdentifiersFromJSONTyped(json, false);
}

export function ParsedSignedTransactionIntentIdentifiersFromJSONTyped(
  json: any,
...
export function ParsedSignedTransactionIntentIdentifiersToJSON(
  value?: ParsedSignedTransactionIntentIdentifiers | null,
): any {
  if (value === undefined) {
    return undefined;
  }
