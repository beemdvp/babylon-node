...
export function TransactionFormatOptionsFromJSON(
  json: any,
): TransactionFormatOptions {
  return TransactionFormatOptionsFromJSONTyped(json, false);
}

export function TransactionFormatOptionsFromJSONTyped(
  json: any,
  ...
  return {
    ...
    balance_changes: !exists(json, "balance_changes")
      ? undefined
      : json["balance_changes"],
    raw_system_transaction: !exists(json, "raw_system_transaction")
      ? undefined
      : json["raw_system_transaction"],
    raw_notarized_transaction: !exists(json, "raw_notarized_transaction")
      ? undefined
      : json["raw_notarized_transaction"],
    raw_ledger_transaction: !exists(json, "raw_ledger_transaction")
      ? undefined
      : json["raw_ledger_transaction"],
  };
}

export function TransactionFormatOptionsToJSON(
  value?: TransactionFormatOptions | null,
): any {
  if (value === undefined) {
    return undefined;
  }
