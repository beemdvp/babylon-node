...
export type PackageCodeVmTypeEntrySubstateAllOfSubstateTypeEnum =
  (typeof PackageCodeVmTypeEntrySubstateAllOfSubstateTypeEnum)[keyof typeof PackageCodeVmTypeEntrySubstateAllOfSubstateTypeEnum];

/**
 * Check if a given object implements the PackageCodeVmTypeEntrySubstateAllOf interface.
 */
export function instanceOfPackageCodeVmTypeEntrySubstateAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function PackageCodeVmTypeEntrySubstateAllOfFromJSON(
  json: any,
): PackageCodeVmTypeEntrySubstateAllOf {
  return PackageCodeVmTypeEntrySubstateAllOfFromJSONTyped(json, false);
}

export function PackageCodeVmTypeEntrySubstateAllOfFromJSONTyped(
  json: any,
...
export function PackageCodeVmTypeEntrySubstateAllOfToJSON(
  value?: PackageCodeVmTypeEntrySubstateAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
