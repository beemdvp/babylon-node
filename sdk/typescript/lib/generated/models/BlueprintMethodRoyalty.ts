...
export function BlueprintMethodRoyaltyFromJSON(
  json: any,
): BlueprintMethodRoyalty {
  return BlueprintMethodRoyaltyFromJSONTyped(json, false);
}

export function BlueprintMethodRoyaltyFromJSONTyped(
  json: any,
...
export function BlueprintMethodRoyaltyToJSON(
  value?: BlueprintMethodRoyalty | null,
): any {
  if (value === undefined) {
    return undefined;
  }
