...
export function AuthConfigFromJSONTyped(
  ...
  return {
    ...
    function_access_rules: !exists(json, "function_access_rules")
      ? undefined
      : mapValues(json["function_access_rules"], AccessRuleFromJSON),
    method_auth_type: MethodAuthTypeFromJSON(json["method_auth_type"]),
    method_roles: !exists(json, "method_roles")
      ? undefined
      : StaticRoleDefinitionAuthTemplateFromJSON(json["method_roles"]),
  };
}
...
export function AuthConfigToJSON(value?: AuthConfig | null): any {
  ...
  return {
    ...
    function_access_rules:
      value.function_access_rules === undefined
        ? undefined
        : mapValues(value.function_access_rules, AccessRuleToJSON),
