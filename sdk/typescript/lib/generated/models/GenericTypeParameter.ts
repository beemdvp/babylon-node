...
/**
 * Check if a given object implements the GenericTypeParameter interface.
 */
export function instanceOfGenericTypeParameter(value: object): boolean {
    let isInstance = true;
...
export function GenericTypeParameterFromJSON(json: any): GenericTypeParameter {
    return GenericTypeParameterFromJSONTyped(json, false);
}

export function GenericTypeParameterFromJSONTyped(json: any, ignoreDiscriminator: boolean): GenericTypeParameter {
...
export function GenericTypeParameterToJSON(value?: GenericTypeParameter | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
