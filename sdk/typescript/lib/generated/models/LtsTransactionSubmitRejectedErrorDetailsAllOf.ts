...
export type LtsTransactionSubmitRejectedErrorDetailsAllOfTypeEnum =
  (typeof LtsTransactionSubmitRejectedErrorDetailsAllOfTypeEnum)[keyof typeof LtsTransactionSubmitRejectedErrorDetailsAllOfTypeEnum];

/**
 * Check if a given object implements the LtsTransactionSubmitRejectedErrorDetailsAllOf interface.
 */
export function instanceOfLtsTransactionSubmitRejectedErrorDetailsAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function LtsTransactionSubmitRejectedErrorDetailsAllOfFromJSON(
  json: any,
): LtsTransactionSubmitRejectedErrorDetailsAllOf {
  return LtsTransactionSubmitRejectedErrorDetailsAllOfFromJSONTyped(
    json,
    false,
  );
}

export function LtsTransactionSubmitRejectedErrorDetailsAllOfFromJSONTyped(
  json: any,
  ...
  return {
    ...
    retry_from_timestamp: !exists(json, "retry_from_timestamp")
      ? undefined
      : InstantMsFromJSON(json["retry_from_timestamp"]),
    retry_from_epoch: !exists(json, "retry_from_epoch")
      ? undefined
      : json["retry_from_epoch"],
...
export function LtsTransactionSubmitRejectedErrorDetailsAllOfToJSON(
  value?: LtsTransactionSubmitRejectedErrorDetailsAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
