...
export type BlueprintSchemaBlueprintTypeReferenceAllOfTypeEnum =
  (typeof BlueprintSchemaBlueprintTypeReferenceAllOfTypeEnum)[keyof typeof BlueprintSchemaBlueprintTypeReferenceAllOfTypeEnum];

/**
 * Check if a given object implements the BlueprintSchemaBlueprintTypeReferenceAllOf interface.
 */
export function instanceOfBlueprintSchemaBlueprintTypeReferenceAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function BlueprintSchemaBlueprintTypeReferenceAllOfFromJSON(
  json: any,
): BlueprintSchemaBlueprintTypeReferenceAllOf {
  return BlueprintSchemaBlueprintTypeReferenceAllOfFromJSONTyped(json, false);
}

export function BlueprintSchemaBlueprintTypeReferenceAllOfFromJSONTyped(
  json: any,
...
export function BlueprintSchemaBlueprintTypeReferenceAllOfToJSON(
  value?: BlueprintSchemaBlueprintTypeReferenceAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
