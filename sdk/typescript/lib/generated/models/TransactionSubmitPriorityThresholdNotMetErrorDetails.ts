 ...
 *
 * @export
 * @interface TransactionSubmitPriorityThresholdNotMetErrorDetails
 */
 ...
 * @export
 */
export const TransactionSubmitPriorityThresholdNotMetErrorDetailsTypeEnum = {
  PriorityThresholdNotMet: "PriorityThresholdNotMet",
} as const;
export type TransactionSubmitPriorityThresholdNotMetErrorDetailsTypeEnum =
  (typeof TransactionSubmitPriorityThresholdNotMetErrorDetailsTypeEnum)[keyof typeof TransactionSubmitPriorityThresholdNotMetErrorDetailsTypeEnum];

/**
 * Check if a given object implements the TransactionSubmitPriorityThresholdNotMetErrorDetails interface.
 */
export function instanceOfTransactionSubmitPriorityThresholdNotMetErrorDetails(
  value: object,
): boolean {
  let isInstance = true;
...
export function TransactionSubmitPriorityThresholdNotMetErrorDetailsFromJSON(
  json: any,
): TransactionSubmitPriorityThresholdNotMetErrorDetails {
  return TransactionSubmitPriorityThresholdNotMetErrorDetailsFromJSONTyped(
    json,
    false,
  );
}

export function TransactionSubmitPriorityThresholdNotMetErrorDetailsFromJSONTyped(
  json: any,
  ...
  return {
    ...
    min_tip_percentage_required: !exists(json, "min_tip_percentage_required")
      ? undefined
      : json["min_tip_percentage_required"],
    tip_proportion: !exists(json, "tip_proportion")
      ? undefined
      : json["tip_proportion"],
    min_tip_proportion_required: !exists(json, "min_tip_proportion_required")
      ? undefined
      : json["min_tip_proportion_required"],
  };
}

export function TransactionSubmitPriorityThresholdNotMetErrorDetailsToJSON(
  value?: TransactionSubmitPriorityThresholdNotMetErrorDetails | null,
): any {
  if (value === undefined) {
    return undefined;
  }
