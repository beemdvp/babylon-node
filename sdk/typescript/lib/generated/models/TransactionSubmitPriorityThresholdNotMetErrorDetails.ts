...
export type TransactionSubmitPriorityThresholdNotMetErrorDetailsTypeEnum = typeof TransactionSubmitPriorityThresholdNotMetErrorDetailsTypeEnum[keyof typeof TransactionSubmitPriorityThresholdNotMetErrorDetailsTypeEnum];


/**
 * Check if a given object implements the TransactionSubmitPriorityThresholdNotMetErrorDetails interface.
 */
export function instanceOfTransactionSubmitPriorityThresholdNotMetErrorDetails(value: object): boolean {
    let isInstance = true;
...
export function TransactionSubmitPriorityThresholdNotMetErrorDetailsFromJSON(json: any): TransactionSubmitPriorityThresholdNotMetErrorDetails {
    return TransactionSubmitPriorityThresholdNotMetErrorDetailsFromJSONTyped(json, false);
}

export function TransactionSubmitPriorityThresholdNotMetErrorDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): TransactionSubmitPriorityThresholdNotMetErrorDetails {
...
export function TransactionSubmitPriorityThresholdNotMetErrorDetailsToJSON(value?: TransactionSubmitPriorityThresholdNotMetErrorDetails | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
