...
export type ConsensusManagerFieldConfigSubstateAllOfSubstateTypeEnum =
  (typeof ConsensusManagerFieldConfigSubstateAllOfSubstateTypeEnum)[keyof typeof ConsensusManagerFieldConfigSubstateAllOfSubstateTypeEnum];

/**
 * Check if a given object implements the ConsensusManagerFieldConfigSubstateAllOf interface.
 */
export function instanceOfConsensusManagerFieldConfigSubstateAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function ConsensusManagerFieldConfigSubstateAllOfFromJSON(
  json: any,
): ConsensusManagerFieldConfigSubstateAllOf {
  return ConsensusManagerFieldConfigSubstateAllOfFromJSONTyped(json, false);
}

export function ConsensusManagerFieldConfigSubstateAllOfFromJSONTyped(
  json: any,
...
export function ConsensusManagerFieldConfigSubstateAllOfToJSON(
  value?: ConsensusManagerFieldConfigSubstateAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
