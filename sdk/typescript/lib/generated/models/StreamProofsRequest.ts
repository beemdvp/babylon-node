...
export function StreamProofsRequestFromJSONTyped(
  json: any,
  ...
  return {
    ...
    filter: !exists(json, "filter")
      ? undefined
      : StreamProofsFilterFromJSON(json["filter"]),
    max_page_size: !exists(json, "max_page_size")
      ? undefined
      : json["max_page_size"],
    continuation_token: !exists(json, "continuation_token")
      ? undefined
      : json["continuation_token"],
  };
}

export function StreamProofsRequestToJSON(
  value?: StreamProofsRequest | null,
): any {
  if (value === undefined) {
    return undefined;
  }
