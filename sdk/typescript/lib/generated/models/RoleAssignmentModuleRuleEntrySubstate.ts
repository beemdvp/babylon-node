...
export type RoleAssignmentModuleRuleEntrySubstateSubstateTypeEnum =
  (typeof RoleAssignmentModuleRuleEntrySubstateSubstateTypeEnum)[keyof typeof RoleAssignmentModuleRuleEntrySubstateSubstateTypeEnum];

/**
 * Check if a given object implements the RoleAssignmentModuleRuleEntrySubstate interface.
 */
export function instanceOfRoleAssignmentModuleRuleEntrySubstate(
  value: object,
): boolean {
  let isInstance = true;
...
export function RoleAssignmentModuleRuleEntrySubstateFromJSON(
  json: any,
): RoleAssignmentModuleRuleEntrySubstate {
  return RoleAssignmentModuleRuleEntrySubstateFromJSONTyped(json, false);
}

export function RoleAssignmentModuleRuleEntrySubstateFromJSONTyped(
  json: any,
...
export function RoleAssignmentModuleRuleEntrySubstateToJSON(
  value?: RoleAssignmentModuleRuleEntrySubstate | null,
): any {
  if (value === undefined) {
    return undefined;
  }
