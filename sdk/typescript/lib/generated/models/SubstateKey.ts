...
export type SubstateKey =
  | ({ key_type: "Field" } & FieldSubstateKey)
  | ({ key_type: "Map" } & MapSubstateKey)
  | ({ key_type: "Sorted" } & SortedSubstateKey);

export function SubstateKeyFromJSON(json: any): SubstateKey {
  return SubstateKeyFromJSONTyped(json, false);
}

export function SubstateKeyFromJSONTyped(
  json: any,
  ...
  switch (json["key_type"]) {
    case "Field":
      return {
        ...FieldSubstateKeyFromJSONTyped(json, true),
        key_type: "Field",
      };
    case "Map":
    ...
    case "Sorted":
      return {
        ...SortedSubstateKeyFromJSONTyped(json, true),
        key_type: "Sorted",
      };
    default:
      throw new Error(
        `No variant of SubstateKey exists with 'key_type=${json["key_type"]}'`,
      );
  }
}
...
export function SubstateKeyToJSON(value?: SubstateKey | null): any {
  ...
  switch (value["key_type"]) {
    ...
    default:
      throw new Error(
        `No variant of SubstateKey exists with 'key_type=${value["key_type"]}'`,
      );
  }
}
