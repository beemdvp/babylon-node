...
export interface LtsStateAccountDepositBehaviourResponse {
  ...
  resource_specific_behaviours?: {
    [key: string]: ResourceSpecificDepositBehaviour;
  };
}
 ...
 */
export function instanceOfLtsStateAccountDepositBehaviourResponse(
  value: object,
): boolean {
  let isInstance = true;
...
export function LtsStateAccountDepositBehaviourResponseFromJSON(
  json: any,
): LtsStateAccountDepositBehaviourResponse {
  return LtsStateAccountDepositBehaviourResponseFromJSONTyped(json, false);
}

export function LtsStateAccountDepositBehaviourResponseFromJSONTyped(
  json: any,
  ...
  return {
    ...
    default_deposit_rule: DefaultDepositRuleFromJSON(
      json["default_deposit_rule"],
    ),
    is_badge_authorized_depositor: !exists(
      json,
      "is_badge_authorized_depositor",
    )
      ? undefined
      : json["is_badge_authorized_depositor"],
    resource_specific_behaviours: !exists(json, "resource_specific_behaviours")
      ? undefined
      : mapValues(
          json["resource_specific_behaviours"],
          ResourceSpecificDepositBehaviourFromJSON,
        ),
  };
}

export function LtsStateAccountDepositBehaviourResponseToJSON(
  value?: LtsStateAccountDepositBehaviourResponse | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    ...
    resource_specific_behaviours:
      value.resource_specific_behaviours === undefined
        ? undefined
        : mapValues(
            value.resource_specific_behaviours,
            ResourceSpecificDepositBehaviourToJSON,
          ),
  };
}
