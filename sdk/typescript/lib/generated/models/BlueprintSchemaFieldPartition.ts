...
export function BlueprintSchemaFieldPartitionFromJSON(json: any): BlueprintSchemaFieldPartition {
    return BlueprintSchemaFieldPartitionFromJSONTyped(json, false);
}

export function BlueprintSchemaFieldPartitionFromJSONTyped(json: any, ignoreDiscriminator: boolean): BlueprintSchemaFieldPartition {
...
export function BlueprintSchemaFieldPartitionToJSON(value?: BlueprintSchemaFieldPartition | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
