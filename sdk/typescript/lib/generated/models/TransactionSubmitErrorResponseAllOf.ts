...
export type TransactionSubmitErrorResponseAllOfErrorTypeEnum =
  (typeof TransactionSubmitErrorResponseAllOfErrorTypeEnum)[keyof typeof TransactionSubmitErrorResponseAllOfErrorTypeEnum];

/**
 * Check if a given object implements the TransactionSubmitErrorResponseAllOf interface.
 */
export function instanceOfTransactionSubmitErrorResponseAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function TransactionSubmitErrorResponseAllOfFromJSON(
  json: any,
): TransactionSubmitErrorResponseAllOf {
  return TransactionSubmitErrorResponseAllOfFromJSONTyped(json, false);
}

export function TransactionSubmitErrorResponseAllOfFromJSONTyped(
  json: any,
  ...
  return {
    details: !exists(json, "details")
      ? undefined
      : TransactionSubmitErrorDetailsFromJSON(json["details"]),
    error_type: !exists(json, "error_type") ? undefined : json["error_type"],
  };
}

export function TransactionSubmitErrorResponseAllOfToJSON(
  value?: TransactionSubmitErrorResponseAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
