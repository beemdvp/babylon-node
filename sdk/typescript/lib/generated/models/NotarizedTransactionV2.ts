...
export function NotarizedTransactionV2FromJSON(
  json: any,
): NotarizedTransactionV2 {
  return NotarizedTransactionV2FromJSONTyped(json, false);
}

export function NotarizedTransactionV2FromJSONTyped(
  json: any,
  ...
  return {
    ...
    signed_transaction_intent: SignedTransactionIntentV2FromJSON(
      json["signed_transaction_intent"],
    ),
    notary_signature: SignatureFromJSON(json["notary_signature"]),
  };
}

export function NotarizedTransactionV2ToJSON(
  value?: NotarizedTransactionV2 | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    ...
    signed_transaction_intent: SignedTransactionIntentV2ToJSON(
