...
export type MetadataModuleEntrySubstateAllOfSubstateTypeEnum =
  (typeof MetadataModuleEntrySubstateAllOfSubstateTypeEnum)[keyof typeof MetadataModuleEntrySubstateAllOfSubstateTypeEnum];

/**
 * Check if a given object implements the MetadataModuleEntrySubstateAllOf interface.
 */
export function instanceOfMetadataModuleEntrySubstateAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function MetadataModuleEntrySubstateAllOfFromJSON(
  json: any,
): MetadataModuleEntrySubstateAllOf {
  return MetadataModuleEntrySubstateAllOfFromJSONTyped(json, false);
}

export function MetadataModuleEntrySubstateAllOfFromJSONTyped(
  json: any,
  ...
  return {
    ...
    value: !exists(json, "value")
      ? undefined
      : MetadataModuleEntryValueFromJSON(json["value"]),
...
export function MetadataModuleEntrySubstateAllOfToJSON(
  value?: MetadataModuleEntrySubstateAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
