...
export type EncryptedTransactionMessageAllOfTypeEnum =
  (typeof EncryptedTransactionMessageAllOfTypeEnum)[keyof typeof EncryptedTransactionMessageAllOfTypeEnum];

/**
 * Check if a given object implements the EncryptedTransactionMessageAllOf interface.
 */
export function instanceOfEncryptedTransactionMessageAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function EncryptedTransactionMessageAllOfFromJSON(
  json: any,
): EncryptedTransactionMessageAllOf {
  return EncryptedTransactionMessageAllOfFromJSONTyped(json, false);
}

export function EncryptedTransactionMessageAllOfFromJSONTyped(
  json: any,
  ...
  return {
    ...
    curve_decryptor_sets: (json["curve_decryptor_sets"] as Array<any>).map(
      EncryptedMessageCurveDecryptorSetFromJSON,
    ),
...
export function EncryptedTransactionMessageAllOfToJSON(
  value?: EncryptedTransactionMessageAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    ...
    curve_decryptor_sets: (value.curve_decryptor_sets as Array<any>).map(
      EncryptedMessageCurveDecryptorSetToJSON,
    ),
    type: value.type,
  };
