 ...
 */
export function instanceOfLtsEntityFungibleBalanceChanges(
  value: object,
): boolean {
  let isInstance = true;
...
export function LtsEntityFungibleBalanceChangesFromJSON(
  json: any,
): LtsEntityFungibleBalanceChanges {
  return LtsEntityFungibleBalanceChangesFromJSONTyped(json, false);
}

export function LtsEntityFungibleBalanceChangesFromJSONTyped(
  json: any,
  ...
  return {
    ...
    fee_balance_change: !exists(json, "fee_balance_change")
      ? undefined
      : LtsFungibleResourceBalanceChangeFromJSON(json["fee_balance_change"]),
    fee_balance_changes: (json["fee_balance_changes"] as Array<any>).map(
      LtsFeeFungibleResourceBalanceChangeFromJSON,
    ),
    non_fee_balance_changes: (
      json["non_fee_balance_changes"] as Array<any>
    ).map(LtsFungibleResourceBalanceChangeFromJSON),
  };
}

export function LtsEntityFungibleBalanceChangesToJSON(
  value?: LtsEntityFungibleBalanceChanges | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    ...
    fee_balance_change: LtsFungibleResourceBalanceChangeToJSON(
      value.fee_balance_change,
    ),
    fee_balance_changes: (value.fee_balance_changes as Array<any>).map(
      LtsFeeFungibleResourceBalanceChangeToJSON,
    ),
    non_fee_balance_changes: (value.non_fee_balance_changes as Array<any>).map(
      LtsFungibleResourceBalanceChangeToJSON,
    ),
  };
}
