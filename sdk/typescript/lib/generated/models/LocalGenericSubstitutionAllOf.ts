...
export type LocalGenericSubstitutionAllOfTypeEnum =
  (typeof LocalGenericSubstitutionAllOfTypeEnum)[keyof typeof LocalGenericSubstitutionAllOfTypeEnum];

/**
 * Check if a given object implements the LocalGenericSubstitutionAllOf interface.
 */
export function instanceOfLocalGenericSubstitutionAllOf(
  value: object,
): boolean {
  let isInstance = true;
...
export function LocalGenericSubstitutionAllOfFromJSON(
  json: any,
): LocalGenericSubstitutionAllOf {
  return LocalGenericSubstitutionAllOfFromJSONTyped(json, false);
}

export function LocalGenericSubstitutionAllOfFromJSONTyped(
  json: any,
...
export function LocalGenericSubstitutionAllOfToJSON(
  value?: LocalGenericSubstitutionAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
