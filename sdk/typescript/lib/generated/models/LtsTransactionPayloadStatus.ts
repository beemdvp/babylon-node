...
export type LtsTransactionPayloadStatus =
  (typeof LtsTransactionPayloadStatus)[keyof typeof LtsTransactionPayloadStatus];

export function LtsTransactionPayloadStatusFromJSON(
  json: any,
): LtsTransactionPayloadStatus {
  return LtsTransactionPayloadStatusFromJSONTyped(json, false);
}

export function LtsTransactionPayloadStatusFromJSONTyped(
  json: any,
...
export function LtsTransactionPayloadStatusToJSON(
  value?: LtsTransactionPayloadStatus | null,
): any {
  return value as any;
}
