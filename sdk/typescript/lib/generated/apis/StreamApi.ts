...
export class StreamApi extends runtime.BaseAPI {
   ...
   * Stream Proofs
   */
  async streamProofsPostRaw(
    requestParameters: StreamProofsPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<StreamProofsResponse>> {
    if (
      requestParameters.streamProofsRequest === null ||
      requestParameters.streamProofsRequest === undefined
    ) {
      throw new runtime.RequiredError(
        "streamProofsRequest",
        "Required parameter requestParameters.streamProofsRequest was null or undefined when calling streamProofsPost.",
      );
    }
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      StreamProofsResponseFromJSON(jsonValue),
    );
  }
   ...
   * Stream Proofs
   */
  async streamProofsPost(
    requestParameters: StreamProofsPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<StreamProofsResponse> {
    const response = await this.streamProofsPostRaw(
      requestParameters,
      initOverrides,
    );
   ...
   */
  async streamTransactionsPostRaw(
    requestParameters: StreamTransactionsPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<StreamTransactionsResponse>> {
    if (
      requestParameters.streamTransactionsRequest === null ||
      requestParameters.streamTransactionsRequest === undefined
    ) {
      throw new runtime.RequiredError(
        "streamTransactionsRequest",
        "Required parameter requestParameters.streamTransactionsRequest was null or undefined when calling streamTransactionsPost.",
      );
    }
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: StreamTransactionsRequestToJSON(
          requestParameters.streamTransactionsRequest,
        ),
      },
      initOverrides,
    );
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      StreamTransactionsResponseFromJSON(jsonValue),
    );
  }
   ...
   * Get Committed Transactions
   */
  async streamTransactionsPost(
    requestParameters: StreamTransactionsPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<StreamTransactionsResponse> {
    const response = await this.streamTransactionsPostRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
