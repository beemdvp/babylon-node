...
export class TransactionApi extends runtime.BaseAPI {
   ...
   */
  async transactionCallPreviewPostRaw(
    requestParameters: TransactionCallPreviewPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<TransactionCallPreviewResponse>> {
    if (
      requestParameters.transactionCallPreviewRequest === null ||
      requestParameters.transactionCallPreviewRequest === undefined
    ) {
      throw new runtime.RequiredError(
        "transactionCallPreviewRequest",
        "Required parameter requestParameters.transactionCallPreviewRequest was null or undefined when calling transactionCallPreviewPost.",
      );
    }
    ...
    const response = await this.request(
      {
        ...
        body: TransactionCallPreviewRequestToJSON(
          requestParameters.transactionCallPreviewRequest,
        ),
      },
      initOverrides,
    );
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      TransactionCallPreviewResponseFromJSON(jsonValue),
    );
  }
   ...
   * Scrypto Call Preview
   */
  async transactionCallPreviewPost(
    requestParameters: TransactionCallPreviewPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<TransactionCallPreviewResponse> {
    const response = await this.transactionCallPreviewPostRaw(
      requestParameters,
      initOverrides,
    );
   ...
   */
  async transactionParsePostRaw(
    requestParameters: TransactionParsePostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<TransactionParseResponse>> {
    if (
      requestParameters.transactionParseRequest === null ||
      requestParameters.transactionParseRequest === undefined
    ) {
      throw new runtime.RequiredError(
        "transactionParseRequest",
        "Required parameter requestParameters.transactionParseRequest was null or undefined when calling transactionParsePost.",
      );
    }
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: TransactionParseRequestToJSON(
          requestParameters.transactionParseRequest,
        ),
      },
      initOverrides,
    );
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      TransactionParseResponseFromJSON(jsonValue),
    );
  }
   ...
   * Parse Transaction Payload
   */
  async transactionParsePost(
    requestParameters: TransactionParsePostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<TransactionParseResponse> {
    const response = await this.transactionParsePostRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   */
  async transactionPreviewPostRaw(
    requestParameters: TransactionPreviewPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<TransactionPreviewResponse>> {
    if (
      requestParameters.transactionPreviewRequest === null ||
      requestParameters.transactionPreviewRequest === undefined
    ) {
      throw new runtime.RequiredError(
        "transactionPreviewRequest",
        "Required parameter requestParameters.transactionPreviewRequest was null or undefined when calling transactionPreviewPost.",
      );
    }
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: TransactionPreviewRequestToJSON(
          requestParameters.transactionPreviewRequest,
        ),
      },
      initOverrides,
    );
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      TransactionPreviewResponseFromJSON(jsonValue),
    );
  }
   ...
   * Transaction Preview V1
   */
  async transactionPreviewPost(
    requestParameters: TransactionPreviewPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<TransactionPreviewResponse> {
    const response = await this.transactionPreviewPostRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   */
  async transactionPreviewV2PostRaw(
    requestParameters: TransactionPreviewV2PostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<TransactionPreviewV2Response>> {
    if (
      requestParameters.transactionPreviewV2Request === null ||
      requestParameters.transactionPreviewV2Request === undefined
    ) {
      throw new runtime.RequiredError(
        "transactionPreviewV2Request",
        "Required parameter requestParameters.transactionPreviewV2Request was null or undefined when calling transactionPreviewV2Post.",
      );
    }
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: TransactionPreviewV2RequestToJSON(
          requestParameters.transactionPreviewV2Request,
        ),
      },
      initOverrides,
    );
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      TransactionPreviewV2ResponseFromJSON(jsonValue),
    );
  }
   ...
   * Transaction Preview V2
   */
  async transactionPreviewV2Post(
    requestParameters: TransactionPreviewV2PostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<TransactionPreviewV2Response> {
    const response = await this.transactionPreviewV2PostRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   */
  async transactionReceiptPostRaw(
    requestParameters: TransactionReceiptPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<TransactionReceiptResponse>> {
    if (
      requestParameters.transactionReceiptRequest === null ||
      requestParameters.transactionReceiptRequest === undefined
    ) {
      throw new runtime.RequiredError(
        "transactionReceiptRequest",
        "Required parameter requestParameters.transactionReceiptRequest was null or undefined when calling transactionReceiptPost.",
      );
    }
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: TransactionReceiptRequestToJSON(
          requestParameters.transactionReceiptRequest,
        ),
      },
      initOverrides,
    );
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      TransactionReceiptResponseFromJSON(jsonValue),
    );
  }
   ...
   * Get Transaction Receipt
   */
  async transactionReceiptPost(
    requestParameters: TransactionReceiptPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<TransactionReceiptResponse> {
    const response = await this.transactionReceiptPostRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
