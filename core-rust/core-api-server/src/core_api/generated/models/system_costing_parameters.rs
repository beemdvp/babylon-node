...
impl SystemCostingParameters {
    pub fn new(execution_cost_unit_price: String, execution_cost_unit_limit: i64, execution_cost_unit_loan: i64, finalization_cost_unit_price: String, finalization_cost_unit_limit: i64, xrd_usd_price: String, xrd_storage_price: String, xrd_archive_storage_price: String) -> SystemCostingParameters {
