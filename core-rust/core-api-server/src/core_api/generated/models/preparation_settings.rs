...
impl PreparationSettings {
    pub fn new(v2_transactions_permitted: bool, max_user_payload_length: String, max_ledger_payload_length: String, max_child_subintents_per_intent: String, max_subintents_per_transaction: String, max_blobs: String) -> PreparationSettings {
        PreparationSettings {
