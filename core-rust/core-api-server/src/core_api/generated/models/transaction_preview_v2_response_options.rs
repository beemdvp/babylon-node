...
pub struct TransactionPreviewV2ResponseOptions {
    ...
    #[serde(rename = "core_api_receipt", skip_serializing_if = "Option::is_none")]
    pub core_api_receipt: Option<bool>,
...
impl TransactionPreviewV2ResponseOptions {
    /// A set of flags to configure the response of the transaction preview.
    pub fn new() -> TransactionPreviewV2ResponseOptions {
        TransactionPreviewV2ResponseOptions {
            core_api_receipt: None,
