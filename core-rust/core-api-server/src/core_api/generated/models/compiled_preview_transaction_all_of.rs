...
pub struct CompiledPreviewTransactionAllOf {
...
impl CompiledPreviewTransactionAllOf {
    pub fn new(preview_transaction_hex: String) -> CompiledPreviewTransactionAllOf {
