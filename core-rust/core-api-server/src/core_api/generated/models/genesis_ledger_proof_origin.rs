...
impl GenesisLedgerProofOrigin {
    pub fn new(_type: crate::core_api::generated::models::LedgerProofOriginType, protocol_version_name: String, genesis_opaque_hash: String, batch_group_idx: i64, batch_group_name: String, batch_idx: i64, batch_name: String, is_end_of_update: bool) -> GenesisLedgerProofOrigin {
