...
pub struct LtsTransactionSubmitRequest {
...
impl LtsTransactionSubmitRequest {
    pub fn new(network: String, notarized_transaction_hex: String) -> LtsTransactionSubmitRequest {
