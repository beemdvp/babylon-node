...
pub struct LtsTransactionSubmitErrorResponse {
...
impl LtsTransactionSubmitErrorResponse {
    pub fn new(error_type: crate::core_api::generated::models::ErrorResponseType, code: i32, message: String) -> LtsTransactionSubmitErrorResponse {
