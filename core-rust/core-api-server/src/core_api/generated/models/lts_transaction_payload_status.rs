...
/// LtsTransactionPayloadStatus : The status of the transaction payload, as per this node. A NotInMempool status means that it wasn't rejected at last execution attempt, but it's not currently in the mempool either. 
...
pub enum LtsTransactionPayloadStatus {
...
impl ToString for LtsTransactionPayloadStatus {
...
impl Default for LtsTransactionPayloadStatus {
    fn default() -> LtsTransactionPayloadStatus {
