...
pub struct TransactionTrackerFieldStateValue {
...
impl TransactionTrackerFieldStateValue {
    pub fn new(start_epoch: i64, start_partition: i32, partition_range_start_inclusive: i32, partition_range_end_inclusive: i32, epochs_per_partition: i64) -> TransactionTrackerFieldStateValue {
