...
pub struct StreamProofsErrorResponse {
    ...
    pub details: Option<Box<crate::core_api::generated::models::StreamProofsErrorDetails>>,
}

impl StreamProofsErrorResponse {
    pub fn new(error_type: crate::core_api::generated::models::ErrorResponseType, code: i32, message: String) -> StreamProofsErrorResponse {
