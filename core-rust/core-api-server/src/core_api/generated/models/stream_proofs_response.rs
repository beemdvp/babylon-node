...
pub struct StreamProofsResponse {
    /// A page of ledger proofs stored by this node.
    #[serde(rename = "page")]
    pub page: Vec<crate::core_api::generated::models::LedgerProof>,
...
impl StreamProofsResponse {
    pub fn new(page: Vec<crate::core_api::generated::models::LedgerProof>) -> StreamProofsResponse {
