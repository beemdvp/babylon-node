...
impl PaymentToRoyaltyRecipient {
    pub fn new(royalty_recipient: crate::core_api::generated::models::EntityReference, xrd_amount: String) -> PaymentToRoyaltyRecipient {
        PaymentToRoyaltyRecipient {
            royalty_recipient: Box::new(royalty_recipient),
            xrd_amount,
        }
    }
}
