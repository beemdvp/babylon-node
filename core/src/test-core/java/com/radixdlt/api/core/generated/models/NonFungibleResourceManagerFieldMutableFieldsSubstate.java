...
public class NonFungibleResourceManagerFieldMutableFieldsSubstate extends Substate {
  ...
  **/
  ...
  /**
   * Return true if this NonFungibleResourceManagerFieldMutableFieldsSubstate object is equal to o.
   */
  @Override
...
static {
  ...
  JSON.registerDiscriminator(NonFungibleResourceManagerFieldMutableFieldsSubstate.class, "substate_type", mappings);
}
}
