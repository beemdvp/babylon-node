...
public class TypeInfoModuleFieldTypeInfoSubstate extends Substate {
  ...
  **/
  ...
  /**
   * Return true if this TypeInfoModuleFieldTypeInfoSubstate object is equal to o.
   */
  @Override
...
static {
  ...
  JSON.registerDiscriminator(TypeInfoModuleFieldTypeInfoSubstate.class, "substate_type", mappings);
}
}
