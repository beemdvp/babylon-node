...
public class OuterObjectOnlyMethodAccessibility extends MethodAccessibility {
  public OuterObjectOnlyMethodAccessibility() { 
  }

  /**
   * Return true if this OuterObjectOnlyMethodAccessibility object is equal to o.
   */
  @Override
...
static {
  ...
  JSON.registerDiscriminator(OuterObjectOnlyMethodAccessibility.class, "type", mappings);
}
}
