...
public class NonFungibleResourceManagerFieldIdTypeSubstate extends Substate {
  ...
  **/
  ...
  /**
   * Return true if this NonFungibleResourceManagerFieldIdTypeSubstate object is equal to o.
   */
  @Override
...
static {
  ...
  JSON.registerDiscriminator(NonFungibleResourceManagerFieldIdTypeSubstate.class, "substate_type", mappings);
}
}
