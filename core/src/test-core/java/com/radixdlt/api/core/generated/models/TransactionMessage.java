 ...
 */
@JsonPropertyOrder({
  TransactionMessage.JSON_PROPERTY_TYPE
})
...
@JsonSubTypes({
  ...
  @JsonSubTypes.Type(value = EncryptedTransactionMessage.class, name = "EncryptedTransactionMessage"),
  @JsonSubTypes.Type(value = PlaintextTransactionMessage.class, name = "Plaintext"),
  @JsonSubTypes.Type(value = PlaintextTransactionMessage.class, name = "PlaintextTransactionMessage"),
})
...
public class TransactionMessage {
  ...
  public TransactionMessage type(TransactionMessageType type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this TransactionMessage object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TransactionMessage transactionMessage = (TransactionMessage) o;
    return Objects.equals(this.type, transactionMessage.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransactionMessage {\n");
...
static {
  ...
  mappings.put("TransactionMessage", TransactionMessage.class);
  JSON.registerDiscriminator(TransactionMessage.class, "type", mappings);
}
}
