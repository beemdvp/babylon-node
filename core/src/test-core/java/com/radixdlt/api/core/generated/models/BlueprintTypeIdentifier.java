 ...
 */
@ApiModel(description = "An identifier for a defined type in the v1 blueprint version under the given package blueprint. ")
@JsonPropertyOrder({
...
public class BlueprintTypeIdentifier {
  ...
  **/
  ...
  /**
   * Return true if this BlueprintTypeIdentifier object is equal to o.
   */
  @Override
