...
public class RoyaltyModuleFieldStateSubstate extends Substate {
  ...
  **/
  ...
  /**
   * Return true if this RoyaltyModuleFieldStateSubstate object is equal to o.
   */
  @Override
...
static {
  ...
  JSON.registerDiscriminator(RoyaltyModuleFieldStateSubstate.class, "substate_type", mappings);
}
}
