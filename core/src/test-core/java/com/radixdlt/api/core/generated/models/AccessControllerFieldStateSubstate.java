...
public class AccessControllerFieldStateSubstate extends Substate {
  ...
  **/
  ...
  /**
   * Return true if this AccessControllerFieldStateSubstate object is equal to o.
   */
  @Override
...
static {
  ...
  JSON.registerDiscriminator(AccessControllerFieldStateSubstate.class, "substate_type", mappings);
}
}
