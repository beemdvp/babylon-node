 ...
 */
@JsonPropertyOrder({
  TypeInfoDetails.JSON_PROPERTY_TYPE
})
...
public class TypeInfoDetails {
  ...
  private TypeInfoType type;

  public TypeInfoDetails() { 
  }

  public TypeInfoDetails type(TypeInfoType type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_TYPE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setType(TypeInfoType type) {
    this.type = type;
  }


  /**
   * Return true if this TypeInfoDetails object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TypeInfoDetails typeInfoDetails = (TypeInfoDetails) o;
    return Objects.equals(this.type, typeInfoDetails.type);
  }
