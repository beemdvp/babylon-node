...
public class OneResourcePoolFieldStateSubstate extends Substate {
  ...
  **/
  ...
  /**
   * Return true if this OneResourcePoolFieldStateSubstate object is equal to o.
   */
  @Override
...
static {
  ...
  JSON.registerDiscriminator(OneResourcePoolFieldStateSubstate.class, "substate_type", mappings);
}
}
