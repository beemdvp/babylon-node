...
@JsonSubTypes({
  ...
  @JsonSubTypes.Type(value = RoleProtectedMethodAccessibility.class, name = "RoleProtectedMethodAccessibility"),
})

public class MethodAccessibility {
  public static final String JSON_PROPERTY_TYPE = "type";
  private MethodAccessibilityType type;
  ...
  **/
  ...
  /**
   * Return true if this MethodAccessibility object is equal to o.
   */
  @Override
...
static {
  ...
  mappings.put("MethodAccessibility", MethodAccessibility.class);
  JSON.registerDiscriminator(MethodAccessibility.class, "type", mappings);
}
}
