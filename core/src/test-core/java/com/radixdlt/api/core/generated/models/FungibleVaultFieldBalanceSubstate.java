...
public class FungibleVaultFieldBalanceSubstate extends Substate {
  ...
  **/
  ...
  /**
   * Return true if this FungibleVaultFieldBalanceSubstate object is equal to o.
   */
  @Override
...
static {
  ...
  JSON.registerDiscriminator(FungibleVaultFieldBalanceSubstate.class, "substate_type", mappings);
}
}
