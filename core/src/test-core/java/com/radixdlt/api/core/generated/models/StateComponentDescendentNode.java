...
public class StateComponentDescendentNode {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The hex-encoded bytes of the substate key, under the entity partition")
  ...
  **/
  ...
  /**
   * Return true if this StateComponentDescendentNode object is equal to o.
   */
  @Override
