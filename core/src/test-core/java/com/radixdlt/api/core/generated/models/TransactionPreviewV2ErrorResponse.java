...
import com.radixdlt.api.core.generated.models.TransactionPreviewV2ErrorDetails;
import com.radixdlt.api.core.generated.models.TransactionPreviewV2ErrorResponse;
import com.radixdlt.api.core.generated.models.TransactionPreviewV2ErrorResponseAllOf;
 ...
 */
@JsonPropertyOrder({
  TransactionPreviewV2ErrorResponse.JSON_PROPERTY_DETAILS
})
...
public class TransactionPreviewV2ErrorResponse extends ErrorResponse {
  public static final String JSON_PROPERTY_DETAILS = "details";
  private TransactionPreviewV2ErrorDetails details;

  public TransactionPreviewV2ErrorResponse() { 
  }

  public TransactionPreviewV2ErrorResponse details(TransactionPreviewV2ErrorDetails details) {
  ...
  **/
  ...
  public TransactionPreviewV2ErrorDetails getDetails() {
    return details;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DETAILS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDetails(TransactionPreviewV2ErrorDetails details) {
    this.details = details;
  }


  /**
   * Return true if this TransactionPreviewV2ErrorResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TransactionPreviewV2ErrorResponse transactionPreviewV2ErrorResponse = (TransactionPreviewV2ErrorResponse) o;
    return Objects.equals(this.details, transactionPreviewV2ErrorResponse.details) &&
        super.equals(o);
  }
...
static {
  ...
  JSON.registerDiscriminator(TransactionPreviewV2ErrorResponse.class, "error_type", mappings);
}
}
