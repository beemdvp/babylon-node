...
public class ValidatorFeeChangeRequest {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "An integer between `0` and `10^10`, marking the epoch at which the fee change becomes effective. ")
  ...
  **/
  ...
  /**
   * Return true if this ValidatorFeeChangeRequest object is equal to o.
   */
  @Override
