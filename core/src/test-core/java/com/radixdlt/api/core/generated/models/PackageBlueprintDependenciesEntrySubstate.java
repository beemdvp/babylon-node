...
public class PackageBlueprintDependenciesEntrySubstate extends Substate {
  ...
  **/
  ...
  /**
   * Return true if this PackageBlueprintDependenciesEntrySubstate object is equal to o.
   */
  @Override
...
static {
  ...
  JSON.registerDiscriminator(PackageBlueprintDependenciesEntrySubstate.class, "substate_type", mappings);
}
}
