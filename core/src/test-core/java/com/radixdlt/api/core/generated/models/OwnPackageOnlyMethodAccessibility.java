...
public class OwnPackageOnlyMethodAccessibility extends MethodAccessibility {
  public OwnPackageOnlyMethodAccessibility() { 
  }

  /**
   * Return true if this OwnPackageOnlyMethodAccessibility object is equal to o.
   */
  @Override
...
static {
  ...
  JSON.registerDiscriminator(OwnPackageOnlyMethodAccessibility.class, "type", mappings);
}
}
