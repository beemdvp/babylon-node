 ...
 */
public enum LtsTransactionPayloadStatus {
  ...
  LtsTransactionPayloadStatus(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static LtsTransactionPayloadStatus fromValue(String value) {
    for (LtsTransactionPayloadStatus b : LtsTransactionPayloadStatus.values()) {
