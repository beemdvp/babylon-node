...
public class UpdatedSubstate {
  ...
  private SubstateValue newValue;
  ...
  public UpdatedSubstate substateId(SubstateId substateId) {
  ...
  **/
  ...
  public UpdatedSubstate newValue(SubstateValue newValue) {
  ...
  **/
  ...
  public SubstateValue getNewValue() {
    return newValue;
  }
  ...
  @JsonProperty(JSON_PROPERTY_NEW_VALUE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setNewValue(SubstateValue newValue) {
    this.newValue = newValue;
  }


  public UpdatedSubstate previousValue(SubstateValue previousValue) {
