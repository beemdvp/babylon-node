...
public class PackageFieldRoyaltyAccumulatorSubstate extends Substate {
  ...
  **/
  ...
  /**
   * Return true if this PackageFieldRoyaltyAccumulatorSubstate object is equal to o.
   */
  @Override
...
static {
  ...
  JSON.registerDiscriminator(PackageFieldRoyaltyAccumulatorSubstate.class, "substate_type", mappings);
}
}
