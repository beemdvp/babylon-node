...
public class PublicMethodAccessibility extends MethodAccessibility {
  public PublicMethodAccessibility() { 
  }

  /**
   * Return true if this PublicMethodAccessibility object is equal to o.
   */
  @Override
...
static {
  ...
  JSON.registerDiscriminator(PublicMethodAccessibility.class, "type", mappings);
}
}
